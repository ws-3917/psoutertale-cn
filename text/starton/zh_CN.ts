...
export default {
   a_starton: {
      ...
      truetext: {
         ...
         puzzle1: () =>
            SAVE.data.b.svr
               ? ["<25>{#p/asriel1}{#f/20}* 不错嘛，Frisk。\n* 没想到\n  你还是个数学高手..."]
               : ['<32>{#p/basic}* 哇。\n* 你竟然真把它解开了？'],
         sans3: ['<32>{#p/basic}* 你尽力了。'],
         sans4: ['<32>{#p/basic}* 你以前做过这个吗...？'],
         sans5: ['<32>{#p/basic}* 拜托，Sans。\n* 这“谜题”根本不值一看。'],
         sans6: ['<32>{#p/basic}* 拜托，Sans。\n* 这“谜题”根本不是人能做的啊。'],
   ...
   b_group_starton: {
      dogs: () => (world.goatbro ? ['<32>{#p/asriel2}* Dogamy和Dogaressa。'] : ['<32>{#p/story}* Dogi发起突袭！']),
      spacetopJerry: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 俗气的帽子再配上没谱的伙计。']
            : ['<32>{#p/story}* Astro Serf大摇大摆地晃了过来！\n* Jerry也来了。'],
      stardrakeSpacetop: () =>
         world.goatbro
   ...
   b_opponent_stardrake: {
      act_check: () =>
         world.goatbro
            ...
            : SAVE.data.b.s_state_chilldrake
               ? ['<33>{#p/story}* CHILLDRAKE - 攻击12 防御7\n* 看啥都要对着干！！\n* 他在找Starry。']
      ...
      hurtStatus: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 离死不远了。']
            : SAVE.data.b.s_state_chilldrake
               ? ['<32>{#p/story}* Chilldrake的身体要散架了。']
               : ['<32>{#p/story}* Stardrake的身体要散架了。'],
      idleTalk1: () =>
         SAVE.data.b.s_state_chilldrake
      ...
      status1: () =>
         SAVE.data.b.s_state_chilldrake
            ? ['<32>{#p/story}* Chilldrake大摇大摆地晃了过来！']
   ...
   b_opponent_doggo: {
      ...
      name: '* Doggo',
      fetchStatus: ['<32>{#p/story}* Doggo喜欢玩抛接！'],
   ...
   c_call_papyrus: <Partial<CosmosKeyed<CosmosProvider<string[]>>>>{
      ...
      a_lab_main: pager.create(
         ...
         () => [
            ...
            solo()
               ? '<18>{#p/papyrus}{#f/0}...还是去找ALPHYS博士玩，\n就这周！'
