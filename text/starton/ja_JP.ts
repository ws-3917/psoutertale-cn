...
export default {
   a_starton: {
      ...
      papdate0: () => [
         SAVE.data.b.flirt_papyrus
            ? "<5>{#p/papyrus}{#f/5}…きさま、　そんなに　オレさまと　デート　したい　のか…"
            : "<5>{#p/papyrus}{#f/5}…きさま、　そんなに　オレさまと　あそび　たい　のか…",
         "<5>{#f/5}ひとりで　オレさまの　いえに　はいって　まで！",
      ...
      papdate1: () => [
         SAVE.data.b.flirt_papyrus
            ? '<5>{#p/papyrus}オレさまと　デートしに　もどって　きたな！'
            : '<5>{#p/papyrus}オレさまに　あいに、　もどって　きたな！',
         ...(world.dead_dog || world.population < 6
            ? [
               "<18>{#f/0}THAT'S GREAT!!",
            ...
            : ['<5>{#f/4}きさま、　どうやら　ホンキ　らしいな…']),
         "<5>{#f/5}なら、　きさまを　とって　おきの　ばしょへ、　つれて　いかねば　ならん…",
         '<5>{#f/0}オレさまが　よくいく　ばしょだ！'
      ],
      papdate2: ['<5>{#p/papyrus}オレさまの　いえッ！'],
      ...
      papdate3a: ['<5>{#p/papyrus}{#f/6}ふぅ！　おもてなし　は、　たいりょく　しょうぶ　だな！'],
      papdate3b: [
         "<18>{#p/papyrus}{#f/5}WOWIE, I CAN'T FEEL MY LEGS...",
         "<5>{#f/0}ってことは　オレさまは　いま、　さいこうの　おもてなし　を　してるって　ことだな！"
      ],
      ...
      papdate6: () => [
         SAVE.data.b.flirt_papyrus
            ? '<#32>{#p/story}         DATE    START！'
            : '<#32>{#p/story}         MATTARI   START！'
      ],
      papdate7: () => [
      ...
      papdate9: () => [
         ...
         SAVE.data.b.flirt_papyrus
            ? '<5>{#f/25}ステップ一　キーボード　で、　Ｃキーを　おすと、　{@fill=#f00}デート用　メニュー{@fill=#000}が　ひらき&ます…'
            : '<5>{#f/25}ステップ一　キーボード　で、　Ｃキーを　おすと、　{@fill=#f00}まったり用　メニュー{@fill=#000}が　ひらき&ます…'
      ],
      papdate10: () => [
   ...
   n_shop_hare: {
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ? ['Say Hello', 'What Happened', 'アウトランド', 'The Future', 'Exit']
