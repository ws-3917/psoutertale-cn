...
export default {
   a_starton: {
      ...
      shockpapyrus1: () =>
         [
            [
               ...
               choicer.create('* （Asriel應該怎麼做？）', '仁慈', '行動', '魔法', '戰鬥')
            ],
      ...
      maze3a: [
         '<18>「火焰之牆」！！',
         '<25>{#p/sans}* 你直接叫它「火牆」\n  不就行了嗎？\n* 這樣多省事。',
         "<18>{#p/papyrus}{#f/4}ALPHYS博士肯定會說\n你亂用這個詞了。",
         "<25>{#p/sans}* 這我不清楚，兄弟。\n  不過，博士真的超級喜歡\n  這個謎題。",
         "<30>{#f/2}* 畢竟... 這東西多讓人\n  {@fill=#ff0}熱{@fill=#fff}血沸騰啊。"
      ],
      maze4: ['<18>{#p/papyrus}{#x3}{#f/7}別說了，SANS！！'],
      maze5: () =>
         world.edgy
            ? [
               '<25>{#p/sans}{#f/0}* 這是「火牆」。',
      ...
      maze7: [
         ...
         [
            ...
            "<18>如果是那樣的話，\n那你一定得知道...",
            '<18>{#x4}{#f/9}我，偉大的PAPYRUS，\n不會因此而評判你！',
            '<18>{#f/0}就像每個明星大廚\n都知道的那樣，\n心意是最重要的。',
            '<18>{#x1}所以，來吧，\n盡力就好！'
         ],
         [
            '<18>{#p/papyrus}{#f/4}（SANS，那個人類\n在幹什麼啊？？）',
            '<25>{#p/sans}* 可能在研究路線吧。',
      ...
      npcinter: {
         ...
         s_genokid: pager.create(
            ...
            () =>
               world.genocide
                  ...
                  : ["<25>{#p/kidd}{#f/1}{#npc/a}* Undyne就是我們的堅實後盾！"]
         ),
                  ...
                  : SAVE.data.n.plot === 33
                     ...
                     : SAVE.data.n.plot === 72
                        ...
                        : papreal()
                           ...
                           : [
                              '<32>{#p/basic}{#npc/a}* 我覺得我可以問問Undyne。\n* 但她好像已經喜歡別人了。'
                           ],
            () =>
               SAVE.data.b.killed_mettaton
         ...
         g_punkhamster: pager.create(
            ...
            () =>
               SAVE.data.b.killed_mettaton
                  ...
                  : SAVE.data.n.plot === 33
                     ? [
                        '<32>{#p/basic}{#npc/a}* Sans當然知道該怎麼逗你笑，\n  對吧？',
                        '<32>* 那是肯定的。\n* 這裡的帳單幾乎都是\n  那個骷髏付的。'
                     ]
                     : SAVE.data.n.plot === 72
                        ? world.population < 2
                     ...
                     : SAVE.data.n.plot === 72
                        ...
                        : papreal() || world.dead_dog
                           ...
                           : world.population < 4
                              ...
                              : ['<32>{#p/basic}{#npc/a}* 我長大了也要像UNDYNE那樣！\n* 吼吼吼！']
         ),
         ...
         t_zorren: pager.create(
            0,
            () => [
               "<32>{#p/basic}{#npc/a}* （喔，嘿，是我，Zorren。）",
               ...(SAVE.data.n.plot === 72
                  ? world.population < 4
                     ? [
      ...
      papsink5: ['<18>{#p/papyrus}{#f/7}SANS！', '<18>別再用配樂\n打擾我的生活了！！'],
      ...
      papspaghet1a: () => [
         ...
         "<18>{#f/0}你帶著它呢！！",
         '<18>{#f/9}人類，你怎麼打算的？',
         choicer.create("* （你要拿Papyrus的意面怎麼辦呢？）", '一起吃吧', '吃掉'),
         '<18>{#p/papyrus}真的！？'
      ],
      papspaghet2a: [
         "<18>{#f/5}你抗拒我做的\n義大利麵的味道...",
      ...
      papyrus3: [
         ...
         '<18>{#p/papyrus}{#f/0}...SANS，我們\n終於做到了！',
         '<18>{#f/9}UNDYNE現在【必定】會讓我\n加入皇家衛隊了！！！',
         '<18>{#f/6}我們只需要...',
         '<18>{#f/5}去...',
         '<18>{#f/4}...',
         "<18>{#f/4}我把什麼東西給忘了。",
      ...
      sans5: [
         ...
         '<25>{#p/sans}* 嗯...',
         '<25>{#f/2}* 沒準這個玩意可以\n  幫到你呢。',
         "<18>{#p/papyrus}{#x3}{#f/7}SANS，那根本沒用！\n你這個懶骨頭！",
         '<18>{#x1}{#f/5}你明明知道，\n你能做的遠不止這些，\n但是...',
         '<18>{#x2}{#f/7}你還是選擇\n整天無所事事！',
         "<18>{#x1}{#f/5}難道你不想... \n從生活中得到更多嗎？",
         "<25>{#p/sans}* 嘿，放輕鬆點。\n* 我的心裡可裝著\n  一大堆事務呢。",
      ...
      trivia: {
         ...
         s_trapnote: () =>
            [
               [
                  "<32>{#p/basic}* 這是張Papyrus留的字條...",
                  '<23>{#p/papyrus}{#f/30}「抱歉，到UNDYNE來之前，\n我得把你鎖在客房裡。」',
                  '<23>「把這裡當自己家\n一樣吧！！！」',
                  '<22>「已提供茶點和住宿。」',
                  '<#23>  「非常捏嘿嘿的，」\n  PAPYRUS'
               ],
      ...
      truetext: {
         ...
         puzzle1: () =>
            SAVE.data.b.svr
               ? ["<25>{#p/asriel1}{#f/20}* 不錯嘛，Frisk。\n* 沒想到\n  你還是個數學高手..."]
               : ['<32>{#p/basic}* 哇。\n* 你竟然真把它解開了？'],
         sans3: ['<32>{#p/basic}* 你盡力了。'],
         sans4: ['<32>{#p/basic}* 你以前做過這個嗎...？'],
         sans5: ['<32>{#p/basic}* 拜託，Sans。\n* 這「謎題」根本不值一看。'],
         sans6: ['<32>{#p/basic}* 拜託，Sans。\n* 這「謎題」根本不是人能做的啊。'],
      ...
      stardrakeSpacetopJerry: () =>
         world.goatbro
            ...
            : SAVE.data.b.spared_jerry
               ...
               : SAVE.data.b.s_state_chilldrake
                  ? ['<32>{#p/story}* Astro Serf和Chilldrake嘆著氣\n  來和你對峙了。\n* Jerry。']
                  : ['<32>{#p/story}* Astro Serf和Stardrake嘆著氣\n  來和你對峙了。\n* Jerry。'],
   ...
   b_opponent_jerry: {
      ...
      hurtStatus: () => (world.goatbro ? ['<32>{#p/asriel2}* 離死不遠了。'] : ['<32>{#p/story}* Jerry受了傷。']),
      idleTalk1: () =>
         SAVE.data.b.spared_jerry
      ...
      randStatus3: () =>
         SAVE.data.b.spared_jerry
            ...
            : ['<32>{#p/story}* Jerry打了個哈欠。'],
      randStatus4: () =>
         SAVE.data.b.spared_jerry
            ? ['<32>{#p/story}* Smells like...... Jerry?']
            : ['<32>{#p/story}* Smells like...... Jerry.'],
      status1: ['<32>{#p/story}* Jerry緊抓著你！'],
   ...
   b_opponent_mouse: {
      ...
      act_direct: ['<32>{#p/human}* （你告訴Whizkarat一個\n  關於老鼠的事實。'],
      act_direct2: [
      ...
      act_disown: [
         ...
         '<32>{#p/basic}* Whizkarat發出了刺耳的嘶嘶聲！'
      ],
      act_disown2: [
         "<32>{#p/human}* （你又拔下了Whizkarat\n  臉上的一根鬍鬚。）",
         '<32>{#p/basic}* Whizkarat吃痛，匆匆跑開了！'
      ],
      ...
      hurtStatus: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 離死不遠了。'] : ['<32>{#p/story}* Whizkarat快斷氣了。'],
      ...
      randStatus3: ['<32>{#p/story}* Whizkarat正試圖裝成\n  自己很小的樣子。'],
      ...
      status1: ['<32>{#p/story}* Whizkarat來了！']
   },
   b_opponent_doggo: {
      act_check: () =>
         world.goatbro
      ...
      act_cuddle: () => ['<32>{#p/human}* （你緊緊地抱住Doggo。）'],
      fetch: () => [
         '<32>{#p/human}* （你把扳手扔了出去。）\n* （狗狗跑出去撿了回來。）\n* （你們就這樣玩了一會巡迴遊戲。）'
      ],
      ...
      normaStatus: () => (world.goatbro ? ['<32>{#p/asriel2}* Doggo。'] : ["<32>{#p/story}* Doggo知道你在這裡。"]),
      pet: () => [
      ...
      status1: () => (world.goatbro ? ['<32>{#p/asriel2}* Doggo。'] : ['<32>{#p/story}* Doggo擋住了去路！']),
      sussy: () =>
         world.goatbro ? ['<32>{#p/asriel2}* Doggo。'] : ['<32>{#p/basic}* Doggo對你的行動\n  十分戒備。']
   },
   b_opponent_lesserdog: {
      ...
      act_handshake: [
         "<32>{#p/human}* （你把手放在Canis Minor的頭上\n  晃啊晃，撫摸著它的毛。）"
      ],
      act_inquire: [
         "<32>{#p/human}* （你撫摸著Canis Minor，\n  並問它好狗狗是誰。\n  它興奮地汪汪叫以示回答。）"
      ],
      act_tickle: [
         "<32>{#p/human}* （你抓撓著Canis Minor的側邊\n  來愛撫它。）\n* （它興奮得近於狂亂。）"
      ],
      fetch: () => [
         '<32>{#p/human}* （你把扳手扔了出去。）\n* （狗狗伸長脖子把扳手撿了回來。）',
         '<32>{#p/human}* （你們就這樣\n  玩了一會巡迴遊戲。）',
      ...
      fetchStatus: ['<32>{#p/story}* Canis Minor喜歡巡迴遊戲！'],
      fetchTalk: ['<11>{#p/basic}{~}（劇烈\n喘喘）'],
      hurtStatus: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 離死不遠了。']
            : ['<32>{#p/story}* Canis Minor將它的尾巴\n  夾到兩條腿之間。'],
      name: '* Canis Minor',
      ...
      status0: () => (world.goatbro ? ['<32>{#p/asriel2}* Canis Minor。'] : ['<32>{#p/story}* Canis Minor出現了。']),
      status1: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Canis Minor。']
            : ['<32>{#p/story}* Canis Minor將自己的頭\n  歪向一側。'],
      status2: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Canis Minor。']
            : ['<32>{#p/story}* Canis Minor覺得你的武器\n  是狗餅乾。'],
      status3: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Canis Minor。']
            : ['<32>{#p/story}* Canis Minor有點心不在焉。'],
      status4: () => (world.goatbro ? ['<32>{#p/asriel2}* Canis Minor。'] : ['<32>{#p/story}* 有一股狗糧的氣味。']),
      status5: () =>
         world.goatbro ? ['<32>{#p/asriel2}* Canis Minor。'] : ['<32>{#p/story}* Canis Minor在興奮地汪汪叫。'],
      status6: () =>
         world.goatbro ? ['<32>{#p/asriel2}* Canis Minor。'] : ['<32>{#p/story}* Canis Minor被過度刺激了。'],
      status7: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Canis Minor。']
            : ['<32>{#p/story}* Canis Minor看樣子\n根本停不下來。'],
      status8: () =>
         world.goatbro ? ['<32>{#p/asriel2}* Canis Minor。'] : ['<32>{#p/story}* Canis Minor正在下降。'],
      status9: () =>
         world.goatbro ? ['<32>{#p/asriel2}* Canis Minor。'] : ['<32>{#p/story}* Canis Minor正在嘗試著編碼。'],
      status10: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Canis Minor。']
            : ["<32>{#p/story}* Canis Minor由於看不見你\n而發出嗚嗚的哀鳴。"],
      status11: () => (world.goatbro ? ['<32>{#p/asriel2}* Canis Minor。'] : ['<32>{#p/story}* 你好啊。']),
      status12: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Canis Minor。']
            : ['<32>{#p/story}* Canis Minor對於你的生活選擇\n表示質疑。'],
      status13: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Canis Minor。']
            : ['<32>{#p/story}* Canis Minor去了沒有任何狗狗\n  到過的地方。']
   },
   b_opponent_dogamy: {
      act_check: () =>
         world.goatbro
      ...
      flirtText: [
         '<32>{#p/human}* （你向Dogamy調情。）',
         "<32>{#p/basic}* 你的... 資訊素，\n  傳到了Dogamy的鼻子上。"
      ],
      flirtTextLone: ['<32>{#p/human}* （你向Dogamy調情。）', "<32>{#p/basic}* Dogamy的表情沒有發生變化。"],
      loneStatus: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 只剩一個了。']
      ...
      petText: ['<32>{#p/human}* （你撫摸了Dogamy。）'],
      petTextLone: ['<32>{#p/human}* （你嘗試撫摸Dogamy，\n  但他畏懼地縮起自己的頭。）'],
      randTalk1: () =>
         world.goatbro
            ? ['<11>{#p/basic}{~}王子已經\n失去了\n理智...']
            : ["<11>{#p/basic}{~}帶走\n我老婆...\n身上的\n跳蚤。"],
   ...
   b_opponent_dogaressa: {
      act_check: () =>
         world.goatbro
            ...
            : ['<32>{#p/story}* DOGARESSA - 14攻擊 5防禦\n* 這隻小狗認為她丈夫很可愛。\n  僅限於氣味的那種？'],
      act_check2: ['<32>{#p/story}* DOGARESSA - 14攻擊 5防禦\n* 這隻小狗非常想念她的老公\n  僅限於被殺掉後的那種？'],
      act_check3: ['<32>{#p/story}* DOGARESSA - 14攻擊 5防禦\n* 對這隻小狗來說\n  事態進展得很順利。'],
      act_check4: [
         "<32>{#p/story}* DOGARESSA - 14攻擊 5防禦\n* 這隻小狗發覺可愛的東西\n  不只有她老公。"
      ],
      act_check5: ["<32>{#p/story}* DOGAMY - 攻擊14 防禦5\n* 這隻小狗在為她老公的安危擔憂。"],
      fetchTextLone: () => [
         '<32>{#p/human}* （你把扳手扔了出去。）\n* （Dogaressa將其撿了起來，然後摔了個粉碎。）',
         ...(world.goatbro && SAVE.flag.n.ga_asrielSpannerComment++ < 1 ? ['<32>{#p/asriel2}* 預料到了。'] : [])
      ],
      ...
      flirtText: [
         '<32>{#p/human}* （你向Dogaressa調情。）',
         "<32>{#p/basic}* 你的... 資訊素，\n  傳到了Dogaressa的鼻子上。"
      ],
      flirtTextLone: [
         '<32>{#p/human}* （你向Dogaressa調情。）',
         "<32>{#p/basic}* Dogaressa的表情沒有發生變化。"
      ],
      loneStatus: () =>
      ...
      resmellTextLone: [
         '<33>{#p/human}* （你激勵Dogaressa來聞聞你，\n  她用鼻子使勁在你臉上\n  蹭來蹭去。）'
      ],
      rollTextLone: () => [
         "<32>{#p/human}* （你在Dogamy的塵埃裡打了幾個滾。）",
         '<32>{#p/basic}* Dogaressa更瘋狂了。',
         ...(world.goatbro ? ['<32>{#p/asriel2}* ...'] : [])
      ],
   ...
   b_opponent_greatdog: {
      act_check: () =>
         world.goatbro
            ...
            : ["<32>{#p/story}* CANIS MAJOR - 15攻擊 8防禦\n* 太過興奮，以至於將\n  戰鬥當作兒戲。"],
      act_check2: ['<32>{#p/story}* CANIS MAJOR - 15攻擊 8防禦\n* 渴望著關愛與照顧...'],
      act_check3: ['<32>{#p/story}* CANIS MAJOR - 15攻擊 8防禦\n* 已經累到虛脫了。'],
      act_flirt: [
         '<32>{#p/human}* （你向Canis Major調情。）',
         '<32>{#p/basic}* Canis Major尷尬地歪著頭。'
      ],
      beckonText: [
      ...
      closeStatus: () =>
         world.goatbro ? ['<32>{#p/asriel2}* Canis Major。'] : ['<32>{#p/story}* Canis Major渴望著關愛。'],
      closeText: ["<32>{#p/human}* （你叫了叫Canis Major。）\n* （但狗狗只是豎了豎耳朵。）"],
      doneText: ['<32>{#p/basic}* Canis Major覺得你太無趣了。'],
      fetch: () =>
         world.goatbro
            ? [
      ...
      hurtStatus: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 離死不遠了。'] : ['<32>{#p/story}* Canis Major正緩緩地喘著氣。'],
      ignoreStatus1: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Canis Major。']
            : ['<32>{#p/story}* Canis Major只是想要一些關愛。'],
      ignoreStatus2: () =>
         world.goatbro ? ['<32>{#p/asriel2}* Canis Major。'] : ['<32>{#p/story}* Canis Major正在賣萌。'],
      name: '* Canis Major',
      fetchStatus: ['<32>{#p/story}* Canis Major喜歡巡迴遊戲！'],
      petStatus1: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Canis Major。']
            : ['<32>{#p/story}* Canis Major正用前爪拍打著地面。'],
      petStatus2: () =>
         world.goatbro ? ['<32>{#p/asriel2}* Canis Major。'] : ['<32>{#p/story}* Canis Major想要溫柔的關愛。'],
      petStatus3: () =>
         world.goatbro ? ['<32>{#p/asriel2}* ...'] : ['<32>{#p/story}* 撫摸能量，百分之四十！'],
      petStatus4: () =>
         world.goatbro ? ["<32>{#p/asriel2}* 不堪一擊。"] : ['<32>{#p/story}* Canis Major非常滿足。'],
      ...
      petText5: [
         ...
         '<32>{#p/basic}* Canis Major幸福地嗚叫著。'
      ],
      playText1: ['<32>{#p/human}* （但Canis Major不夠興奮，\n  不能和你一起玩。）'],
      playText2: [
         '<32>{#p/human}* （你變幻出了全息影像，想\n  讓狗狗去追趕它。）',
         '<32>* （最終，全息影像無法聚合，\n  自動消散了。）',
         '<32>* （Canis Major收集了這個區域\n  殘存的所有能量，並將其\n  帶還給你。）',
         '<32>{#p/basic}* 疲憊的Canis Major把頭\n  靠在了你身邊...'
      ],
      playText3: ['<32>{#p/basic}* Canis Major精疲力盡，\n  不想再玩了。'],
      playText4: ['<32>{#p/human}* （但是Canis Major已經開始在玩\n  巡迴遊戲了。）'],
      status0: () => (world.goatbro ? ['<32>{#p/asriel2}* Canis Major。'] : ['<32>{#p/story}* Canis Major出現了。']),
      status1: () =>
         world.goatbro ? ['<32>{#p/asriel2}* Canis Major。'] : ['<32>{#p/story}* Canis Major正緊緊地注視著你。'],
      status2: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Canis Major。']
   ...
   b_opponent_papyrus: {
      ...
      act_check: () =>
         world.genocide
            ...
            : papreal()
               ? ['<32>{#p/story}* PAPYRUS - 攻擊3 防禦3\n* 依然相信著你。']
               : ['<32>{#p/story}* PAPYRUS - 攻擊20 防禦20\n* 喜歡說「捏嘿嘿！」'],
      act_check2: ['<32>{#p/story}* PAPYRUS - 攻擊20 防禦20\n* 一切都很順利。'],
      act_check3: ['<32>{#p/story}* PAPYRUS - 攻擊20 防禦20\n* 最最最仁慈的衛兵！'],
      capture1: [
      ...
      flirt7: ['<32>{#p/human}* （但Papyrus現在忙於戰鬥，\n  沒時間聽你說話。）'],
      flirtStatus1: ['<32>{#p/story}* Papyrus正在為約會考慮\n  要穿什麼。'],
      flirtStatus2: ['<32>{#p/story}* Papyrus往他耳後拍了些\n  骨龍水。'],
      flirtStatus3: ['<32>{#p/story}* Papyrus正在為約會考慮\n  要煮什麼。'],
      flirtStatus4: ['<32>{#p/story}* Papyrus往他耳後拍了些\n  番茄醬。'],
      flirtStatus5: ['<32>{#p/story}* Papyrus正在想{@fill=#ff0}方色{@fill=#fff}法\n  變得出名。'],
      flirtStatus6: ['<32>{#p/story}* Papyrus往他耳後拍了些\n  MTT牌面霜。'],
      flirtStatus7: ['<32>{#p/story}* Papyrus往他耳後拍了些\n  MTT牌動漫粉。'],
      flirtStatus8: ['<32>{#p/story}* Papyrus往他耳後拍了些\n  MTT牌可愛汁。'],
      flirtStatus9: ["<32>{#p/story}* Papyrus意識到他沒有耳朵。"],
      flirtStatus10: ['<32>{#p/story}* Papyrus頭上隨便貼了一些藥膏。'],
      flirtStatus11: ["<32>{#p/story}* ...他還在想{@fill=#ff0}方色{@fill=#fff}法\n  變得出名。"],
      hurtStatus: ['<32>{#p/story}* Papyrus要被打敗了。'],
      ...
      insult4: ['<32>{#p/human}* （但Papyrus現在忙於戰鬥，\n  沒時間聽你說話。）'],
      name: '* Papyrus',
      randomStatus1: ['<32>{#p/story}* Papyrus正在準備一記\n  骨頭攻擊。'],
      randomStatus2: ['<32>{#p/story}* Papyrus準備了一記非骨頭攻擊，\n  然後花了一分鐘的時間來糾正錯誤。'],
      randomStatus3: ['<32>{#p/story}* Papyrus正在做飯。'],
      randomStatus4: ['<32>{#p/story}* Papyrus悄悄說了一句「捏嘿嘿！」'],
      randomStatus5: ['<32>{#p/story}* Papyrus正在左右搖晃他的骨頭。'],
      randomStatus6: ['<32>{#p/story}* Papyrus正在努力扮酷。'],
      randomStatus7: ['<32>{#p/story}* Papyrus正在考慮他的選擇。'],
      ...
      specialStatus0: ["<32>{#p/story}* Papyrus的氣場越來越強。"],
      specialStatus1: ['<32>{#p/story}* 特殊攻擊。'],
      specialStatus2: ['<32>{#p/story}* Papyrus正全力以赴。'],
      specialStatus3: ['<32>{#p/story}* Papyrus將所有邏輯都拋之腦後。'],
      specialStatus4: ['<32>{#p/story}* Papyrus發覺自己有些缺乏邏輯，\n  又把它撈回來了。'],
      specialStatus5: ['<32>{#p/story}* Papyrus汗流浹背。'],
      specialStatus6: ["<32>{#p/story}* Papyrus已經束手無策了。"],
      status1: ['<32>{#p/story}* Papyrus正在饒恕你。'],
      status2: ['<32>{#p/story}* Papyrus擋住了去路！'],
      ...
      turnTalk6: () =>
         world.postnoot
            ...
            : ['<15>{#p/papyrus}{#f/20}PAPYRUS:\n特戰隊成員！'],
      turnTalk7: ['<15>{#p/papyrus}{#f/10}UNDYNE一定會\n為我感到驕傲！！'],
   ...
   i_fryz: {
      ...
      drop: ["<32>{#p/human}* （你把烈焰Grillby像燃燒瓶一樣丟了出去。）"],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? ['<32>{#p/human}* （30 HP。）']
   ...
   c_call_papyrus: <Partial<CosmosKeyed<CosmosProvider<string[]>>>>{
      ...
      f_dummy: pager.create(
         ...
         () => [
            ...
            "<18>{#p/papyrus}{#f/5}迎接TEMMIE狂熱的心情。",
