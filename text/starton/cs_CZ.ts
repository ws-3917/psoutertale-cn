...
export default {
   a_starton: {
      telescope1: () => [
         ...(SAVE.data.b.svr ? [] : ['<32>{#p/basic}* Standardní dalekohled CITADEL s dlouhým dosahem, přibližně 261X.']),
         choicer.create('* (Použít dalekohled?)', 'Ano', 'Ne')
      ],
      telescopeMeetup1: ['<25>{#p/kidd}{#f/2}* Pozorujete hvězdy??'],
      telescopeMeetup2: [
         '<25>{#p/kidd}{#f/1}* Jo... Vsadím se, že jsi právě viděl něco opravdu skvělého.',
         '<25>{#f/7}* Když jsem se naposledy díval do dalekohledu, viděl jsem zatracenou'
      ],
      telescopeMeetup3: [
         '<25>{#p/kidd}{#f/3}* SUPERNOVU!\n* Zde.\n* Vezmi si tohle.',
         '<32>{#s/equip}{#p/human}* (Prémiový členský poukaz byl přidán do vašeho svazku klíčů.)',
         '<25>{#p/kidd}{#f/7}* Nyní můžete použít JAKÝKOLI dalekohled, dokonce',
         '<25>{#f/1}* i ty „prémiové“!\n* Ta krátká kostra mi jich předtím dala spoustu.',
         '<25>{#f/2}* Také mi dal nějakou digitální věc za spoustu peněz...',
         '<25>{#f/1}* Asi mě má opravdu rád, haha.'
      ],
      telescopeMeetup4: [
         '<25>{#p/kidd}{#f/3}* Každopádně jsem ti chtěl dát poukaz.',
         '<25>{#f/1}* Doufám, že s tím ale uvidíte něco skvělého!'
      ],
      telescopeMeetup5: ["<25>{#p/kidd}{#f/1}* Budu ve městě!"],
      telescope2: () =>
         SAVE.data.b.svr
            ? ['<25>{#p/asriel1}{#f/17}* Vidíte něco, co se vám líbí?']
            : SAVE.data.b.oops || SAVE.data.b.s_state_chargazer
               ? ['<32>{#p/basic}* Pozorování hvězd ve vesmíru...\n* Opravdu, to je nějaké nekonvenční myšlení.']
               : ((SAVE.data.b.s_state_chargazer = true),
                  [
                     '<32>{#p/basic}* ...',
                     '<32>* Asriel a já jsme měli dalekohled přesně takový.',
                     "<32>* Namířili jsme to náhodnými směry a doufali, že uvidíme něco vzrušujícího...",
                     '<32>* ... nikdy jsme toho moc neviděli.',
                     "<32>* Přesto se mu zdálo, že mu na tom nezáleží...",
                     '<32>* Zatímco já jsem se soustředil na to, abych se díval ven, on byl prostě šťastný,',
                     '<32>* že může trávit čas se mnou.\n<32>* ...',
                     '<32>{#p/human}* (Slyšíte povzdech.)',
                     "<32>{#p/basic}* ... Vraťme se k tomu, co jsme dělali."
                  ]),
      notv: ["<32>{#p/basic}* Nezdá se, že by tu bylo něco zajímavého ke sledování."],
      nicecreamScoreReaction1a: ['<32>{#p/basic}* To není špatné na váš první pokus...'],
      nicecreamScoreReaction1b: ['<32>{#p/basic}* Na první pokus to není špatné.'],
      nicecreamScoreReaction2a: ['<32>{#p/basic}* Můžete to udělat lépe...'],
      nicecreamScoreReaction2b: ['<32>{#p/basic}* Můžete to udělat lépe.'],
      nicecreamScoreReaction3a: [
         "<32>{#p/basic}* Porazil jsi nejlepšího střelce...?\n* Myslím, že jsem nikdy neviděl nikoho něco takového udělat..."
      ],
      nicecreamScoreReaction3b: [
         "<32>{#p/basic}* Porazili jste nejlepšího střelce?\n* Myslím, že jsem nikdy neviděl nikoho něco takového udělat!"
      ],
      nicecreamScoreReaction4a: ['<33>{#p/basic}* Zdá se, že jsi v tom docela dobrý...'],
      nicecreamScoreReaction4b: ['<32>{#p/basic}* Zdá se, že jste v tom docela dobrý.'],
      nicecreamScoreReaction5a: ['<32>{#p/basic}* Překonal jsi své nejvyšší skóre...?'],
      nicecreamScoreReaction5b: ['<32>{#p/basic}* Podívejte se na to, nové vysoké skóre!'],
      nicecreamScoreReaction6a: ['<32>{#p/basic}* Na vteřinu jsem si myslel, že porazíš nejlepšího střelce...'],
      nicecreamScoreReaction6b: [
         "<32>{#p/basic}* Páni, mohli jste porazit nejlepšího střelce!\n* Dokážete jít až do konce?"
      ],
      nicecreamScoreReaction7a: ['<32>{#p/basic}* Vypadá to, že by se ti hodila trocha cviku...'],
      nicecreamScoreReaction7b: ['<32>{#p/basic}* Vypadá to, že by se ti hodila trocha tréninku.'],
      nicecreamScoreReaction8a: ["<32>{#p/basic}* To je lepší..."],
      nicecreamScoreReaction8b: ["<32>{#p/basic}* To je spíš ono."],
      nicecreamScoreReaction9a: [
         '<32>{#p/basic}* Překonali jste nejlepšího střelce na první pokus...?\n*Jak je proboha možné...'
      ],
      nicecreamScoreReaction9b: ["<32>{#p/basic}* Překonali jste nejlepšího střelce na první pokus?\n* Jste přirozený!"],
      nicecreamScoreReaction10a: ["<32>{#p/basic}* Na první pokus je to docela dobré..."],
      nicecreamScoreReaction10b: ["<32>{#p/basic}* Na první pokus je to docela dobré!"],
      nicecreamScoreReaction11a: ['<32>{#p/basic}* Pořád se dostáváš tak blízko...'],
      nicecreamScoreReaction11b: ['<32>{#p/basic}* Sakra, zase jsi málem překonal nejlepšího střelce...\n* Můžeš to udělat!'],
      noteleport: ["<32>{#p/human}* (Zdá se, že už není zapnutý.)"],
      evac: ['<32>{#p/human}* (Cítíš, jak se přítomnost blízkého monstra zmenšuje.)'],
      shopclosed: ['<32>{#p/human}* (Ale ti tu nezbývalo nic.)'],
      jukebox0: ["<32>{#p/basic}* Je mimo provoz."],
      jukebox1: () => [
         SAVE.data.b.svr
            ? '<32>{#p/human}* (Sáhneš po jukeboxu...)'
            : "<32>{#p/basic}* Tento jukebox přehrává pouze hudbu, kterou jste již slyšeli.",
         choicer.create(
            '* (Přehrát písničku?)',
            SAVE.data.b.napsta_performance ? 'Trasa 01' : '???',
            2 <= SAVE.data.n.state_foundry_swansong ? 'Trasa 02' : '???',
            2 <= SAVE.data.n.state_starton_trashprogress ? 'Trasa 03' : '???',
            'Zrušit'
         )
      ],
      jukebox1x1: () =>
         SAVE.data.b.svr
            ? ["<32>{#p/human}* (Ale nemohli jste zahrát písničku, kterou jste ještě neznali.)"]
            : ["<32>{#p/basic}* Na obalu je vyobrazen strašidelný DJ hrající pro dav.\n* Tuhle píseň nemůžete znát."],
      jukebox1x2: () =>
         SAVE.data.b.svr
            ? ["<32>{#p/human}* (Ale nemohli jste zahrát písničku, kterou jste ještě neznali.)"]
            : ["<33>{#p/basic}* Na obálce je vyobrazen strašidelný DJ u počítače.\n* Tuhle píseň nemůžete znát."],
      jukebox1x3: () =>
         SAVE.data.b.svr
            ? ["<32>{#p/human}* (Ale nemohli jste zahrát písničku, kterou jste ještě neznali.)"]
            : [
               "<32>{#p/basic}* Na obálce je vyobrazen malý bílý pes obklopený odpadky.\n* Tuhle píseň nemůžete znát."
            ],
      jukebox1y: ['<32>{*}{#p/human}* (Vybrali jste disk...) {^40} {%}'],
      jukebox2: () => [
         SAVE.data.b.svr
            ? '<32>{#p/human}* (Zní to, jako by právě hrála nějaká písnička.)'
            : [
               '<32>{#p/basic}* Aktuálně se přehrává \"Trasa 01\"',
               '<32>{#p/basic}* Aktuálně se přehrává \"Trasa 02\"',
               '<32>{#p/basic}* Aktuálně se přehrává \"Trasa 03\"'
            ][SAVE.data.n.state_starton_jukebox - 1],
         choicer.create('* (Zastavit přehrávání?)', 'Ano', 'Ne')
      ],
      jukebox3a1: ["<32>{#p/basic}{#npc/a}* To je spíš ono!"],
      jukebox3a2: ['<32>{#p/basic}{#npc/a}* (Tento druh hudby milujeme.)'],
      jukebox3b: ['<32>{#p/basic}{#npc/a}* Je to ta písnička, která koluje v tanečním klubu?'],
      jukebox3c: [
         '<32>{#p/basic}* ...\n* ...\n* ...',
         "<32>{#npc/a}* Grillbz říká, že tuhle píseň už někde slyšel."
      ],
      jukebox3d: [
         '<32>{#p/basic}{#npc/a}* Určitě znáš spoustu hudby z ruky, chlapče...',
         '<32>* Musíš být opravdu chutná.'
      ],
      shockpapyrus0a: [
         '<15>{#p/papyrus}{#e/papyrus/27}CO SE TO TU DĚJE??',
         '<15>{#p/papyrus}{#e/papyrus/21}PŘIJÍMÁM TELEFONNÍ HOVOR Z BALKONU...',
         '<15>{#p/papyrus}{#e/papyrus/19}A TAM MĚ TO VEDE!?',
         "<15>{#p/papyrus}{#e/papyrus/14}ŘEKNU VÁM, ŽE JSEM BOTA PRO KRÁLOVSKOU GARDU.",
         '<15>{#p/papyrus}{#e/papyrus/15}TAKŽE, AŤ UŽ VY DVA PLÁNUJETE COKOLI...'
      ],
      shockpapyrus0b: [
         '<15>{#p/papyrus}{#e/papyrus/24}... POČKAT, TEN HLAS...',
         '<15>{#p/papyrus}{#e/papyrus/22}JSI TO TY, KDO MI PŘEDTÍM VOLAL!?'
      ],
      shockpapyrus0c: [
         '<15>{#p/papyrus}{#e/papyrus/20}... SAMOZŘEJMĚ!\nTÍM SE VYSVĚTLUJE VŠECHNO!',
         "<15>{#p/papyrus}{#e/papyrus/10}TAK DOBŘE.\nJSEM RÁD, ŽE JSEM VÁS KONEČNĚ POTKAL.",
         '<15>{#p/papyrus}{#e/papyrus/24}ABYCH BYL UPŘÍMNÝ, TAK TROCHU MI PŘIPOMÍNÁTE...',
         '<15>{#p/papyrus}{#e/papyrus/20}... HEJ, POČKEJTE CHVÍLI!!',
         '<15>{#p/papyrus}{#e/papyrus/22}PŘIVEDL JSI S SEBOU ČLOVĚKA?!?',
         '<15>{#p/papyrus}{#e/papyrus/10}WOWIE!!\nTOHLE JE PROSTĚ LEPŠÍ A LEPŠÍ!!',
         '<15>{#p/papyrus}{#e/papyrus/20}TAKŽE, CO TU VLASTNĚ DĚLÁME?'
      ],
      shockpapyrus1: () =>
         [
            [
               '<32>{#p/asriel2}* Připraven, $(name)?',
               choicer.create('* (Co by měl Asriel dělat?)', 'Péče', 'Akce', 'Magie', 'Boj')
            ],
            ["<32>{#p/asriel2}* Pojďme to mít za sebou."]
         ][Math.min(SAVE.flag.n.ga_asrielPapyrus, 1)],
      shockpapyrus2a: [
         '<32>{#p/asriel2}* Péče, co?',
         '<32>{#p/asriel2}* Péče... Myslím, že se mi to slovo líbí.',
         '<32>{#p/asriel2}* Ukažme mu trochu \"Péče\".'
      ],
      shockpapyrus2b: [
         "<32>{#p/asriel2}* Akce...?\n* Ukážu vám, jak se chovat.",
         '<32>{#p/asriel2}* Nejprve zvedneš ruku...',
         '<32>{#p/asriel2}* Pak...!'
      ],
      shockpapyrus2c: [
         '<32>{#p/asriel2}* Magie.\nSíla, která nás monstra spojuje.',
         '<32>{#p/asriel2}* Nebo, v tomto případě...',
         '<33>{#p/asriel2}* Síla, která je roztrhá na kusy.'
      ],
      shockpapyrus2d: ['<32>{#p/asriel2}* Boj... ideální volbou.', '<32>{#p/asriel2}* Hee hee hee...'],
      sansDeath1: ["<15>{#p/papyrus}{#e/papyrus/27}SANS!\nJSI ZRANĚN!"],
      sansDeath2: ["<20>{#p/sans}papyrus, neříkal jsem ti, abys zůstal doma?", '{*}{#e/papyrus/21}{%}'],
      sansDeath3: ["<20>{#p/sans}... Neboj se, brácho, je to jen yamok omáčka.", '{*}{#e/papyrus/26}{%}'],
      sansDeath4: ["<15>{#p/papyrus}{#e/papyrus/21}ALE JSI ZRANĚNÝ..."],
      sansDeath5: [
         "<20>{#p/sans}ano, to je to, co se stane, když jednáte instinktivně.",
         '<20>{#p/sans}... teď už s tím moc dělat nemůžu.',
         '{*}{#e/papyrus/21}{%}'
      ],
      sansDeath6: [
         '<20>{#p/sans}takže...',
         ...
         '<20>...',
         '<20>jen...',
         "<20>slib mi, že beze mě budeš v pohodě, brácho.",
         "<20>slib mi, že budeš s-{^5}skvělý.",
         '<20>...',
         '<20>koneckonců...'
      ],
      sansDeath7: ["<20>{|} {#p/sans}ty jsi... velký p-{^5}papyrus. {^20} {%}"],
      sansDeath8: ['<15>{#p/papyrus}{#e/papyrus/33}N-NE... {^40} {%}'],
      fast_food1: () => [
         SAVE.data.b.fryz
            ? "<32>{#p/human}{#npc}* (Dostali jste Flamin' Grillby.)"
            : '<32>{#p/human}{#npc}* (Dostali jste posuvníky.)'
      ],
      fast_food2: ["<32>{#p/human}{#npc}* (Nesete toho příliš mnoho.)"],
      aussie: pager.create(
         0,
         () =>
            SAVE.data.n.state_starton_trashprogress < 1
               ? [
                  '<25>{#p/sans}{#f/0}* konečně.',
                  "<25>{#f/3}* zajímalo by mě, kdy se objevíte.",
                  '<25>{#f/0}* nevím, jestli si vzpomínáte, ale když jsme se poprvé setkali...',
                  '<25>{#f/0}* řekl jsem papyrusovi, aby se více zaměřil na \"závažnost\" situace.',
                  '<25>{#f/0}* ptáte se, co jsem tím myslel?',
                  '<25>{#f/3}* no.',
                  "<25>{#f/2}* chystáte se {@fill=#003cff}zjistit{@fill=#fff}."
               ]
               : ['<25>{#p/sans}{#f/0}* vítejte zpět.', '<25>{#f/2}* jste připraveni zjistit, co vás čeká?'],
         () =>
            SAVE.data.n.state_starton_trashprogress < 1
               ? ['<25>{#p/sans}{#f/0}* pokračujte, podívejte se.', "<25>{#f/2}* to je přesně tam, jelene."]
               : ["<25>{#p/sans}{#f/2}* to je přesně tam, jelene."],
         () =>
            SAVE.data.n.state_starton_trashprogress < 2
               ? ["<25>{#p/sans}{#f/2}* nebojte se, není to nebezpečné... i když se o to snaží."]
               : ['<25>{#p/sans}{#f/2}* díky za pomoc.']
      ),
      trashhunt1: [
         '<25>{#p/sans}{#f/0}* takže... co si myslíš?',
         '<25>{#f/3}* říkám jí \"odpadková planeta\".',
         "<25>{#f/0}* ... ve skutečnosti se tahle věc už nějakou dobu zvětšuje.",
         '<25>{#f/0}* pokud se to ještě zvětší, no...',
         "<25>{#f/2}* řekněme, že bychom se ocitli{@fill=#ff0}ve světě{@fill=#fff}.",
         "<25>{#f/0}* ale nebojte se.\n* s vaší pomocí bude během chvilky pryč.",
         '<25>{#f/2}* dokonce jsem vám našel nějakou hudbu, která vás motivovala.'
      ],
      trashhunt2: '* Opakovaným stisknutím tlačítka [Z] zatřeste\n  Ven ze všech těch odpadků!',
      trashhunt3: () => [
         '<25>{#p/sans}{#f/3}* páni.\n* všechno najednou, co?',
         "<25>{#f/2}* ... no, budu obrácená vzhůru nohama.",
         '<25>{#f/0}* asi vám musím dát nějakou odměnu.',
         '<25>{#f/0}* ...\n* tady.\n* mějte to na sobě.',
         '<32>{#p/human}* (Sans ti něco hodil.)',
         ...(SAVE.storage.inventory.size < 8
            ? ['<32>{#s/equip}{#p/human}* (Máš meč kukuřičného psa.)', '<25>{#p/sans}{#f/2}* ho používejte moudře.']
            : [
               "<32>{#p/human}* (Nesete toho příliš mnoho.)",
               '<25>{#p/sans}{#f/3}* není místo, co?',
               "<25>{#p/sans}{#f/2}* nebojte se.\n* nechám ti ho ve svém pokoji."
            ])
      ],
      gravo1: () =>
         SAVE.data.b.svr
            ? [
               '<32>{#p/human}* (Zvědavě se díváte na zdánlivě neužitečné zařízení.)',
               ...[["<25>{#p/asriel1}{#f/17}* Škoda, že na tuhle věc nemáme ovladač, co?"], []][
               Math.min(asrielinter.gravo1++, 1)
               ]
            ]
            : ['<32>{#p/basic}* Je to \"gravometrický invertor\".', '<32>* Ať už to znamená cokoli.'],
      gravo3: () => [
         '<32>{#p/human}* (Používáte dálkový ovladač gravometrického invertoru.)\n* (Nic se neděje.)',
         ...(SAVE.data.b.svr
            ? [["<25>{#p/asriel1}{#f/21}* Pravděpodobně vypínají napájení pro nepodstatná zařízení."], []][
            Math.min(asrielinter.gravo3++, 1)
            ]
            : ['<32>{#p/basic}* Musí být offline...'])
      ],
      gravo2: ['<32>{#p/human}* (Používáte dálkový ovladač gravometrického invertoru.)'],
      sansdoor1: () =>
         SAVE.data.b.svr || world.runaway
            ? ['<32>{#p/human}* (Zdá se, že byla uzavřena těsněním uzamyka.)']
            : ["<32>{#p/basic}* Je zamčený."],
      sansdoor2: ['<32>{#p/human}* (Používáte klíč kostry.)'],
      sanscab1: () => [
         ...(SAVE.data.b.svr ? [] : ["<32>{#p/basic}* Uvnitř této obálky je podivný dálkový ovladač."]),
         '<32>{#s/equip}{#p/human}* (Dálkový ovladač Gravometric Inverter Remote byl přidán do vaší klíčenky.)'
      ],
      sanscab2: () =>
         SAVE.data.b.svr
            ? ['<32>{#p/human}* (Ale vy jste již vyprázdnil obálku s jejím obsahem.)']
            : ["<32>{#p/basic}* Je to jen prázdná obálka."],
      sanscab3: () => [
         ...(SAVE.data.b.svr ? [] : ["<32>{#p/basic}* Je tu zvláštní... uvnitř této obálky."]),
         SAVE.storage.inventory.size < 8
            ? '<32>{#s/equip}{#p/human}* (Máš meč kukuřičného psa.)'
            : "<32>{#p/human}* (Nesete toho příliš mnoho.)"
      ],
      cream_get: ['<32>{#p/human}* (Dostali jste ledový sen.)'],
      cream_deny: ['<32>{#p/basic}* Nic nezbylo.'],
      cream_full: ["<32>{#p/human}* (Nesete toho příliš mnoho.)"],
      cream_get_archive: [
         '<32>{#p/human}* (Sáhneš do vozíku.)',
         '<32>{#p/human}{#s/equip}* (Dostali jste ledový sen.)'
      ],
      cream_empty_archive: ['<32>{#p/human}* (Sáhneš do vozíku.)', '<32>{#p/human}* (...)'],
      cream_full_archive: ["<32>{#p/human}* (Neseš toho příliš mnoho, než abys dosáhl dovnitř.)"],
      bunbun: pager.create(
         0,
         () =>
            SAVE.data.n.plot === 72
               ? ["<32>{#p/basic}* Máma říká, že brzy odjíždíme na nový domovský svět.", "<32>* ... co je to domovský svět?"]
               : [
                  '<32>{#p/základní}* Máma říká, že spánek vám může obnovit zdraví {@fill=#ff0} nad vaše maximální ZB{@fill=#fff}.',
                  "<32>* ... co je maximální ZB?"
               ],
         () =>
            SAVE.data.n.plot === 72
               ? ['<32>{#p/basic}* Mají lidé domovský svět?']
               : ['<32>{#p/basic}* Je to něco, co mají příšery?']
      ),
      emptytable1: () =>
         SAVE.data.b.svr
      ...
      bedbook4: () => [choicer.create('* (Have $(name) read the book?)', 'Ano', 'Ne')],
      bedbook5: [
         '<32>{#p/basic}* Okay, here goes...',
         '<32>* \"Před dávnými časy vládly sluneční soustavě dva druhy: lidé a monstra.\"',
         '<32>* \"Zpočátku byly příšery jen návštěvníky, kteří se brzy vrátí do svého vlastního hvězdného systému.\"',
         '<32>* \"Ale příšery byly lidstvem fascinovány a chtěly s nimi koexistovat.\"',
      ...
      crossword2: (check: boolean) =>
         world.edgy
            ...
            : [
               ...
               '<25>{#p/sans}* cože? vážně, kámo?\n* to snadné zamíchání čísel?',
               "<25>{#f/4}* to je pro dětské kostry",
               '<18>{#p/papyrus}{#f/4}UN. BELIEVABLE.',
               '<18>{#f/9}HUMAN!!!\nSOLVE THIS DISPUTE!',
               choicer.create('* (Které je těžší?)', 'Sudoku', 'Kakuro')
            ],
      crossword3a: [
         '<18>{#p/papyrus}HA! HA! ANO!',
      ...
      genotext: {
         asriel1: () =>
            [['<25>{#p/asriel2}{#f/9}* Just follow my lead...'], ['<25>{#p/asriel2}{#f/16}* Tudy.']][
         ...
         asriel9: ["<25>{#p/asriel2}{#f/8}* Psst, počkejme a uvidíme, co udělá."],
         asriel10: () =>
            [
               [
      ...
      innkeep1b: pager.create(
         ...
         () => [
            ...
            choicer.create('* (Get a room again?)', 'Ano', 'Ne')
         ],
         () => ['<32>{#p/basic}{#npc/a}* Changed your mind?', choicer.create('* (Get a room again?)', 'Ano', 'Ne')]
      ),
      ...
      nicecreamPrompt1: () => [choicer.create('* (Buy the Ice Dream for $(x)G?)', 'Ano', 'Ne')],
      nicecreamPrompt2: () => [choicer.create('* (Get an Ice Dream?)', 'Ano', 'Ne')],
      nicecreamSc4: [
         ...
         papmail1: () =>
            SAVE.data.b.svr
               ...
               : [
                  ...
                  choicer.create('* (Look inside the mailbox?)', 'Ano', 'Ne')
               ],
         ...
         () =>
            postSIGMA()
               ...
               : [
                  ...
                  choicer.create("* (Log in to Papyrus's account?)", 'Ano', 'Ne')
               ],
         () =>
            postSIGMA()
               ? ["<32>{#p/basic}* Je mimo provoz."]
      ...
      papcouch1: pager.create(
         ...
         () => [
            ...
            choicer.create('* (Take the coins?)', 'Ano', 'Ne')
         ],
         () => [
            SAVE.data.b.svr
      ...
      papdate30: () => [choicer.create('* (Do you know what it is?)', 'Ano', 'Ne')],
      papdate31a: [
      ...
      puzzle3: () => [
         ...
         choicer.create('* (View the pattern?)', 'Ano', 'Ne')
      ],
      robotx: () =>
         SAVE.data.b.svr
      ...
      robot1: pager.create(
         ...
         () => [
            ...
            choicer.create('* (Take a chip?)', 'Ano', 'Ne')
         ],
         () => [
      ...
      robot6: () => [
         ...
         choicer.create('* (Take another chip?)', 'Ano', 'Ne')
      ],
      robot7: [
      ...
      sansbook2: () => [choicer.create('* (Take a look inside?)', 'Ano', 'Ne')],
      ...
      trivia: {
         ...
         s_grillbys_beegstool: () =>
            SAVE.data.b.svr
               ? ['<25>{#p/asriel1}{#f/20}* Myslím, že by to pro tebe mohlo být trochu vysoké.']
               : world.darker
      ...
      a_hub5: pager.create(
         ...
         () =>
            solo()
               ...
               : ['<18>{#p/papyrus}{#f/6}PŘESTAŇTE SI DĚLAT STAROSTI!!']
      )
   },

   s_save_starton: {
      s_crossroads: {
         name: 'Starton - Přistávací zóna',
         text: () =>
            SAVE.data.n.plot < 29
               ? world.edgy
      ...
      s_pacing: {
         name: 'Starton - Měsíční skalní cesta',
         text: () =>
      ...
      s_spaghetti: {
         name: 'Starton - Špagetová křižovatka',
         text: () =>
            [
         ...
         text: () =>
            SAVE.data.b.svr
               ...
               : papreal() || world.runaway
                  ...
                  : ['<32>{#p/human}* (Toto roztomilé městečko vás naplní odhodláním.)']
      }
   }
};
