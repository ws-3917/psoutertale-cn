...
export default {
   a_starton: {
      ...
      papspaghet1a: () => [
         ...
         "<18>{#f/0}你带着它呢！！",
         '<18>{#f/9}人类，你怎么打算的？',
         choicer.create("* （你要拿帕派瑞斯的意面怎么办呢？）", '一起吃吧', '吃掉'),
         '<18>{#p/papyrus}真的！？'
      ],
      papspaghet2a: [
         "<18>{#f/5}你抗拒我做的\n意大利面的味道...",
   ...
   b_group_starton: {
      dogs: () => (world.goatbro ? ['<32>{#p/asriel2}* 狗来米和狗媳儿。'] : ['<32>{#p/story}* 狗夫妇向你发起攻击！']),
      spacetopJerry: () =>
         world.goatbro
   ...
   b_opponent_lesserdog: {
      ...
      fetchStatus: ['<32>{#p/story}* 小犬座喜欢巡回游戏！'],
   ...
   b_opponent_papyrus: {
      ...
      flirtStatus8: ['<32>{#p/story}* 帕派瑞斯往他耳后拍了些\n  镁塔牌可爱汁。'],
