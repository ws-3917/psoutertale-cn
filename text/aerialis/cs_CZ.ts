...
export default {
   a_aerialis: {
      coreterminal: () => [
         ...(SAVE.data.b.svr
            ? ['<32>{#p/human}* (Zdá se, že terminál je mimo vaši úroveň přístupu.)']
            : world.runaway
               ? ["<32>{#p/basic}* Je to CORE terminál.\n* Zdá se, že nedostává moc energie."]
               : [
                  world.postnoot
                     ? "<32>{#p/basic}* Je to CORE terminál.\n* Nedávno byly zpřístupněny atmosférické systémy."
                     : world.bad_robot && 68 <= SAVE.data.n.plot
                        ? "<32>{#p/basic}* Je to CORE terminál.\n* Zdá se, že dochází energie."
                        : "<32>{#p/basic}* Je to CORE terminál.\n* Zdá se, že běží dobře.",
                  ...(!world.genocide && !world.badder_lizard && SAVE.data.b.a_state_corecall && SAVE.data.n.plot < 68
                     ? [
                        ["<25>{#p/alphys}{#g/alphysOhGodNo}* Prosím, nedotýkejte se jich!!"],
                        ['<25>{#p/alphys}{#g/alphysNeutralSweat}* Vážně.'],
         ...
         ...(world.meanie && !world.genocide && world.badder_lizard
            ? [
               "<32>{#p/human}* (Všimli jste si, že jste sami.)",
               "<32>{#p/human}* (Přestože víte, že by to zhroutilo atmosféru základny, něco zvažujete.)",
               choicer.create('* (Rozbít terminál?)', 'Ano', 'Ne')
            ]
            : [])
      ],
      termsmash1: ['<32>{#p/human}* (Rozhodnete se nerozbít.)'],
      termsmash2: ['<32>{#p/human}* (Máš švih...)'],
      puzzlenoot1: () => [
         '<32>{#s/phone}{#p/event}* Zvoní, zvoní...',
         world.nootflags.has('a_barricade1') // NO-TRANSLATE

            ? '<25>{#p/alphys}{#g/alphysInquisitive}* Vyřešila se hádanka také sama?'
            : "<25>{#p/alphys}{#g/alphysInquisitive}* Hm, hádanka vypadá, že už je vyřešená.",
         '<25>{#p/alphys}{#g/alphysFR}* To je zvláštní.',
         '<32>{#s/equip}{#p/event}* Klikněte...'
      ],
      puzzlenoot2: () => [
         '<32>{#s/phone}{#p/event}* Zvoní, zvoní...',
         world.nootflags.has('a_puzzle1') // NO-TRANSLATE

            ? "<25>{#p/alphys}{#g/alphysWelp}* A tenhle.\n* Tohle je také vyřešeno."
            : "<25>{#p/alphys}{#g/alphysWelp}* Huh... vypadá to, že hádanku už někdo udělal.",
         "<25>{#p/alphys}{#g/alphysUhButHeresTheDeal}* Vezmeme to!!",
         '<32>{#s/equip}{#p/event}* Klikněte...'
      ],
      noequip: ['<32>{#p/human}* (Rozhodneš se nevybavit.)'],
      evac: ['<32>{#p/human}* (Cítíš, jak se přítomnost blízkého monstra zmenšuje.)'],
      endo: ['<32>{#p/human}* (Všimli jste si špatné kvality této tabulky.)'],
      businessKILLER: [
      ...
      corndog1: pager.create(
         ...
         () => [
            ...
            choicer.create('* (Buy the Corn Dog for 5G?)', 'Ano', 'Ne')
         ],
         () => ['<25>{#p/sans}{#f/0}* corn dogs for 5G.', choicer.create('* (Buy the Corn Dog for 5G?)', 'Ano', 'Ne')]
      ),
      corndog2: [
      ...
      spidershop1: () => [
         SAVE.data.n.plot === 72
            ? choicer.create('* (Leave 36G in the web?)', 'Ano', 'Ne')
            : choicer.create('* (Leave 56G in the web?)', 'Ano', 'Ne')
      ],
      spidershop2: [
      ...
      hotelfood0: () =>
         SAVE.data.b.svr
            ? [
               ...
               choicer.create('* (Take the food?)', 'Ano', 'Ne')
            ]
            : ["<33>{#p/basic}* It's a kind of mysterious food.", choicer.create('* (Take the food?)', 'Ano', 'Ne')],
      hotelfood1: () => [
      ...
      sonic1: () => [
         ...
         choicer.create('* (Equip the Sonic Resonator?)', 'Ano', 'Ne')
      ],
      sonic2: ["<32>{#p/human}* (You're carrying too much to take that.)"],
      tablaphone1: () => [
         '<32>{#p/human}* (You got the Tablaphone.)',
         choicer.create('* (Equip the Tablaphone?)', 'Ano', 'Ne')
      ],
      ...
      story: {
         ...
         barricade3: () => [
            ...
            choicer.create('* (What do you say?)', 'Model 42', 'Hapstablook', 'Aidrian', 'Mettaton') 
         ],
         barricade3b1: [
               ...
               : [
                  ...(!SAVE.storage.inventory.has('tvm_mewmew') && // NO-TRANSLATE
                     ...
                     : [
                        ...
                        '<25>{#f/3}* Please?',
                        choicer.create('* (Give back the Mew Mew doll?)', 'Ano', 'Ne')
                     ])
               ])
         ],
         opera36b1: [
      ...
      overworld: {
         ...
         doublefridge2: () => [
            ...
            choicer.create('* (Take the opened bottle?)', 'Ano', 'Ne')
         ],
         ...
         exofountain1: () => [
            ...
            choicer.create('* (Take a sip?)', 'Ano', 'Ne')
         ],
         ...
         topdesk1: () =>
            SAVE.data.b.svr || world.bad_lizard > 1 || world.genocide || SAVE.data.n.state_foundry_undyne === 2
               ...
               : [
                  ...
                  choicer.create('* (Turn on the computer?)', 'Ano', 'Ne')
               ],
      ...
      dinnerdate1: pager.create(
         ...
         () => [
            ...
            choicer.create('* (Have dinner?)', 'Ano', 'Ne')
         ],
         () => ['<25>{#p/sans}{#f/2}* changed your mind?', choicer.create('* (Have dinner?)', 'Ano', 'Ne')]
      ),
      ...
      candy1: () =>
         postSIGMA()
            ...
            : [
               ...
               choicer.create('* (Buy the Filament for 40G?)', 'Ano', 'Ne')
            ],
            ...
            SAVE.data.n.plot === 72
               ...
               : SAVE.data.b.killed_mettaton
                  ...
                  : [
                     ...
                     choicer.create('* (Own a room?)', 'Ano', 'Ne')
                  ],
         () =>
            SAVE.data.n.plot === 72
