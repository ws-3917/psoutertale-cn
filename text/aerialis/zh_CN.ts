...
export default {
   a_aerialis: {
      ...
      story: {
         ...
         rg1b1: () =>
            world.bad_lizard > 1
               ? [ '<32>{#p/basic}{#x1}* 前面的，给个说法：\n  为啥把人都杀了？{#x3}' ]
               : [ '<32>{#p/basic}{#x1}* 请问，你知道\n  附近哪里有卖冰淇淋的吗？{#x3}' ],
         rg1b2: () =>
            world.bad_lizard > 1
...
'<32>* “当前的真实时间\n  应为克历625年9月。”'
      ...
      genotext: {
         ...
         azzyBpants: [ '<25>{#p/asriel2}{#f/8}* 我勒个去。\n* 这家伙怎么还在这。' ]
      },
      coreswitched: () =>
         SAVE.data.b.svr
      ...
      onionsan4a: [ "<32>{*}{#p/basic}* 咱都会自由哒啊啊啊啊啊啊啊啊啊{^999}" ],
      onionsan4x: [ '<25>{#p/asriel2}{#f/8}* 当然喽。' ],
      candy1: () =>
         postSIGMA()
            ? [ "<32>{#p/basic}* 停机了。" ]
            : [
      ...
      core13: [
         "<25>{#p/alphys}{#g/alphysGarbo}* 两开关你都按了。",
         '<25>{#p/alphys}{#g/alphysGarboCenter}* 这下开心了吗？'
      ],
      core14: () => [
         "<25>{#p/alphys}{#g/alphysWelp}* 停一下，前面有个人。",
         '<25>{#p/alphys}{#g/alphysNeutralSweat}* 我看看我这回\n  能不能直接扫清障碍...',
         SAVE.data.b.ubershortcut
            ? '<32>{#p/human}* (It sounds like someone is furiously typing at a keyboard.)'
            : '<32>{|}{#p/human}* (Yet again, the obligatory- {%}',
         "<25>{#p/alphys}{#g/alphysCutscene3}* 那人不在内部通信系统上。",
         "<25>{#g/alphysUhButHeresTheDeal}* 那人甚至不是守卫中的一员！",
         '<25>{#g/alphysWelp}* ...这很不妙。'
      ],
      core14a: [
         '<32>{#p/basic}* 以为只要走过这座桥，\n  就能到对面了？',
         "<32>* Oouhuhu...\n* I'm afraid, dear comm-raid..."
      ],
      core14b: [ "<32>{#p/basic}* 你得再好好想想了！{%20}" ],
      core15: () =>
         !world.killed_mushketeer
            ? [ '<25>{#p/alphys}{#g/alphysNeutralSweat}* 结... 结束了？', '<25>* 我们能前进了？' ]
            : [
   ...
   b_opponent_madjick: {
      ...
      idleStatus1: () =>
         !world.badder_lizard ? [ "<32>{#p/alphys}* 这是Cozmo。" ] : [ '<32>{#p/story}* Cozmo跳着不可思议的舞蹈。' ],
      idleStatus2: () =>
         !world.badder_lizard
            ? [ "<32>{#p/alphys}* 这是Cozmo。" ]
      ...
      idleStatus5: () =>
         !world.badder_lizard ? [ "<32>{#p/alphys}* 这是Cozmo。" ] : [ '<32>{#p/story}* ...魔法的味道扑面而来。' ],
   ...
   b_opponent_knightknight: {
      ...
      idleStatus1: () =>
         !world.badder_lizard
            ? [ "<32>{#p/alphys}* 这是Terrestria。" ]
            : [ '<32>{#p/story}* Terrestria紧紧握着她的法杖。' ],
      idleStatus2: () =>
         !world.badder_lizard ? [ "<32>{#p/alphys}* 这是Terrestria。" ] : [ '<32>{#p/story}* Terrestria深吸了一口气。' ],
      idleStatus3: () =>
         !world.badder_lizard ? [ "<32>{#p/alphys}* 这是Terrestria。" ] : [ '<32>{#p/story}* Terrestria静静地看着你。' ],
      idleStatus4: () =>
         !world.badder_lizard
            ? [ "<32>{#p/alphys}* 这是Terrestria。" ]
            ...
            : [
                 ...[
                    ...
                    [
                       ...
                       { b: '<16>* “不过Alphys...”', c: '<16>* “Alphys。”' },
                       { b: '<16>* “她看起来...”', c: '<16>* \"...超级无敌生气。\"' },
                       {
                          b: '<16>* “以前从没见过\n  她这样。”',
                          c: '<16>* “以前从没见过\n  她摆那副臭脸。”',
                          s: true
                       ...
                       { b: '<16>* “还有，\n  他有没有说...\n  要灭了你来着？”', c: '<16>* “呃...\n  记不清了。”' },
                       { b: '<16>* “反正，我要是你，\n  这会都吓尿裤子了。”', c: '<16>* \"God, TELL me about it...\"' }
                    ]
