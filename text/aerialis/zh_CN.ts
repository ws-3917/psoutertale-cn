...
'<32>* 苦恼吧，挣扎吧。\n  剩下几位观众有好戏看啦。',
            ...
            ...(SAVE.data.b.killed_glyde
               ? [
                    !world.badder_lizard
                       ...
                       : "<32>{#p/mettaton}{#x0}* ...难怪ALPHYS不想跟你待在一块。",
                    '<32>{#x1}* 你不感到羞愧吗？',
                    "<32>{#x0}* 为了保护我观众们宝贵的眼睛，\n  我还得切断直播！",
                    !world.badder_lizard
                       ? "<32>{#x0}* 太倒霉了...\n* 但你应该也累了！"
      ...
      core2a: () =>
         [
            ...
            [ '<32>{#p/event}* 铃铃，铃铃...', "<25>{#p/alphys}{#g/alphysWelp}* I'll be on the line." ]
   ...
   b_opponent_madjick: {
      ...
      status1: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* Uh oh.' ] : [ '<32>{#p/story}* Cozmo在瞬息间突然现身！' ],
      act_check: () =>
         !world.badder_lizard
      ...
      idleStatus1: () =>
         !world.badder_lizard ? [ "<32>{#p/alphys}* It's Cozmo." ] : [ '<32>{#p/story}* Cozmo跳着神秘的舞蹈。' ],
      idleStatus2: () =>
         !world.badder_lizard
