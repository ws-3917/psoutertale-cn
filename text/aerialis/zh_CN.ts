...
'<32>{#z11}* 开始我还很生气。\n* 但死得太多，\n  现在我都看麻木了。',
         ...
         barricade1: () => [
            ...
            '<32>{#p/human}* （...）',
            '<32>{#p/human}* （敲键盘的声音听下来了。）',
            "<25>{#p/alphys}{#g/alphysWelp}* 嗯... 我们得回答\n  几个安保问题才行。",
            "<25>{#g/alphysGarbo}* Mettaton设的...",
            ...
            ...(world.postnoot
               ...
               : [
                  ...
                  '<25>{#g/alphysNervousLaugh}* “谁最喜欢Mettaton？”',
         ...
         barricade1b4: () => [
            ...(SAVE.data.n.state_foundry_undyne === 1
               ? [
                  ...
                  "<25>{#g/alphysSideSad}* 还是试试... Asgore吧。"
               ]
               : [
         ...
         barricade2: () => [
            ...
            choicer.create('* （你要怎么回答？）', 'MTT美妆', 'MTT厨具', 'MTT科技', 'MTT卫视')
         ],
         barricade2b1: [
         ...
         barricade3: () => [
            ...
            choicer.create('* （你要怎么回答？）', '42型机器人', 'Hapstablook', 'Aidrian', 'Mettaton') 
         ],
         barricade3b1: [
         ...
         cooker12x: ["<32>{#p/basic}* ...你意识到Alphys的手机\n  配备了个喷气背包。"],
         cooker13: () => [
            '<32>{#p/human}* （你激活了喷气背包。）',
            SAVE.data.n.state_foundry_undyne > 0
...
'<32>{#p/basic}* 这些光圈能证明，\n  就算老板炒我鱿鱼，\n  我也肯定能复职的...'
         ...
         moneyIntro3a: () =>
            iRespeccYourVilliany()
               ? ['<32>{#p/mettaton}{#z0}* 卫队队长，UNDYNE！']
               : ['<32>{#p/mettaton}{#z0}* 骷髅SANS！'],
         moneyIntro3b: () =>
            iRespeccYourVilliany()
               ? ['<25>{#p/undyne}{#f/1}* 没错！']
               : world.dead_skeleton
         ...
         moneyVote2a: () =>
            iRespeccYourVilliany()
               ? ['<32>{#p/mettaton}* BLOOKY，你想票掉谁呢？']
               : world.dead_skeleton
                  ? ["<32>{#p/mettaton}* 好吧，少了一票。", '<32>{#p/mettaton}* BLOOKY，你想票掉谁呢？']
                  : [
                     '<32>{#p/mettaton}* 嗯...',
                     '<32>* 什么“小鸡”？',
                     "<25>{#p/sans}{#g/sansLaugh1}* 小鸡器人你太镁了。",
                     "<32>{#p/mettaton}* 你出局！",
                     '<25>{#p/sans}{#g/sansLaugh2}* 呵呵，值了。',
                     '<32>{#p/mettaton}* 呃... BLOOKY，你想票掉谁呢？'
                  ],
         moneyVote3a: () =>
            iRespeccYourVilliany()
               ? [
         ...
         moneyVote5a: () =>
            SAVE.data.n.state_foundry_muffet === 1
               ? ['<32>{#p/tem}* tem投... 阔爱幽灵！', '<32>* tem住的离阔爱幽灵近... \n  喜欢阔爱幽灵！']
               : [
                  iFancyYourVilliany()
            ...
            SAVE.data.n.state_foundry_muffet === 1
               ...
               : iRespeccYourVilliany()
                  ? [
                     ...
                     "<25>{#p/kidd}{#f/1}* 哦... 那我不投人类了，都不用说了。\n  那么...",
                     "<25>{#f/2}* 叫我票掉Undyne... 我可做不到！",
            ...
            iRespeccYourVilliany()
               ...
               : SAVE.data.n.state_foundry_muffet === 1
                  ? SAVE.data.b.colleg
                     ...
                     : ['<32>{#p/tem}* nu...', '<32>* tem will be OKs tho...', '<32>* 记得来光顾TEM商店！！']
                  : SAVE.data.b.f_state_kidd_betray
         ...
         opera5: ['<25>{#p/alphys}{#g/alphysSmileSweat}* 你-你们好呀。', "<32>{#p/basic}{#x1}* 'Sup.{#x3}"],
         ...
         opera35: () => [
            ...(SAVE.data.b.killed_glyde
               ? [
                  !world.badder_lizard
                     ? "<32>{#p/mettaton}{#x0}* ...难怪ALPHYS刚刚跑掉了。"
               ...
               : !world.badder_lizard
                  ...
                  : [
                     ...
                     SAVE.data.n.bad_lizard === 1 && SAVE.data.b.bad_lizard
                        ...
                        : "<25>{#g/alphysCutscene3}* 我只是来看看Mettaton还好吗。"
                  ],
         end6: () =>
            SAVE.data.b.killed_mettaton
               ? ["<25>{#p/alphys}{#f/10}* ...M-Mettaton在哪？", '<25>{#p/alphys}{#f/3}* 你-你把他给...']
               : !world.badder_lizard
                  ? [
...
'<32>* “当前的真实时间\n  应为克历625年9月。”'
      ...
      trivia: {
         ...
         corenote1: [
            '<32>{#p/basic}* 一盒录音带，标着“Toriel”。',
            '<32>{#p/human}* （你听了听内容...）',
            '<32>{#p/alphys}* Asgore总跟我提起你。',
            '<32>* 他说，你做得一手好派，\n  讲故事也是一把好手。',
'<32>* 他说，你风趣幽默，\n  总能用笑话逗他发笑。',
            '<32>* 他还说，你心地善良，\n  会把满满的爱送给\n  每一位受困的人类。',
            '<32>* 尽管与Asgore存在误会，\n  但你仍努力成为温暖的光芒。',
...
'<32>* 但我知道，你一直坚守本心，\n  做最棒的自己。\n* 直到最后一刻。',
         ...
         corenote5: [
            '<32>{#p/basic}* 一盒录音带，标着“Mettaton”。',
            '<32>{#p/human}* （你听了听内容...）',
            "<32>{#p/alphys}* 一开始，我们相处得不太愉快。\n* 但如果没有你，\n  我就走不到今天这一步。",
            "<32>* Mettaton，如果你在听...\n  我想对你说，你很棒。",
            "<32>* 整个前哨站，我只为你一人\n  做过新的身体。",
            "<32>* 其实... 我也考虑过\n  给Napstablook做个身体。\n* 但是，Napstablook不适合派去战斗。",
            '<32>* 总之，\n  加油，Mettaton。'
         ],
         corenote6: () => [
            '<32>{#p/basic}* 一盒录音带，标着“Asgore”。',
            '<32>{#p/human}* （你听了听内容...）',
   ...
   b_group_aerialis: {
      ...
      froggitexWhimsalotX: (whimmer: boolean) =>
         whimmer ? ['<32>{#p/story}* Flutterknyte独自飞着。'] : ['<32>{#p/story}* Final Froggit没了伙伴，\n  独自蹦跳。'],
      astigmatism: () =>
         !world.badder_lizard
            ? ['<32>{#p/alphys}* 怎么是他们啊...']
            : world.genocide
      ...
      spacetopTsundereX: (spacetop: boolean) =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 只剩一个了。']
            : spacetop
               ? ['<32>{#p/story}* 这里只剩Astro Serf了。']
               : ['<32>{#p/story}* 这里只剩Tsunderidex了。'],
      pyropeTsundere: () =>
      ...
      pyropeTsundereX: (pyrope: boolean) =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 只剩一个了。']
            : pyrope
               ? ['<32>{#p/story}* 这里只剩Hotwire了。']
               : ['<32>{#p/story}* 这里只剩Tsunderidex了。'],
      astigmatismMigospelX: ['<32>{#p/story}* Eyewalker Prime掌控了战局！']
   },
   ...
   b_opponent_glyde: {
      ...
      act_berate: ['<32>{#p/human}* （你训了Glyde一顿。）\n* （Glyde回以嘲讽。）'],
      fightEnder1: [
      ...
      turn6f: () =>
         ateThreshold()
            ? ['<20>{#p/mettaton}哎呀，对不起嘛...', "<20>I DIDN'T KNOW IT WAS A CRIME TO HOST A TV SHOW."]
      ...
      hurtStatus: ['<32>{#p/story}* Glyde有危险了。']
   },
   ...
   b_opponent_mettaton1: {
      ...
      status1: () =>
         SAVE.data.n.plot < 67
            ? ['<32>{#p/story}* Mettaton开始行动了！']
            : ['<32>{#p/story}* Mettaton又回来了！'],
      act_check: () =>
         SAVE.data.n.plot < 67
            ? ['<32>{#p/story}* METTATON - 攻击30 防御255\n* 他的金属制的身体\n  使他无懈可击。']
            : ['<32>{#p/story}* METTATON - 攻击30 防御255\n* 没想到，他的金属身体\n  竟然使他无懈可击！'],
      act_flirt: ['<32>{#p/human}* （你向Mettaton调情。）'],
      ...
      checkTalk: ["<20>{#p/mettaton}欣赏ALPHYS的\n令人惊叹的技术了？\n我不予置评。"],
      attackTalk: () =>
         SAVE.data.n.plot < 67
      ...
      turn2status: ['<32>{#p/story}* Mettaton鼓起了机器手掌。'],
      turn3status: ["<32>{#p/story}* 一连串的八度音。"],
      turn4status: ["<32>{#p/story}* Shyren的歌声\n  在实验室里回响。"],
      turn4statusX: ['<32>{#p/story}* Mettaton不敢落下一滴眼泪。'],
      turn5status: ['<32>{#p/story}* Mettaton展示了一个舞蹈动作。'], 
      turn6status: ['<32>{#p/story}* 放克音乐空前热烈。'],
      turn7status: ['<32>{#p/story}* 闻起来像疯人院。'],
      turn7statusX: ['<32>{#p/story}* Mettaton正在摆弄着\n  他的麦克风。'],
      turn8status: ['<32>{#p/story}* Mettaton引人注目地指着镜头。'],
      ...
      act_turn: ["<32>{#p/human}* （你告诉Mettaton，\n  他后面有一面镜子。）"],
   ...
   b_opponent_madjick: {
      ...
      artifact_text: ['<32>{#p/basic}* Cozmo认出来了神器，\n  并认为你值得它的尊敬！'],
      artifactTalk: [
         '<20>{#p/basic}{~}真的假的？\n那是王室的吊坠？',
         '<20>{#p/basic}{~}我不该再妨碍你了！'
      ],
      ...
      old_gun_text: ['<32>{#p/human}* （你开了一枪。）', '<32>{#p/basic}* Cozmo被击倒了！'],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸弹。）\n* （云雾缭绕。）',
         '<32>{#p/basic}* Cozmo被击倒了！'
      ],
      ...
      act_check2: ['<32>{#p/story}* COZMO - 攻击29 防御24\n* 智障。'],
      act_check3: ['<32>{#p/story}* COZMO - 攻击29 防御24\n* 一个魔法师，但他没花招了...'],
      act_check4: ['<32>{#p/story}* COZMO - 攻击29 防御24\n* 再没有魔咒能帮到\n  这位老魔法师了。'],
      act_check5: [
         '<32>{#p/story}* COZMO - 攻击29 防御24\n* 爱的力量比最古老的魔法还要强大。'
      ],
      idleStatus1: () =>
         !world.badder_lizard ? ["<32>{#p/alphys}* 这位是Cozmo。"] : ['<32>{#p/story}* Cozmo跳着不可思议的舞蹈。'],
      idleStatus2: () =>
         !world.badder_lizard
            ? ["<32>{#p/alphys}* 这位是Cozmo。"]
            : ['<32>{#p/story}* Cozmo气势汹汹地卖弄着它的魔球。'],
      idleStatus3: () =>
         !world.badder_lizard
            ? ["<32>{#p/alphys}* 这位是Cozmo。"]
            : ['<32>{#p/story}* Cozmo嘀咕着艰深晦涩的脏话。'],
      idleStatus4: () =>
         !world.badder_lizard
            ? ["<32>{#p/alphys}* 这位是Cozmo。"]
            : ['<32>{#p/story}* Cozmo以火眼金睛凝视着你。'],
      idleStatus5: () =>
         !world.badder_lizard ? ["<32>{#p/alphys}* 这位是Cozmo。"] : ['<32>{#p/story}* ...魔法的味道扑面而来。'],
      ...
      danceText1: ['<32>{#p/human}* （你选择跳舞。）', "<32>{#p/basic}* Cozmo的牵引魔球\n  离你越来越近..."],
      ...
      perilStatus: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* 它不剩多少HP了...'] : ['<32>{#p/story}* Cozmo坚持着。']
   },
   ...
   b_opponent_knightknight: {
      ...
      artifact_text: ['<32>{#p/basic}* Terrestria认出来了神器，\n  并认为你值得她的信任！'],
      artifactTalk: [
         '<20>{#p/basic}{~}与我们阔别的世界中的\n一件神器...',
         '<20>{#p/basic}{~}想必它的传奇\n会在你心中永存。'
      ],
      old_gun_text: ['<32>{#p/human}* （你开了一枪。）', '<32>{#p/basic}* Terrestria被击倒了！'],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸弹。）\n* （云雾缭绕。）',
         '<32>{#p/basic}* Terrestria被击倒了！'
      ],
      old_spray_text: [
         '<32>{#p/human}* （你喷洒了糖雾。）\n* （好甜...）',
         '<32>{#p/basic}* Terrestria被击倒了！'
      ...
      act_check2: ['<32>{#p/story}* TERRESTRIA - 攻击36 防御36\n* 这世界正在分崩离析。'],
      act_check3: ["<32>{#p/story}* TERRESTRIA - 攻击36 防御36\n* 事情变得没那么糟糕了。"],
      act_check4: ['<32>{#p/story}* TERRESTRIA - 攻击36 防御36\n* 大地在她那双破旧的靴子下颤抖。'],
      act_check5: ['<32>{#p/story}* TERRESTRIA - 攻击36 防御36\n* 她的注意力被偷走了，\n  世间一切如同消失。'],
      idleStatus1: () =>
         !world.badder_lizard
            ? ["<32>{#p/alphys}* 这位是Terrestria。"]
            : ['<32>{#p/story}* Terrestria紧紧握着她的法杖。'],
      idleStatus2: () =>
         !world.badder_lizard ? ["<32>{#p/alphys}* 这位是Terrestria。"] : ['<32>{#p/story}* Terrestria深吸了一口气。'],
      idleStatus3: () =>
         !world.badder_lizard ? ["<32>{#p/alphys}* 这位是Terrestria。"] : ['<32>{#p/story}* Terrestria静静地看着你。'],
      idleStatus4: () =>
         !world.badder_lizard
            ? ["<32>{#p/alphys}* 这位是Terrestria。"]
      ...
      comfortText3: ['<32>{#p/human}* （你安抚了Terrestria。）\n* （无事发生。）'],
      comfortText4: [
      ...
      comfortStatus3: () =>
         !world.badder_lizard
            ...
            : ['<32>{#p/story}* Terrestria平静下来了。'],
      flashText1: () => [
         '<32>{#p/human}* （你把手机调亮，\n  朝Terrestria闪了过去。）',
         '<32>{#p/basic}* Terrestria惊慌失措！',
   ...
   b_opponent_froggitex: {
      ...
      old_gun_text: ['<32>{#p/human}* （你开了一枪。）', '<32>{#p/basic}* Final Froggit被击倒了！'],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸弹。）\n* （云雾缭绕。）',
         '<32>{#p/basic}* Final Froggit被击倒了！'
      ],
      old_spray_text: [
         '<32>{#p/human}* （你喷洒了糖雾。）\n* （好甜...）',
         '<32>{#p/basic}* Final Froggit被击倒了！'
         ...
         world.goatbro && SAVE.data.n.plot > 66.2
            ...
            : !world.badder_lizard
               ? calm_lizard()
                  ...
                  : ["<32>{#p/alphys}* 这只是Final Froggit罢了。"]
               : ['<32>{#p/story}* FINAL FROGGIT - 攻击30 防御24\n* 这个怪物前途无量。'],
      act_check2: [
         '<32>{#p/story}* FINAL FROGGIT - 攻击30 防御24\n* 这个怪物会用它的智慧\n  继续生存下去。'
      ],
      act_check3: ['<32>{#p/story}* FINAL FROGGIT - 攻击30 防御24\n* 这个怪物明白了\n  你真正的欲望。'],
      act_check4: ['<32>{#p/story}* FINAL FROGGIT - 攻击30 防御24\n* 这个怪物对自己的话很满意。'],
      ...
      status3: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Final Froggit希望能够\n  分享它的智慧。'],
      act_flirt: () => [
         '<32>{#p/human}* （你向Final Froggit调情。）',
      ...
      act_translate2: ["<32>{#p/human}* （你翻译了Final Froggit的话。）"],
      translateText1: () =>
         world.meanie
            ? ["<08>{#p/basic}{~}（不要\n杀人，\n也不要\n被杀。）"]
            : ['<08>{#p/basic}{~}（时间\n可以治愈\n一切。）'],
   ...
   b_opponent_whimsalot: {
      ...
      genostatus: ['<32>{#p/asriel2}* ...'],
      old_gun_text: ['<32>{#p/human}* （你开了一枪。）', '<32>{#p/basic}* Flutterknyte被击倒了！'],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸弹。）\n* （云雾缭绕。）',
         '<32>{#p/basic}* Flutterknyte被击倒了！'
      ],
      old_spray_text: [
         '<32>{#p/human}* （你喷洒了糖雾。）\n* （好甜...）',
         '<32>{#p/basic}* Flutterknyte被击倒了！'
         ...
         world.goatbro && SAVE.data.n.plot > 66.2
            ...
            : !world.badder_lizard
               ? calm_lizard()
                  ...
                  : ["<32>{#p/alphys}* 这只是Flutterknyte罢了。"]
               : [
                  '<32>{#p/story}* FLUTTERKNYTE - 攻击34 防御12\n* 这个怪物有着过大的责任感。'
               ],
      act_check2: ['<32>{#p/story}* FLUTTERKNYTE - 攻击34 防御12\n* 它躲在后头，怕令人失望。'],
      act_check3: ['<32>{#p/story}* FLUTTERKNYTE - 攻击34 防御12\n* 它的翅膀如释重负。'],
      act_check4: ["<32>{#p/story}* FLUTTERKNYTE - 攻击34 防御12\n* 在扑腾的可不只有它的翅膀..."],
      act_perch1: () => [
         '<32>{#p/human}* （你伸出胳膊，\n  供Flutterknyte在上面栖息。）',
      ...
      act_poke2: () => [
         '<32>{#p/human}* （你戳了戳Flutterknyte\n  以让它失去平衡。）',
         '<32>{#p/basic}* Flutterknyte掉了下去并逃之夭夭！',
      ...
      perilStatus: () =>
         !world.badder_lizard
            ? calm_lizard()
               ? ['<32>{#p/alphys}* 呃...']
               : ['<32>{#p/alphys}* 不...']
            : ['<32>{#p/story}* Flutterknyte大难临头。'],
      status1: () =>
         !world.badder_lizard
            ? ['<32>{#p/alphys}* ...']
            : ['<32>{#p/story}* Flutterknyte继续嘟囔着\n  那些正当理由。'],
      status2: () => (!world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Flutterknyte在徘徊着。']),
      status3: () => (!world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* 梨的味道扑面而来。']),
      status4: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Flutterknyte的呼吸缓慢而平稳。'],
      status5: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Flutterknyte思考着未来。'],
      spareStatus: () =>
         !world.badder_lizard
            ? calm_lizard()
               ? ['<32>{#p/alphys}* 看来Flutterknyte准备接受你的仁慈。']
   ...
   b_opponent_astigmatism: {
      ...
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸弹。）\n* （云雾缭绕。）',
         '<32>{#p/basic}* Eyewalker Prime被击倒了！'
      ],
      old_spray_text: [
         '<32>{#p/human}* （你喷洒了糖雾。）\n* （好甜...）',
         '<32>{#p/basic}* Eyewalker Prime被击倒了！'
         ...
         world.goatbro && SAVE.data.n.plot > 66.2
            ...
            : !world.badder_lizard
               ? calm_lizard()
                  ...
                  : ["<32>{#p/alphys}* 这只是Eyewalker Prime而已。"]
      ...
      act_stare: ['<32>{#p/human}* （你紧盯着Eyewalker Prime。）'],
      act_smile: ['<32>{#p/human}* （你对着Eyewalker Prime微笑。）'],
      act_flirt: () => [
         '<32>{#p/human}* （你对着Eyewalker Prime眨眼。）',
         ...(!world.badder_lizard && calm_lizard() ? ['<32>{#p/alphys}* 噢，得了吧。'] : [])
      ],
      status1: () =>
         !world.badder_lizard
            ? ['<32>{#p/alphys}* ...']
            : ['<32>{#p/story}* Eyewalker Prime正凝视着你的灵魂。'],
      status2: () =>
         !world.badder_lizard
            ? ['<32>{#p/alphys}* ...']
            : ['<32>{#p/story}* Eyewalker Prime露出了\n  凶狠的笑容。'],
      status3: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ["<32>{#p/story}* Eyewalker Prime可不是省油的灯。"],
      status4: () =>
         !world.badder_lizard
            ? ['<32>{#p/alphys}* ...']
      ...
      perilStatus: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* 呃...'] : ['<32>{#p/story}* Eyewalker Prime在流泪。'],
      ...
      fullStatus: () =>
         !world.badder_lizard
            ? calm_lizard()
               ? ['<32>{#p/alphys}* Eyewalker Prime现在\n  看起来很满意...']
               : ['<32>{#p/alphys}* 它现在看起来很满意...']
            : ['<32>{#p/story}* Eyewalker Prime很高兴。'],
         ...
         world.goatbro && SAVE.data.n.plot > 66.2
            ...
            : !world.badder_lizard
               ? calm_lizard()
                  ...
                  : ["<32>{#p/alphys}* 这只是Silencio罢了。"]
               : ['<32>{#p/story}* SILENCIO - 攻击28 防御17\n* 无耻而懦弱。\n* 来凑热闹的。'],
      act_flirt: () => [
         '<32>{#p/human}* （你向Silencio调情。）',
         ...(!world.badder_lizard && calm_lizard() ? ['<32>{#p/alphys}* 好吧...'] : [])
      ],
      flirtTalk: ["<09>{#p/basic}{~}你真可爱。"],
      act_insult: ['<32>{#p/human}* （你辱骂了Silencio。）\n* （没什么效果。）'],
      groupStatus1: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Silencio对他人视而不见。'],
      groupStatus2: () =>
   ...
   b_opponent_mushketeer: {
      ...
      status0: () =>
         world.genocide
            ...
            : !world.badder_lizard
               ? ["<32>{#p/alphys}* 可别死了。"]
               : ['<32>{#p/story}* Mushketeer挡住了去路！'],
      status1: () => (!world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Mushketeer坚定不移。']),
      status2: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Mushketeer想做一个英雄。'],
      status3: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Mushketeer在为交火做准备。'],
      status4: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Mushketeer伸手去拿枪。'],
      ...
      travelStatus2: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Mushketeer紧张不安。'],
      travelStatus3: () =>
         !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ['<32>{#p/story}* Mushketeer急速扫视着四周。'],
      act_check: () =>
         world.genocide
         ...
         world.genocide
            ...
            : !world.badder_lizard
               ? calm_lizard()
                  ? ['<32>{#p/alphys}* 等等，成了？']
                  : ['<32>{#p/alphys}* ...']
               : ['<32>{#p/story}* 好了，Mushketeer是认真的。'],
      act_travel1: () => [
         '<32>{#p/human}* （你靠近了Mushketeer。）',
         "<32>{#p/basic}* Mushketeer的攻击变得更加猛烈！",
         ...(world.genocide
            ? ['<32>{#p/asriel2}* ...？']
            : !world.badder_lizard && calm_lizard()
               ? ['<32>{#p/alphys}* 小心...']
      ...
      act_travel2: () => [
         '<32>{#p/human}* （你来到Mushketeer身边。）',
         "<32>{#p/basic}* Mushketeer的攻击开始疯狂起来！",
         ...(world.genocide
            ? ['<32>{#p/asriel2}* $(name)...？']
            : !world.badder_lizard && calm_lizard()
      ...
      act_disarm3: () => ['<32>{#p/human}* （你缴了Mushketeer的械。）'],
      act_disarm3x: ['<32>{#p/human}* （但Mushketeer已经被缴械了。）'],
      ...
      disarmStatus: ['<32>{#p/story}* Mushketeer等待着\n  这场战斗的结束。'],
   ...
   b_opponent_pyrope: {
      ...
      act_check3: ["<32>{#p/story}* HOTWIRE - 攻击 29 防御 14\n* 这个冒烟蠢货的押韵词容易着火。"],
      act_check4: ['<32>{#p/story}* HOTWIRE - 攻击 29 防御 14\n* 重新点燃了对说唱的热爱，每次一句。'],
      act_flirt: ['<32>{#p/human}* （你对Hotwire调情。）', '<32>{#p/basic}* Hotwire也向你调情！'],
      act_diss: ['<32>{#p/human}* （你使劲贬损Hotwire。）'],
      ...
      sparkText1: ["<32>{#p/human}* （你点亮了Hotwire的引线。）", "<32>{#p/basic}* Hotwire的自信不断增加。"],
      sparkText2: ["<32>{#p/human}* （你点亮了Hotwire的引线。）", '<32>{#p/basic}* Hotwire达到了巅峰！'],
      sparkText3: ["<32>{#p/human}* （你点亮了Hotwire的引线。）", '<32>{#p/basic}* Hotwire已经通电了。'],
      rapText1: ['<32>{#p/human}* （你向Hotwire说唱。）', '<32>{#p/basic}* Hotwire对你很冷漠。'],
      rapText2: ['<32>{#p/human}* （你向Hotwire说唱。）', '<32>{#p/basic}* Hotwire对你很失望。'],
      rapText3: ['<32>{#p/human}* （你向Hotwire说唱。）', '<32>{#p/basic}* Hotwire感到你很恶心。'],
      ...
      status1: ['<32>{#p/story}* Hotwire正在寻找额外的动力。'],
      status2: ['<32>{#p/story}* Hotwire吟唱起了一场风暴。'],
      status3: ['<32>{#p/story}* Hotwire被它迷人的微笑保护了起来。'],
      ...
      hurtStatus: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 离死不远了。'] : ['<32>{#p/story}* Hotwire要失控了。']
   },
   ...
   b_opponent_perigee: {
      ...
      hurtStatus: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 离死不远了。'] : ["<32>{#p/story}* Perigee的死期快到了。"]
   },
   ...
   i_face_steak: {
      ...
      drop: ["<32>{#p/human}* （你把Glyde的爱扔掉了。）"],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? ['<32>{#p/human}* （55 HP。）']
            : ['<32>{#p/basic}* “Glyde的爱” 回复55 HP\n* 这就叫“攻守易形”。'],
      name: "Glyde的爱",
      use: ["<32>{#p/human}* （你尽情享受着Glyde的爱。）"]
   },
   i_starfait_x: {
      battle: {
         description: '...',
   ...
   i_face_steak_x: {
      ...
      info: ['<32>{#p/basic}* “Undyne的哀” 回复-55 HP\n* ...'],
      name: "Undyne的哀",
      use: ["<32>{#p/human}* （你把Undyne的哀都咽到肚子里。）"]
   },
   i_trash: {
      battle: {
      ...
      item: () =>
         world.runaway
            ? [
               ...
               '0G - 星园烁宠',
               '0G - 猛男汉堡',
               SAVE.data.b.item_face_steak ? '§fill=#808080§---- 售罄 ----' : "0G - Glyde的爱",
               '离开'
            ]
            : SAVE.data.n.plot === 72
               ? [
                  ...
                  '10G - 星园烁宠',
                  '5G - 猛男汉堡',
                  SAVE.data.b.item_face_steak ? '§fill=#808080§---- 售罄 ----' : "49G - Glyde的爱",
                  '离开'
               ]
               : world.genocide || world.killed0 || burger()
                  ...
                  : [
                     ...
                     '30G - 星园烁宠',
                     '24G - 猛男汉堡',
                     SAVE.data.b.item_face_steak ? '§fill=#808080§---- 售罄 ----' : "69G - Glyde的爱",
                     '离开'
                  ],
      itemInfo: () =>
         world.genocide || world.killed0 || burger()
      ...
      talk: () =>
         SAVE.data.n.plot === 72
            ...
            : [
               ...
               postSIGMA()
                  ? '突然停电'
                  : ['我们在哪', '§fill=#ff0§Glyde（新）', 'Glyde'][Math.min(SAVE.data.n.shop_bpants_hub, 2)],
               '你的未来',
               '离开'
            ],
      talkPrompt: () =>
            ...
            SAVE.data.n.plot === 72
               ...
               : [
                  ...
                  [
                     ...
                     { b: '<16>{#k/2/4}* 怎么说呢...', c: '<16>* UNNATURALLY smart.' },
                     {
