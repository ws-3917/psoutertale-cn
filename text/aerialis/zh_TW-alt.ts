...
'<25>{#p/asriel2}{#f/6}* 你明明知道\n  艾菲斯的備用機在哪。',
                             ...
                             : 
                               [ "<25>{#p/asriel2}{#f/3}* 別忘了艾菲斯實驗室裡\n  那臺手機。" ]
                          : 
                            [
                               [
                                  '<25>{#p/asriel2}{#f/3}* 艾菲斯一直會給手機\n  配好升降機通行證的。',
                                  '<25>* 實驗室裡我看到有一部。\n* 快去拿。'
                               ],
                               [
      ...
      talkText: [
         ...
         () =>
            SAVE.data.n.plot === 72
               ...
               : SAVE.data.b.killed_mettaton
               ? [ '<32>{#p/basic}{#k/8}* 鎂塔頓。', '<32>{#k/4}* ...', "<32>{#k/6}* 嗯，死了。" ]
