...
export default {
   a_aerialis: {
      ...
      story: {
         ...
         rg1b1: () =>
            world.bad_lizard > 1
               ? [ '<32>{#p/basic}{#x1}* 前面的，給個說法：\n  為啥把人都殺了？{#x3}' ]
               : [ '<32>{#p/basic}{#x1}* 請問，你知道\n  附近哪裡有賣冰淇淋的嗎？{#x3}' ],
         rg1b2: () =>
            world.bad_lizard > 1
...
'<32>{#z11}* 開始我還很生氣。\n* 但死得太多，\n  現在我都看麻木了。',
         ...
         barricade3: () => [
            ...
            choicer.create('* （你要怎麼回答？）', '42型機器人', '納普斯樂', '阿德裡安', '鎂塔頓') 
         ],
         barricade3b1: [
         ...
         cooker12x: [ "<32>{#p/basic}* ...你意識到艾菲斯的手機\n  配備了個噴氣背包。" ],
         cooker13: () => [
            '<32>{#p/human}* （你激活了噴氣背包。）',
            SAVE.data.n.state_foundry_undyne > 0
...
'<32>{#p/basic}* 這些光圈能證明，\n  就算老闆炒我魷魚，\n  我也肯定能復職的...'
         ...
         moneyIntro3a: () =>
            iRespeccYourVilliany()
               ? [ '<32>{#p/mettaton}{#z0}* 衛隊隊長，安黛因！' ]
               : [ '<32>{#p/mettaton}{#z0}* 骷髏衫斯！' ],
         moneyIntro3b: () =>
            iRespeccYourVilliany()
               ? [ '<25>{#p/undyne}{#f/1}* 沒錯！' ]
               : world.dead_skeleton
         ...
         moneyVote2a: () =>
            iRespeccYourVilliany()
               ? [ '<32>{#p/mettaton}* 小幽，你想票掉誰呢？' ]
               : world.dead_skeleton
               ? [ "<32>{#p/mettaton}* 好吧，少了一票。", '<32>{#p/mettaton}* 小幽，你想票掉誰呢？' ]
               : [
                    '<32>{#p/mettaton}* 嗯...',
                    '<32>* 什麼「小雞」？',
         ...
         moneyVote6a: () =>
            iRespeccYourVilliany()
               ? [ "<32>{#p/mettaton}* 很遺憾，小幽。\n* 但時間差不多了。\n* 再見。" ]
               : [ "<32>{#p/mettaton}* 很遺憾，衫斯。\n* 但時間差不多了。\n* 再見。" ],
         ...
         moneyFinal0b: () =>
            iRespeccYourVilliany()
               ...
               ? SAVE.data.b.colleg
                  ...
                  : [ '<32>{#p/tem}* nu...', '<32>* tem will be OKs tho...', '<32>* 記得來光顧提咪商店！！' ]
               : SAVE.data.b.f_state_kidd_betray
         ...
         opera14a: [ '<32>{#p/alphys}{#g/alphysGarbo}* 鎂塔頓。' ],
         ...
         opera35: () => [
            ...(SAVE.data.b.killed_glyde
               ? [
                    !world.badder_lizard
                       ? "<32>{#p/mettaton}{#x0}* ...難怪艾菲斯剛剛跑掉了。"
                       : "<32>{#p/mettaton}{#x0}* ...難怪艾菲斯不想跟你\n  待在一塊。",
                    '<32>{#x1}* 你還要臉嗎？',
                    "<32>{#x0}* 我得馬上下播，\n  不能髒了觀眾的眼睛！",
                    !world.badder_lizard
                       ? '<32>{#x0}* 真倒霉...',
            ...
            SAVE.data.b.killed_mettaton
               ...
               : [
                    ...
                    SAVE.data.n.bad_lizard === 1 && SAVE.data.b.bad_lizard
                       ...
                       : "<25>{#g/alphysCutscene3}* 我只是來看看鎂塔頓還好嗎。"
                 ],
         end6: () =>
            SAVE.data.b.killed_mettaton
               ? [ "<25>{#p/alphys}{#f/10}* ...鎂-鎂塔頓在哪？", '<25>{#p/alphys}{#f/3}* 你-你把他給...' ]
               : !world.badder_lizard
               ? [
         ...
         lablizard: {
            a: pager.create(
               ...
               () =>
                  SAVE.data.n.plot < 51
                     ? [
                          '<25>{#p/alphys}{#g/alphysSideSad}* 關於鎂塔頓的事，\n  我很抱歉...',
...
'<32>* 「當前的真實時間\n  應為克歷625年9月。」'
      ...
      trivia: {
         ...
         corenote1: [
            '<32>{#p/basic}* 一盒錄音帶，標著「托麗爾」。',
            '<32>{#p/human}* （你聽了聽內容...）',
            '<32>{#p/alphys}* 艾斯戈爾常跟我談起你。',
            '<32>* 說你做得一手好派，\n  講故事也是一把好手，\n  還有你會怎麼逗他笑...',
         ...
         a_reg: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  : [
                       "<32>{#p/basic}{#npc/a}* 那蒲公罌仙氣十足，我就聞了下，\n  結果保安把我轟出來了。",
                       SAVE.data.b.killed_mettaton
      ...
      genotext: {
         ...
         azzyBpants: [ '<25>{#p/asriel2}{#f/8}* 我勒個去。\n* 這傢伙怎麼還在這。' ]
      },
      coreswitched: () =>
         SAVE.data.b.svr
      ...
      onionsan1: [ '<32>{#p/basic}* 你好哇...\n* 看到你啦...' ],
      onionsan1a: [ "<32>{#p/basic}* 我是Onionsan！\n* Onionsan，你聽到沒！" ],
      onionsan2: () =>
         world.goatbro
            ? [ "<32>{#p/basic}* 你倆，看著像壞事做盡了..." ]
      ...
      onionsan4a: [ "<32>{*}{#p/basic}* 咱都會自由噠啊啊啊啊啊啊啊啊啊{^999}" ],
      onionsan4x: [ '<25>{#p/asriel2}{#f/8}* 當然嘍。' ],
      candy1: () =>
         postSIGMA()
            ? [ "<32>{#p/basic}* 停機了。" ]
            : [
      ...
      core13: [
         "<25>{#p/alphys}{#g/alphysGarbo}* 兩開關你都按了。",
         '<25>{#p/alphys}{#g/alphysGarboCenter}* 這下開心了嗎？'
      ],
      core14: () => [
         "<25>{#p/alphys}{#g/alphysWelp}* 停一下，前面有個人。",
         '<25>{#p/alphys}{#g/alphysNeutralSweat}* 我看看我這回\n  能不能直接掃清障礙...',
         SAVE.data.b.ubershortcut
            ? '<32>{#p/human}* (It sounds like someone is furiously typing at a keyboard.)'
            : '<32>{|}{#p/human}* (Yet again, the obligatory- {%}',
         "<25>{#p/alphys}{#g/alphysCutscene3}* 那人不在內部通信系統上。",
         "<25>{#g/alphysUhButHeresTheDeal}* 那人甚至不是守衛中的一員！",
         '<25>{#g/alphysWelp}* ...這很不妙。'
      ],
      core14a: [
         '<32>{#p/basic}* 以為只要走過這座橋，\n  就能到對面了？',
         "<32>* Oouhuhu...\n* I'm afraid, dear comm-raid..."
      ],
      core14b: [ "<32>{#p/basic}* 你得再好好想想了！{%20}" ],
      core15: () =>
         !world.killed_mushketeer
            ? [ '<25>{#p/alphys}{#g/alphysNeutralSweat}* 結... 結束了？', '<25>* 我們能前進了？' ]
            : [
                 '<26>{#p/alphys}{#g/alphysNeutralSweat}* 你... 你真的...',
   ...
   b_group_aerialis: {
      froggitexWhimsalot: () =>
         !world.badder_lizard
            ...
            : [ '<32>{#p/story}* 終極蛙吉特和飄遊䗁士\n  出現在你的面前！' ],
      froggitexWhimsalotX: (whimmer: boolean) =>
         whimmer ? [ '<32>{#p/story}* 飄遊䗁士獨自飛著。' ] : [ '<32>{#p/story}* 終極蛙吉特沒了夥伴，\n  獨自蹦跳。' ],
      astigmatism: () =>
         !world.badder_lizard
            ? [ '<32>{#p/alphys}* 怎麼是他們啊...' ]
            : world.genocide
      ...
      pyropeTsundereX: (pyrope: boolean) =>
         world.goatbro
            ? [ '<32>{#p/asriel2}* 只剩一個了。' ]
            : pyrope
            ? [ '<32>{#p/story}* 這裡只剩烈焰熱線了。' ]
            : [ '<32>{#p/story}* 這裡只剩傲嬌飛船了。' ],
      astigmatismMigospelX: [ '<32>{#p/story}* 眼行者掌控了戰局！' ]
   },
   ...
   b_opponent_mettaton1: {
      ...
      checkTalk: [ "<20>{#p/mettaton}欣賞艾菲斯的\n令人驚嘆的技術了？\n我不予置評。" ],
      attackTalk: () =>
         SAVE.data.n.plot < 67
      ...
      turn2status: [ '<32>{#p/story}* 鎂塔頓鼓起了機器手掌。' ],
      turn3status: [ "<32>{#p/story}* 一連串的八度音。" ],
      turn4status: [ "<32>{#p/story}* 害羞塞壬的歌聲\n  在實驗室裡迴響。" ],
      turn4statusX: [ '<32>{#p/story}* 鎂塔頓不敢落下一滴眼淚。' ],
      turn5status: [ '<32>{#p/story}* 鎂塔頓展示了一個舞蹈動作。' ], 
      turn6status: [ '<32>{#p/story}* 放克音樂空前熱烈。' ],
      turn7status: [ '<32>{#p/story}* 聞起來像瘋人院。' ],
      turn7statusX: [ '<32>{#p/story}* 鎂塔頓正在擺弄著\n  他的麥克風。' ],
      turn8status: [ '<32>{#p/story}* 鎂塔頓引人注目地指著鏡頭。' ],
   ...
   b_opponent_mettaton2: {
      ...
      name: () => (world.genocide ? '* 鎂塔頓 NEO' : world.bad_robot ? '* 鎂塔頓 SIGMA' : '* 鎂塔頓 EX'),
      ...
      act_check: () =>
         world.genocide
            ...
            : world.bad_robot
            ? [
                 '<33>{#p/story}* 鎂塔頓 SIGMA - 攻擊255 防禦42\n* 一臺超頻過載的殺人機器。\n  攻擊力大幅提升，但也付出了代價。'
              ]
            : [ '<32>{#p/story}* 鎂塔頓 EX - 攻擊47 防禦47\n* 弱點是心形核心。' ],
      ...
      tvmReaction: {
         blookpie: () =>
            world.genocide || world.bad_robot
               ? [
                    '<32>{#p/basic}* 這塊點心使鎂塔頓想起\n  某個需要他去守護的人...',
                    "<32>{#p/story}* 鎂塔頓的攻擊力提升了！\n* 鎂塔頓的防禦力提升了！"
                 ]
               : [
                    SAVE.data.b.a_state_hapstablook
                       ? '<32>{#p/basic}* 這塊點心使鎂塔頓想起\n  一位重要的親人...'
                       : '<32>{#p/basic}* 這塊點心使鎂塔頓想起\n  某個熟悉的人...',
                    "<32>{#p/story}* 鎂塔頓的攻擊力下降了！\n* 鎂塔頓的防禦力下降了！"
                 ],
         radio: () =>
            world.bad_robot
               ? [
                    '<32>{#p/human}* （你把收音機遞給了鎂塔頓。）\n* （他放起了死亡重金屬音樂，\n  並朝你大吼大叫。）'
                 ]
               : iFancyYourVilliany()
               ? [
                    '<32>{#p/human}* （你把收音機遞給了鎂塔頓。）\n* （他放了一段交響樂，\n  以此振奮士氣。）'
      ...
      turnTalk11: () =>
         world.bad_robot
            ? [
                 ...
                 '<20>{#e/mettaton/12}{#a.la/8}{#a.ra/8}艾菲斯，艾斯戈爾，\n還有那堆表親，\n全是一個熊樣。'
              ]
            : SAVE.data.b.a_state_hapstablook
      ...
      napstahero1: [ '<20>{#p/finalghost}{~}...', '<20>{~}鎂塔頓...' ],
      napstahero2: [
   ...
   b_opponent_madjick: {
      ...
      artifact_text: [ '<32>{#p/basic}* 謎宇人認出來了神器，\n  並認為你值得它的尊敬！' ],
      artifactTalk: [
         '<20>{#p/basic}{~}真的假的？\n那是王室的吊墜？',
         '<20>{#p/basic}{~}我不該再妨礙你了！'
      ],
      ...
      old_gun_text: [ '<32>{#p/human}* （你開了一槍。）', '<32>{#p/basic}* 謎宇人被擊倒了！' ],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸彈。）\n* （雲霧繚繞。）',
         '<32>{#p/basic}* 謎宇人被擊倒了！'
      ],
      old_spray_text: [ '<32>{#p/human}* （你噴灑了糖霧。）\n* （好甜...）', '<32>{#p/basic}* 謎宇人被擊倒了！' ],
      status1: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* 糟糕。' ] : [ '<32>{#p/story}* 謎宇人在剎那間突然現身！' ],
      act_check: () =>
         !world.badder_lizard
            ? [ '<32>{#p/alphys}* 謎宇人就是一個你所說的\n  「傳統」意義上的魔法師。\n* 它的力量源自於它的魔球...' ]
            : [ '<32>{#p/story}* 謎宇人 - 攻擊29 防禦24\n* 這個高深莫測的特戰隊成員\n  總念著魔咒。' ],
      act_check2: [ '<32>{#p/story}* 謎宇人 - 攻擊29 防禦24\n* 智障。' ],
      act_check3: [ '<32>{#p/story}* 謎宇人 - 攻擊29 防禦24\n* 一個魔法師，但他沒花招了...' ],
      act_check4: [ '<32>{#p/story}* 謎宇人 - 攻擊29 防禦24\n* 再沒有魔咒能幫到\n  這位老魔法師了。' ],
      act_check5: [
         '<32>{#p/story}* 謎宇人 - 攻擊29 防禦24\n* 愛的力量比最古老的魔法還要強大。'
      ],
      idleStatus1: () =>
      ...
      danceText1: [ '<32>{#p/human}* （你選擇跳舞。）', "<32>{#p/basic}* 謎宇人的牽引魔球\n  離你越來越近..." ],
      ...
      perilStatus: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* 它不剩多少HP了...' ] : [ '<32>{#p/story}* 謎宇人堅持著。' ]
   },
   ...
   b_opponent_knightknight: {
      ...
      artifact_text: [ '<32>{#p/basic}* 特雷莉亞認出來了神器，\n  並認為你值得她的信任！' ],
      artifactTalk: [
         '<20>{#p/basic}{~}與我們闊別的世界中的\n一件神器...',
         '<20>{#p/basic}{~}想必它的傳奇\n會在你心中永存。'
      ],
      old_gun_text: [ '<32>{#p/human}* （你開了一槍。）', '<32>{#p/basic}* 特雷莉亞被擊倒了！' ],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸彈。）\n* （雲霧繚繞。）',
         '<32>{#p/basic}* 特雷莉亞被擊倒了！'
      ],
      ...
      status1: () =>
         !world.badder_lizard
            ? SAVE.data.b.assist_madjick
               ...
               : [ '<32>{#p/alphys}* 又來了。' ]
            : [ '<32>{#p/story}* 特雷莉亞擋住了去路！' ],
      act_check: () =>
         !world.badder_lizard
            ? [ "<32>{#p/alphys}* 特雷莉亞是個權杖使用者，\n  她十分熱愛我們的故園。" ]
            : [
                 '<32>{#p/story}* 特雷莉亞 - 攻擊36 防禦36\n* 這個高大挺拔的特戰隊成員\n  使用著行星法杖。'
              ],
      act_check2: [ '<32>{#p/story}* 特雷莉亞 - 攻擊36 防禦36\n* 這世界正在分崩離析。' ],
      act_check3: [ "<32>{#p/story}* 特雷莉亞 - 攻擊36 防禦36\n* 事情變得沒那麼糟糕了。" ],
      act_check4: [ '<32>{#p/story}* 特雷莉亞 - 攻擊36 防禦36\n* 大地在她那雙破舊的靴子下顫抖。' ],
      ...
      comfortStatus1: () =>
         !world.badder_lizard
            ? [ '<32>{#p/alphys}* 她在... 哭嗎？' ]
            : [ "<32>{#p/story}* 特雷莉亞的立場動搖了。" ],
      comfortText2: () => [
         '<32>{#p/human}* （你擁抱特雷莉亞，提醒她宇宙中\n  仍然存在著美好。）',
   ...
   b_opponent_froggitex: {
      ...
      old_gun_text: [ '<32>{#p/human}* （你開了一槍。）', '<32>{#p/basic}* 終極蛙吉特被擊倒了！' ],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸彈。）\n* （雲霧繚繞。）',
         '<32>{#p/basic}* 終極蛙吉特被擊倒了！'
      ],
      old_spray_text: [
         '<32>{#p/human}* （你噴灑了糖霧。）\n* （好甜...）',
         '<32>{#p/basic}* 終極蛙吉特被擊倒了！'
      ...
      act_check: () =>
         world.goatbro && SAVE.data.n.plot > 66.2
            ...
            : !world.badder_lizard
            ? calm_lizard()
               ? [ "<32>{#p/alphys}* 終極蛙吉特，它就像蛙吉特一樣，\n  但更加華麗。\n* 它用一種古怪的語言說話。" ]
               : [ "<32>{#p/alphys}* 這只是終極蛙吉特罷了。" ]
            : [ '<32>{#p/story}* 終極蛙吉特 - 攻擊30 防禦24\n* 這個怪物前途無量。' ],
      act_check2: [
         '<32>{#p/story}* 終極蛙吉特 - 攻擊30 防禦24\n* 這個怪物會用它的智慧\n  繼續生存下去。'
      ],
      act_check3: [ '<32>{#p/story}* 終極蛙吉特 - 攻擊30 防禦24\n* 這個怪物明白了\n  你真正的欲望。' ],
      act_check4: [ '<32>{#p/story}* 終極蛙吉特 - 攻擊30 防禦24\n* 這個怪物對自己的話很滿意。' ],
      ...
      status2: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 終極蛙吉特想求得解悟。' ],
      status3: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 終極蛙吉特希望能夠\n  分享它的智慧。' ],
      act_flirt: () => [
         '<32>{#p/human}* （你向終極蛙吉特調情。）',
         '<32>* 終極蛙吉特對你的話\n  有一定賞識。',
      ...
      act_translate2: [ "<32>{#p/human}* （你翻譯了終極蛙吉特的話。）" ],
      translateText1: () =>
         world.meanie
            ? [ "<08>{#p/basic}{~}（不要\n殺人，\n也不要\n被殺。）" ]
            : [ '<08>{#p/basic}{~}（時間\n可以治癒\n一切。）' ],
   ...
   b_opponent_whimsalot: {
      ...
      genostatus: [ '<32>{#p/asriel2}* ...' ],
      old_gun_text: [ '<32>{#p/human}* （你開了一槍。）', '<32>{#p/basic}* 飄遊䗁士被擊倒了！' ],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸彈。）\n* （雲霧繚繞。）',
         '<32>{#p/basic}* 飄遊䗁士被擊倒了！'
      ],
      ...
      act_check: () =>
         world.goatbro && SAVE.data.n.plot > 66.2
            ...
            : !world.badder_lizard
            ? calm_lizard()
               ? [ '<32>{#p/alphys}* 飄遊䗁士... 它似乎看起來很緊張，\n  或者是我的問題？' ]
               : [ "<32>{#p/alphys}* 這只是飄遊䗁士罷了。" ]
            : [
                 '<32>{#p/story}* 飄遊䗁士 - 攻擊34 防禦12\n* 這個怪物有著過大的責任感。'
              ],
      act_check2: [ '<32>{#p/story}* 飄遊䗁士 - 攻擊34 防禦12\n* 它躲在後頭，怕令人失望。' ],
      act_check3: [ '<32>{#p/story}* 飄遊䗁士 - 攻擊34 防禦12\n* 它的翅膀如釋重負。' ],
      act_check4: [ "<32>{#p/story}* 飄遊䗁士 - 攻擊34 防禦12\n* 在撲騰的可不只有它的翅膀..." ],
      act_perch1: () => [
         '<32>{#p/human}* （你伸出胳膊，\n  供飄遊䗁士在上面棲息。）',
         '<32>{#p/basic}* 飄遊䗁士考慮\n  接受你的提議...',
      ...
      status1: () =>
         !world.badder_lizard
            ? [ '<32>{#p/alphys}* ...' ]
            : [ '<32>{#p/story}* 飄遊䗁士繼續嘟囔著\n  那些正當理由。' ],
      status2: () => (!world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 飄遊䗁士在徘徊著。' ]),
      status3: () => (!world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 梨的味道撲面而來。' ]),
      status4: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 飄遊䗁士的呼吸緩慢而平穩。' ],
      status5: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 飄遊䗁士思考著未來。' ],
      spareStatus: () =>
         !world.badder_lizard
            ? calm_lizard()
               ? [ '<32>{#p/alphys}* 看來飄遊䗁士準備接受你的仁慈。' ]
   ...
   b_opponent_astigmatism: {
      ...
      genostatus: [ '<32>{#p/asriel2}* ...' ],
      old_gun_text: [ '<32>{#p/human}* （你開了一槍。）', '<32>{#p/basic}* 眼行者被擊倒了！' ],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸彈。）\n* （雲霧繚繞。）',
         '<32>{#p/basic}* 眼行者被擊倒了！'
      ],
      ...
      act_check: () =>
         world.goatbro && SAVE.data.n.plot > 66.2
            ...
            ? calm_lizard()
               ...
               : [ "<32>{#p/alphys}* 這只是眼行者而已。" ]
            : [ "<33>{#p/story}* 眼行者 - 攻擊32 防禦26\n* 這個怪物比看起來還要難應付。" ],
      act_check2: [
         '<33>{#p/story}* 眼行者 - 攻擊32 防禦26\n* 很滿意你對家族傳統的遵循。'
      ],
      ...
      act_stare: [ '<32>{#p/human}* （你緊盯著眼行者。）' ],
      act_smile: [ '<32>{#p/human}* （你對著眼行者微笑。）' ],
      act_flirt: () => [
         '<32>{#p/human}* （你對著眼行者眨眼。）',
      ...
      status1: () =>
         !world.badder_lizard
            ? [ '<32>{#p/alphys}* ...' ]
            : [ '<32>{#p/story}* 眼行者正凝視著你的靈魂。' ],
      status2: () =>
         !world.badder_lizard
            ? [ '<32>{#p/alphys}* ...' ]
            : [ '<32>{#p/story}* 眼行者露出了\n  兇狠的笑容。' ],
      status3: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ "<32>{#p/story}* 眼行者可不是省油的燈。" ],
      status4: () =>
         !world.badder_lizard
            ? [ '<32>{#p/alphys}* ...' ]
            : [ "<32>{#p/story}* 眼行者想到了\n  他們家族的榮譽。" ],
      ...
      perilStatus: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* 呃...' ] : [ '<32>{#p/story}* 眼行者在流淚。' ],
   ...
   b_opponent_migospel: {
      ...
      old_gun_text: [ '<32>{#p/human}* （你開了一槍。）', '<32>{#p/basic}* 默之蟑逃走了！' ],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸彈。）\n* （雲霧繚繞。）',
         '<32>{#p/basic}* 默之蟑逃走了！'
      ],
      ...
      act_check: () =>
         world.goatbro && SAVE.data.n.plot > 66.2
            ...
            ? calm_lizard()
               ? [ '<32>{#p/alphys}* 默之蟑是嗎？\n* 啊，這傢伙經常到處亂跑。' ]
               : [ "<32>{#p/alphys}* 這只是默之蟑罷了。" ]
            : [ '<32>{#p/story}* 默之蟑 - 攻擊28 防禦17\n* 無恥而懦弱。\n* 來湊熱鬧的。' ],
      act_flirt: () => [
         '<32>{#p/human}* （你向默之蟑調情。）',
         ...(!world.badder_lizard && calm_lizard() ? [ '<32>{#p/alphys}* 好吧...' ] : [])
      ],
      flirtTalk: [ "<09>{#p/basic}{~}你真可愛。" ],
      act_insult: [ '<32>{#p/human}* （你辱罵了默之蟑。）\n* （沒什麼效果。）' ],
      groupStatus1: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 默之蟑對他人視而不見。' ],
      groupStatus2: () =>
   ...
   b_opponent_mushketeer: {
      ...
      old_gun_text: [ '<32>{#p/human}* （你開了一槍。）', '<33>{#p/basic}* 蘑炮手遇上了個勁敵！' ],
      old_bomb_text: [
         '<32>{#p/human}* （你引爆了炸彈。）\n* （雲霧繚繞。）',
         '<32>{#p/basic}* 蘑炮手投降了！'
      ],
      ...
      status0: () =>
         world.genocide
            ...
            ? [ "<32>{#p/alphys}* 可別死了。" ]
            : [ '<32>{#p/story}* 蘑炮手擋住了去路！' ],
      status1: () => (!world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 蘑炮手堅定不移。' ]),
      status2: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 蘑炮手想做一個英雄。' ],
      status3: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 蘑炮手在為交火做準備。' ],
      status4: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 蘑炮手伸手去拿槍。' ],
      ...
      travelStatus2: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 蘑炮手緊張不安。' ],
      travelStatus3: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* ...' ] : [ '<32>{#p/story}* 蘑炮手急速掃視著四周。' ],
      act_check: () =>
         world.genocide
      ...
      flirtStatus2: () =>
         world.genocide
            ...
            ? calm_lizard()
               ? [ '<32>{#p/alphys}* 等等，成了？' ]
               : [ '<32>{#p/alphys}* ...' ]
            : [ '<32>{#p/story}* 好了，蘑炮手是認真的。' ],
      act_travel1: () => [
         '<32>{#p/human}* （你靠近了蘑炮手。）',
         "<32>{#p/basic}* 蘑炮手的攻擊變得更加猛烈！",
         ...(world.genocide
            ? [ '<32>{#p/asriel2}* ...？' ]
            : !world.badder_lizard && calm_lizard()
            ? [ '<32>{#p/alphys}* 小心...' ]
      ...
      act_disarm3: () => [ '<32>{#p/human}* （你繳了蘑炮手的械。）' ],
      act_disarm3x: [ '<32>{#p/human}* （但蘑炮手已經被繳械了。）' ],
      ...
      disarmStatus: [ '<32>{#p/story}* 蘑炮手等待著\n  這場戰鬥的結束。' ],
   ...
   b_opponent_pyrope: {
      ...
      genoStatus: [ '<32>{#p/asriel2}* 烈焰熱線。' ],
      genoSpareStatus: [ "<32>{#p/asriel2}* 不堪一擊。" ],
      act_check: () =>
         world.goatbro
            ? [ '<32>{#p/asriel2}* 烈焰熱線，說唱呆子。\n* 腦子這麼活絡，\n  卻把才華浪費在這種小兒科上。' ]
            : [ '<32>{#p/story}* 烈焰熱線 - 攻擊 29 防禦 14\n* 這種怪物很狡猾，任何計畫對它來說都不複雜。' ],
      act_check2: [
         '<32>{#p/story}* 烈焰熱線 - 攻擊 29 防禦 14\n* 這個怪物點燃的火花正在熄滅。'
      ],
      act_check3: [ "<32>{#p/story}* 烈焰熱線 - 攻擊 29 防禦 14\n* 這個冒煙蠢貨的押韻詞容易著火。" ],
      act_check4: [ '<32>{#p/story}* 烈焰熱線 - 攻擊 29 防禦 14\n* 重新點燃了對說唱的熱愛，每次一句。' ],
      act_flirt: [ '<32>{#p/human}* （你對烈焰熱線調情。）', '<32>{#p/basic}* 烈焰熱線也向你調情！' ],
      act_diss: [ '<32>{#p/human}* （你使勁貶損烈焰熱線。）' ],
      ...
      sparkText1: [ "<32>{#p/human}* （你點亮了烈焰熱線的引線。）", "<32>{#p/basic}* 烈焰熱線的自信不斷增加。" ],
      sparkText2: [ "<32>{#p/human}* （你點亮了烈焰熱線的引線。）", '<32>{#p/basic}* 烈焰熱線達到了巔峰！' ],
      sparkText3: [ "<32>{#p/human}* （你點亮了烈焰熱線的引線。）", '<32>{#p/basic}* 烈焰熱線已經通電了。' ],
      rapText1: [ '<32>{#p/human}* （你向烈焰熱線說唱。）', '<32>{#p/basic}* 烈焰熱線對你很冷漠。' ],
      rapText2: [ '<32>{#p/human}* （你向烈焰熱線說唱。）', '<32>{#p/basic}* 烈焰熱線對你很失望。' ],
      rapText3: [ '<32>{#p/human}* （你向烈焰熱線說唱。）', '<32>{#p/basic}* 烈焰熱線感到你很噁心。' ],
      ...
      status1: [ '<32>{#p/story}* 烈焰熱線正在尋找額外的動力。' ],
      status2: [ '<32>{#p/story}* 烈焰熱線吟唱起了一場風暴。' ],
      status3: [ '<32>{#p/story}* 烈焰熱線被它迷人的微笑保護了起來。' ],
      status4: [ '<32>{#p/story}* 烈焰熱線嘗試渦輪增壓。' ],
      status5: [ '<32>{#p/story}* Smells like lyricism.' ],
      sparkStatus1A: [ '<32>{#p/story}* 烈焰熱線被它的輝煌震驚了。' ],
      sparkStatus2A: [ '<32>{#p/story}* 烈焰熱線啟動了點火程式...手動地。' ],
      sparkStatus3A: [ '<32>{#p/story}* 不管我們喜不喜歡，烈焰熱線仍然我行我素。' ],
      sparkStatus1B: [ '<32>{#p/story}* 烈焰熱線很興奮。' ],
      sparkStatus2B: [ '<32>{#p/story}* 烈焰熱線的能力完全釋放了出來。' ],
      sparkStatus3B: [ '<32>{#p/story}* 烈焰熱線正在渦輪增壓。' ],
      hurtStatus: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* 離死不遠了。' ] : [ '<32>{#p/story}* 烈焰熱線要失控了。' ]
   },
   ...
   b_opponent_perigee: {
      ...
      whistleStatus: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* 呦呦雞。' ] : [ '<32>{#p/story}* Perigee awaits your gesture.' ],
   ...
   b_opponent_tsundere: {
      ...
      status5: () =>
         world.goatbro ? [ '<32>{#p/asriel2}* 傲嬌飛船。' ] : [ '<32>{#p/story}* Smells like space cacti.' ],
      status6: () =>
         world.goatbro
            ? [ "<32>{#p/asriel2}* 不堪一擊。" ]
   ...
   i_face_steak: {
      ...
      drop: [ "<32>{#p/human}* （你把老滑頭的愛扔掉了。）" ],
      info: () =>
         SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
            ? [ '<32>{#p/human}* （55 HP。）' ]
            : [ '<32>{#p/basic}* 「老滑頭的愛」 回復55 HP\n* 這就叫「攻守易形」。' ],
      name: "老滑頭的愛",
      use: [ "<32>{#p/human}* （你盡情享受著老滑頭的愛。）" ]
   },
   i_starfait_x: {
      battle: {
         description: '...',
   ...
   i_face_steak_x: {
      ...
      info: [ '<32>{#p/basic}* 「安黛因的哀」 回復-55 HP\n* ...' ],
      name: "安黛因的哀",
      use: [ "<32>{#p/human}* （你把安黛因的哀都咽到肚子裡。）" ]
   },
   i_trash: {
      battle: {
      ...
      talkText: [
         ...
         () =>
            SAVE.data.n.plot === 72
               ...
               : SAVE.data.b.killed_mettaton
               ? [ '<32>{#p/basic}{#k/8}* 鎂塔頓。', '<32>{#k/4}* ...', "<32>{#k/6}* Yeah, he's dead." ]
