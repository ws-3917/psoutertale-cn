...
'<32>* 苦惱吧，掙扎吧。\n  剩下幾位觀眾有好戲看啦。',
            ...
            ...(SAVE.data.b.killed_glyde
               ? [
                    !world.badder_lizard
                       ...
                       : "<32>{#p/mettaton}{#x0}* ...難怪艾菲斯不想跟你待在一塊。",
                    '<32>{#x1}* 你不感到羞愧嗎？',
                    "<32>{#x0}* 為了保護我觀眾們寶貴的眼睛，\n  我還得切斷直播！",
                    !world.badder_lizard
                       ? "<32>{#x0}* 太倒霉了...\n* 但你應該也累了！"
   ...
   b_opponent_madjick: {
      ...
      status1: () =>
         !world.badder_lizard ? [ '<32>{#p/alphys}* Uh oh.' ] : [ '<32>{#p/story}* 謎宇人在瞬息間突然現身！' ],
      act_check: () =>
         !world.badder_lizard
      ...
      idleStatus1: () =>
         !world.badder_lizard ? [ "<32>{#p/alphys}* It's Cozmo." ] : [ '<32>{#p/story}* 謎宇人跳著神秘的舞蹈。' ],
      idleStatus2: () =>
         !world.badder_lizard
