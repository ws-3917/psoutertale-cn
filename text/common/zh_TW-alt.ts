...
export default {
   ...
   a_common: {
      bullybed: [
         ...
         [
            "<32>{#p/human}* （絕望之中，你撥了托麗爾的號碼。）\n* （沒有回應。）",
            '<32>{#p/human}* （你又給帕派瑞斯，安黛因打電話...）',
            '<32>{#p/human}* （沒有回應。）'
         ],
         [
            '<32>{#p/human}* （...）',
            ...
            if (!dundyne) {
               if (royals < 2) {
                  ...
                  addB([
                     ...
                     '<25>{#p/undyne}{#f/22}* 艾菲斯被嚇得不輕。\n  國王死了，\n  皇家衛隊幾乎全軍覆沒。',
                     '<25>{#p/undyne}{#f/20}* 更糟的是...',
                     "<25>{#p/undyne}{#f/22}* 鎂塔頓和艾菲斯為了\n  幹掉你，動用了大量的能量。\n* 最終，前哨站能量供應失控。",
                  ...
                  addB([
                     ...
                     '<25>{#p/alphys}{#f/31}* 安黛因知道了「檔案」的事情。\n  衝到那裡，把裡面的人類\n  全殺了。',
                  ...
                  if (!dtoriel) {
                     addB([
                        "<32>{#p/basic}{@fill=#d4bbff}* 安黛因是怎麼\n  統治前哨站的？\n* 武裝奪權？",
                        '<26>{#p/alphys}{#f/24}* 呃，那事把我噁心壞了。',
                        '<25>{#p/alphys}{#f/30}* 曾經的王后站了出來，\n  想阻止她的野心...',
                        "<25>{#p/alphys}{#f/31}* ...結果，安黛因的擁護者們\n  一擁而上，把王后撂倒，\n  當場踩死。",
                  ...
                  if (hkills > 19) {
                     ...
                     addB([
                        '<25>{#p/alphys}{#f/17}* ...\n* 講完了。\n* 這就是我們的命運。',
                        "<25>{#p/alphys}{#f/26}* 誠然，\n  你沒殺那麼多人...",
                        '<25>{#p/alphys}{#f/23}* 誠然，我和鎂塔頓反應\n  有些過度...',
                        "<25>{#p/alphys}{#f/18}* 但最根本的錯在你。"
                     ]);
                  }
                  addB([
                     "<32>{#p/basic}{@fill=#ffbbdc}* 艾菲斯，告訴那人。",
...
'<25>{#p/sans}{#f/3}* 裡面的人類當場死亡。',
                  ...
                  if (!dtoriel) {
                     addB([
                        ...
                        '<25>{#p/sans}{#f/0}* 但隨即，她看到了那些靈魂...',
                        '<25>{#p/sans}{#f/3}* 她不停地控訴，\n  說「我們都是他的幫兇」。',
                        '<25>{#p/sans}{#f/0}* 我們努力解釋，把艾斯戈爾的\n  所作所為都講給王后...',
                  ...
                  if (!dpapyrus) {
                     if (!dtoriel) {
                        addB([
                           "<25>{#p/sans}{#f/0}* 托麗爾拒絕了，\n  我就去找帕派瑞斯。",
                           '<25>{#p/sans}{#f/3}* 好在，當我把情況\n  告訴他後...'
                        ]);
                     } else {
                        addB(['<25>{#p/sans}{#f/3}* 好在，帕派瑞斯還在，\n  我找到他，把事情告訴了他後...']);
                     }
                     if (royals === 1) {
                        addB([
...
'<26>{#p/sans}{#f/0}* 你在前哨站的這段時間，\n  我們搜集到不少\n  有價值的數據。',
      ...
      neutral2: [
         ...
         "<25>{#p/asgore}{#f/7}* 我覺得，艾斯利爾幹出那些事\n  不該都歸咎於你。",
         '<25>{#p/asgore}{#f/5}* 你饒恕了帕派瑞斯，\n  放過了瑪菲特，也對\n  很多其他怪物抱以仁慈...',
         ...
         '<25>{#p/kidd}{#f/14}* 喲--！帕派瑞斯！！！',
         '<25>{#p/kidd}{#f/1}* 骷髏老兄，\n  你也想跟人類說說話嗎？',
         "<25>{#p/kidd}{#f/2}* 正好艾斯戈爾要送我回家。",
         "<18>{#p/papyrus}{#f/0}當然！\n我可有很重要的事喔。",
   ...
   b_opponent_moldsmal: {
      ...
      act_check0: ['<32>{#p/asriel2}* 小黏團，沒腦子的粘球。\n* 有什麼好說的？'],
      act_check: ['<32>{#p/story}* 小黏團 - 攻擊6 防禦0\n* 典型印象：身段妖嬈氣質好，\n  就是沒大腦...'],
      act_check2: ["<32>{#p/story}* 小黏團 - 攻擊6 防禦0\n* 應季的色彩令它更為迷人。"],
      act_check3: ['<32>{#p/story}* 小黏團 - 攻擊6 防禦0\n* 與你所喜歡的類別相同。\n* 刻板印象的那種。'],
      act_check4: ['<32>{#p/story}* 小黏團 - 攻擊6 防禦0\n* 這位超級模特早已輝煌不再。'],
      act_flirt: [
         '<32>{#p/human}* （你扭動著你的臀部。）\n* （小黏團用扭動回應你。）',
         '<33>{#p/basic}* 真是有意義的交流！'
      ],
      act_imitate: [
         '<33>{#p/human}* （你輕輕地拍了拍小黏團。）\n* （它的身體變色了。）',
      ...
      perilStatus: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ...
            : ['<32>{#p/story}* 小黏團已經開始腐爛了。'],
      sexyChat: ['<08>{#p/basic}{~}\x00*性感\n扭動*'],
      status1: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 小黏團把身體挺成正方形。'] : ["<32>{#p/story}* 一對小黏團跳了過來。"],
      status2: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 小黏團。']
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? ["<32>{#p/kidding}* 噓... 它在思考！"]
               : ['<32>{#p/story}* 小黏團靜靜地凝結著。'],
      status3: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 小黏團。'] : ['<32>{#p/story}* 小黏團樂觀地等待著。'],
      status4: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 小黏團。']
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
   ...
   b_opponent_spacetop: {
      ...
      act_compliment: ['<32>{#p/human}* （你告訴太空帽說它\n  有一根很棒的天線。）'],
      ...
      createStatus1: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 太空帽。']
            : ["<32>{#p/story}* 太空帽小心翼翼地確定著\n  你有沒有看它的天線。"],
      createStatus2: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 太空帽。'] : ['<32>{#p/story}* 太空帽被打動了。'],
      ...
      hurtStatus: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 離死不遠了。'] : ["<32>{#p/story}* 太空帽的衣服松垮垮的。"],
      ...
      status1: ['<32>{#p/story}* 太空帽昂首闊步走了過來。'],
   ...
   b_party_kidd: {
      ...
      mkTurnActRand2: (opponent: string) =>
         opponent === 'muffet' // NO-TRANSLATE
            ...
            ? [
               ['<32>{#p/story}* 怪物小孩誇瑪菲特穿得真精緻，\n  有品味。'],
               ['<32>{#p/story}* 怪物小孩告訴瑪菲特，\n  她的糕點在怪物界就是一流。'],
               ["<32>{#p/story}* 怪物小孩告訴瑪菲特，\n  她織的網簡直無人能敵。"]
            ]
            : opponent === 'shyren' // NO-TRANSLATE
               ...
               ? [
                  ...
                  ["<32>{#p/story}* 怪物小孩告訴害羞塞壬，\n  她的頭髮真好看。"],
                  ["<32>{#p/story}* 怪物小孩告訴害羞塞壬，\n  她的聲音真好聽。"]
               ]
               : opponent === 'woshua' // NO-TRANSLATE

                  ? [
                     ['<32>{#p/story}* 怪物小孩告訴刷潔頓，\n  這片數它最愛乾淨。'],
                     ["<32>{#p/story}* 怪物小孩告訴刷潔頓，\n  它就是鑄廠模範清潔工。"],
                     ["<32>{#p/story}* 怪物小孩對刷潔頓說，\n  它對完美的追求真是執著。"]
                  ]
                  : opponent === 'radtile' // NO-TRANSLATE

                     ? [
                        ["<32>{#p/story}* 怪物小孩誇老頑鱷的鏡子\n  真好看。"],
                        ["<32>{#p/story}* 怪物小孩誇老頑鱷\n  帽子真酷。"],
                        ["<32>{#p/story}* 怪物小孩再三打量老頑鱷\n  帥氣的臉龐。"]
                     ]
                     : [
                        ['<32>{#p/story}* 怪物小孩告訴$(x)，\n  會陪著它。'],
                        ["<32>{#p/story}* 怪物小孩告訴$(x)，\n  會盡全力幫助它。"],
      ...
      mkTurnActRand3: (opponent: string) =>
         opponent === 'muffet' // NO-TRANSLATE
            ...
            : opponent === 'shyren' // NO-TRANSLATE
               ...
               ? [
                  ['<32>{#p/story}* 怪物小孩和害羞塞壬爭論起\n  用哪種記譜方式更好。'],
                  ['<32>{#p/story}* 怪物小孩開始講起了樂理知識。'],
                  ['<32>{#p/story}* 怪物小孩跟害羞塞壬討論起\n  彼此喜愛的音樂流派。']
               ]
               : opponent === 'woshua' // NO-TRANSLATE
      ...
      mkTurnActResult4: (opponent: string, multiple: boolean, allowpac: boolean) =>
         opponent === 'woshua' // NO-TRANSLATE
            ...
            ? [
               '<32>{#p/story}* 刷潔頓擔心自己小命不保，\n  趕忙跑掉了！',
               ...(multiple ? ['<32>{#p/story}* 其他對手還想繼續戰鬥。'] : [])
            ]
            : opponent === 'shyren' // NO-TRANSLATE

               ? allowpac
                  ? ['<32>{#p/story}* 害羞塞壬擔心自己小命不保，\n  趕忙跑掉了！']
                  : ['<32>{#p/story}* 表演過後，害羞塞壬有了信心。\n  決定勇敢地直面危險！']
               : opponent === 'radtile' // NO-TRANSLATE

                  ? ['<32>{#p/story}* 老頑鱷擔心自己小命不保，\n  趕忙跑掉了！']
                  : [
