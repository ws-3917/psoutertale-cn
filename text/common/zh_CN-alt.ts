...
export default {
   ...
   a_common: {
      bullybed: [
         ...
         [
            "<32>{#p/human}* （绝望之中，你拨了托丽尔的号码。）\n* （没有回应。）",
            '<32>{#p/human}* （你又给帕派瑞斯，安黛因打电话...）',
            '<32>{#p/human}* （没有回应。）'
         ],
         [
            '<32>{#p/human}* （...）',
            ...
            if (!dundyne) {
               if (royals < 2) {
                  ...
                  addB([
                     ...
                     '<25>{#p/undyne}{#f/22}* 艾菲斯被吓得不轻。\n  国王死了，\n  皇家卫队几乎全军覆没。',
                     '<25>{#p/undyne}{#f/20}* 更糟的是...',
                     "<25>{#p/undyne}{#f/22}* 镁塔顿和艾菲斯为了\n  干掉你，动用了大量的能量。\n* 最终，前哨站能量供应失控。",
                  ...
                  addB([
                     ...
                     '<25>{#p/alphys}{#f/18}* ...安黛因到了首塔。\n* 和我预想的完全一样，\n  她告诉我...',
                     "<25>{#p/alphys}{#f/3}* 艾斯戈尔被人杀了。",
                     ...
                     '<25>{#p/alphys}{#f/31}* 安黛因知道了“档案”的事情。\n  冲到那里，把里面的人类\n  全杀了。',
                  ...
                  if (!dtoriel) {
                     addB([
                        "<32>{#p/basic}{@fill=#d4bbff}* 安黛因是怎么\n  统治前哨站的？\n* 武装夺权？",
                        '<26>{#p/alphys}{#f/24}* 呃，那事把我恶心坏了。',
                        '<25>{#p/alphys}{#f/30}* 曾经的王后站了出来，\n  想阻止她的野心...',
                        "<25>{#p/alphys}{#f/31}* ...结果，安黛因的拥护者们\n  一拥而上，把王后撂倒，\n  当场踩死。",
                  ...
                  if (hkills > 19) {
                     ...
                     addB([
                        '<25>{#p/alphys}{#f/17}* ...\n* 讲完了。\n* 这就是我们的命运。',
                        "<25>{#p/alphys}{#f/26}* 诚然，\n  你没杀那么多人...",
                        '<25>{#p/alphys}{#f/23}* 诚然，我和镁塔顿反应\n  有些过度...',
                        "<25>{#p/alphys}{#f/18}* 但最根本的错在你。"
                     ]);
                  }
                  addB([
                     "<32>{#p/basic}{@fill=#ffbbdc}* 艾菲斯，告诉那人。",
...
'<25>{#p/sans}{#f/3}* 里面的人类当场死亡。',
                  ...
                  if (!dtoriel) {
                     addB([
                        ...
                        '<25>{#p/sans}{#f/0}* 但随即，她看到了那些灵魂...',
                        '<25>{#p/sans}{#f/3}* 她不停地控诉，\n  说“我们都是他的帮凶”。',
                        '<25>{#p/sans}{#f/0}* 我们努力解释，把艾斯戈尔的\n  所作所为都讲给皇后...',
                  ...
                  if (!dpapyrus) {
                     if (!dtoriel) {
                        addB([
                           "<25>{#p/sans}{#f/0}* 托丽尔拒绝了，\n  我就去找帕派瑞斯。",
                           '<25>{#p/sans}{#f/3}* 好在，当我把情况\n  告诉他后...'
                        ]);
                     } else {
                        addB(['<25>{#p/sans}{#f/3}* 好在，帕派瑞斯还在，\n  我找到他，把事情告诉了他后...']);
                     }
                     if (royals === 1) {
                        addB([
                           '<25>{#p/sans}{#f/2}* 他马上就答应了。',
                           '<18>{#p/papyrus}{#f/4}...没想到这会议开这么久。',
                           "<25>{#p/sans}{#f/0}* 欸，说曹操曹操到。\n* 会议顺利吗？",
                     ...
                     if (royals === 1) {
                        ...
                        if (!ddoggo) {
                           addB([
                              ...
                              '<18>{#p/papyrus}{#f/5}艾菲斯刚醒，\n把事情告诉了我们。',
                              '<18>{#p/papyrus}{#f/3}...别的守卫们，\n  全都...',
                              '<18>{#p/papyrus}{#f/31}...',
                              '<18>{#p/papyrus}{#f/5}听罢，遁狗十分难受。',
                              "<18>{#p/papyrus}{#f/6}但我跟艾菲斯\n可不会丢下他不管！",
                              '<18>{#p/papyrus}{#f/6}我告诉他，\n要是伤心了，就找我俩，\n一定会帮他的！',
                              "<18>{#p/papyrus}{#f/5}而且，还会给他\n一个新的家。",
                              '<25>{#p/sans}{#f/0}* 哦... 我说呢。',
                              "<25>{#p/sans}{#f/2}* 我说艾斯戈尔的沙发上\n  咋有那些狗毛呢。"
                           ]);
                        } else if (!dlesserdog) {
                           addB([
                              '<18>{#p/papyrus}{#f/5}声音是从安保门那里\n传来的。\n是一阵轻快的叩门声。',
...
'<18>{#p/papyrus}{#f/6}让它备受打击。',
                        ...
                        addB([
                           '<18>{#p/papyrus}{#f/5}原来是遇到了困难，\n想让我帮忙解开心结。',
                           '<18>{#p/papyrus}{#f/0}正好，\n睡了一觉，精神百倍！',
                           '<18>{#p/papyrus}{#f/0}于是，我帮助了他。',
                           '<18>{#p/papyrus}{#f/4}第二天，又有人\n找我做精神疏导。',
                  ...
                  addB([
                     ...
                     '<25>{#p/sans}{#f/0}* 简单说说后续，我和艾菲斯\n  找了个安全的地儿\n  安置他们的灵魂。',
                     '<25>{#p/sans}{#f/3}* 那总得有个人看着吧，\n  雇谁好呢？',
               ...
               addB([
                  ...
                  "<26>{#p/sans}{#f/3}* 最终，她振作起来。\n  接任了艾斯戈尔的王位。",
                  '<25>{#p/sans}{#f/0}* ...渐渐地，\n  风波平息了下来。',
                  '<32>{#p/human}{#v/4}{@fill=#d535d9}* 衫斯，我俩想去游泳，\n  可以陪我们去吗？',
                  ...
                  "<32>{#p/human}{#v/5}{@fill=#00c000}* 衫斯，对不起，\n  影响你打电话了...",
...
'<26>{#p/sans}{#f/0}* 你在前哨站的这段时间，\n  我们搜集到不少\n  有价值的数据。',
               ...
               if (!dpapyrus) {
                  addB([
                     ...
                     "<18>{#p/papyrus}{#f/5}帕派瑞斯的休息时间\n非常有限...",
                     '<18>{#p/papyrus}{#f/0}所以，我想珍惜这些\n休息时光。',
                     '<26>{#p/sans}{#f/3}* 嗯...',
                     '<25>{#p/sans}{#f/2}* 是不是艾菲斯让你休息的？',
                     '<18>{#p/papyrus}{#f/4}...',
               ...
               addB([
                  "<25>{#p/alphys}{#f/20}* 衫-衫斯，对不起。\n* 你赶紧带孩子们去游泳吧。",
                  "<25>{#p/alphys}{#f/3}* 这些孩子都快把我\n  折磨疯了。",
                  '<25>{#p/sans}{#f/3}* 那...',
                  "<25>{#p/sans}{#f/0}* 剩下的话，就让艾菲斯说吧。",
      ...
      neutral2: [
         ...
         "<25>{#p/asgore}{#f/7}* 我觉得，艾斯利尔干出那些事\n  不该都归咎于你。",
         '<25>{#p/asgore}{#f/5}* 你饶恕了帕派瑞斯，\n  放过了玛菲特，也对\n  很多其他怪物抱以仁慈...',
         ...
         '<25>{#p/kidd}{#f/14}* 哟--！帕派瑞斯！！！',
         '<25>{#p/kidd}{#f/1}* 骷髅老兄，\n  你也想跟人类说说话吗？',
         "<25>{#p/kidd}{#f/2}* 正好艾斯戈尔要送我回家。",
         "<18>{#p/papyrus}{#f/0}当然！\n我可有很重要的事哦。",
   ...
   b_act: {
      ...
      asgore: '* 艾斯戈尔',
      asriel: '* 艾斯利尔',
      asrieldreemurr: '§fill=#ff7f7f§§swirl=2/1/1.05§§hue§* 艾斯利尔·逐梦',
      bathe: '* 洗澡',
      beckon: '* 招呼过来',
      bedtime: '* 睡觉时间',
      berate: '* 斥责',
   ...
   b_opponent_moldsmal: {
      ...
      act_check0: ['<32>{#p/asriel2}* 小黏团，没脑子的粘球。\n* 有什么好说的？'],
      act_check: ['<32>{#p/story}* 小黏团 - 攻击6 防御0\n* 典型印象：身段妖娆气质好，\n  就是没大脑...'],
      act_check2: ["<32>{#p/story}* 小黏团 - 攻击6 防御0\n* 应季的色彩令它更为迷人。"],
      act_check3: ['<32>{#p/story}* 小黏团 - 攻击6 防御0\n* 与你所喜欢的类型相同。\n* 刻板印象的那种。'],
      act_check4: ['<32>{#p/story}* 小黏团 - 攻击6 防御0\n* 这位超级模特早已辉煌不再。'],
      act_flirt: [
         '<32>{#p/human}* （你扭动着你的臀部。）\n* （小黏团用扭动回应你。）',
         '<33>{#p/basic}* 真是有意义的交流！'
      ],
      act_imitate: [
         '<33>{#p/human}* （你轻轻地拍了拍小黏团。）\n* （它的身体变色了。）',
         "<32>{#p/basic}* 这是小黏团高兴时的颜色！"
      ],
      act_slap: [
         '<32>{#p/human}* （你使劲扇了小黏团一巴掌。）',
         '<32>{#p/basic}* 小黏团身体发生凹陷，\n  但不久便恢复原形。'
      ],
      act_slap2: [
         '<32>{#p/human}* （你用尽全身力气，\n  狠狠扇了小黏团一巴掌。）',
         '<32>{#p/basic}* 小黏团的根基被动摇了！'
      ],
      act_slap3: [
         '<32>{#p/human}* （你用尽全身力气，\n  狠狠扇了小黏团一巴掌。）',
         '<32>{#p/basic}* 小黏团逃离了现场！'
      ...
      perilStatus: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ...
            : ['<32>{#p/story}* 小黏团已经开始腐烂了。'],
      sexyChat: ['<08>{#p/basic}{~}\x00*性感\n扭动*'],
      status1: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 小黏团把身体挺成正方形。'] : ["<32>{#p/story}* 一对小黏团跳了过来。"],
      status2: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 小黏团。']
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? ["<32>{#p/kidding}* 嘘... 它在思考！"]
               : ['<32>{#p/story}* 小黏团静静地凝结着。'],
      status3: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 小黏团。'] : ['<32>{#p/story}* 小黏团乐观地等待着。'],
      status4: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 小黏团。']
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
   ...
   b_opponent_spacetop: {
      ...
      act_compliment: ['<32>{#p/human}* （你告诉太空帽说它\n  有一根很棒的天线。）'],
      ...
      createStatus1: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 太空帽。']
            : ["<32>{#p/story}* 太空帽小心翼翼地确定着\n  你有没有看它的天线。"],
      createStatus2: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 太空帽。'] : ['<32>{#p/story}* 太空帽被打动了。'],
      ...
      genoStatus: ['<32>{#p/asriel2}* 太空帽。'],
      hurtStatus: () =>
         world.goatbro ? ['<32>{#p/asriel2}* 离死不远了。'] : ["<32>{#p/story}* 太空帽的衣服松垮垮的。"],
   ...
   b_party_kidd: {
      ...
      mkTurnActRand2: (opponent: string) =>
         opponent === 'muffet' // NO-TRANSLATE
            ...
            ? [
               ['<32>{#p/story}* 怪物小孩夸玛菲特穿得真精致，\n  有品味。'],
               ['<32>{#p/story}* 怪物小孩告诉玛菲特，\n  她的糕点在怪物界就是一流。'],
               ["<32>{#p/story}* 怪物小孩告诉玛菲特，\n  她织的网简直无人能敌。"]
            ]
            : opponent === 'shyren' // NO-TRANSLATE
               ...
               ? [
                  ...
                  ["<32>{#p/story}* 怪物小孩告诉害羞塞壬，\n  她的头发真好看。"],
                  ["<32>{#p/story}* 怪物小孩告诉害羞塞壬，\n  她的声音真好听。"]
               ]
               : opponent === 'woshua' // NO-TRANSLATE

                  ? [
                     ['<32>{#p/story}* 怪物小孩告诉刷洁顿，\n  这片数它最爱干净。'],
                     ["<32>{#p/story}* 怪物小孩告诉刷洁顿，\n  它就是铸厂模范清洁工。"],
                     ["<32>{#p/story}* 怪物小孩对刷洁顿说，\n  它对完美的追求真是执着。"]
                  ]
                  : opponent === 'radtile' // NO-TRANSLATE

                     ? [
                        ["<32>{#p/story}* 怪物小孩夸老顽鳄的镜子\n  真好看。"],
                        ["<32>{#p/story}* 怪物小孩夸老顽鳄\n  帽子真酷。"],
                        ["<32>{#p/story}* 怪物小孩再三打量老顽鳄\n  帅气的脸庞。"]
                     ]
                     : [
                        ['<32>{#p/story}* 怪物小孩告诉$(x)，\n  会陪着它。'],
                        ["<32>{#p/story}* 怪物小孩告诉$(x)，\n  会尽全力帮助它。"],
      ...
      mkTurnActRand3: (opponent: string) =>
         opponent === 'muffet' // NO-TRANSLATE
            ...
            : opponent === 'shyren' // NO-TRANSLATE
               ...
               ? [
                  ['<32>{#p/story}* 怪物小孩和害羞塞壬争论起\n  用哪种记谱方式更好。'],
                  ['<32>{#p/story}* 怪物小孩开始讲起了乐理知识。'],
                  ['<32>{#p/story}* 怪物小孩跟害羞塞壬讨论起\n  彼此喜爱的音乐流派。']
               ]
               : opponent === 'woshua' // NO-TRANSLATE
      ...
      mkTurnActResult1: (opponent: string) =>
         opponent === 'woshua' // NO-TRANSLATE
            ...
            : opponent === 'shyren' // NO-TRANSLATE
               ...
               ? ["<32>{#p/story}* 害羞塞壬感到很不自在！\n* 害羞塞壬的防御力下降了！"]
               : opponent === 'radtile' // NO-TRANSLATE

                  ? ["<32>{#p/story}* 老顽鳄感到很不自在！\n* 老顽鳄的防御力下降了！"]
                  : ["<32>{#p/story}* $(x)感到很不自在！\n* $(x)的防御力下降了！"],
      ...
      mkTurnActResult4: (opponent: string, multiple: boolean, allowpac: boolean) =>
         opponent === 'woshua' // NO-TRANSLATE
            ...
            ? [
               '<32>{#p/story}* 刷洁顿担心自己小命不保，\n  赶忙跑掉了！',
               ...(multiple ? ['<32>{#p/story}* 其他对手还想继续战斗。'] : [])
            ]
            : opponent === 'shyren' // NO-TRANSLATE

               ? allowpac
                  ? ['<32>{#p/story}* 害羞塞壬担心自己小命不保，\n  赶忙跑掉了！']
                  : ['<32>{#p/story}* 表演过后，害羞塞壬有了信心。\n  决定勇敢地直面危险！']
               : opponent === 'radtile' // NO-TRANSLATE

                  ? ['<32>{#p/story}* 老顽鳄担心自己小命不保，\n  赶忙跑掉了！']
                  : [
