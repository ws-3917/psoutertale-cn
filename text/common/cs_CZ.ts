...
export default {
   _0: {
      _1: 'Hráč udělal vše, co mohl...',
      _2: 'Ale bohužel, jeho osud byl zpečetěn a...',
      _3: 'Žádný dodatek k příběhu ho nedokázal rozluštit.',
      _4: 'Neexistoval žádný scénář, ve kterém by hráč mohl být skutečně spokojen.',
      _5: 'Opravdu si to zaslouží?',
      _6: 'Žít v hořkosladké agónii s vědomím, že nikdy nemůže být...',
      _7: 'Žádný...\nto nedovolím.',
      _8: 'Pokud je potřeba ohýbat látku časoprostoru, pak...',
      _9: 'Budiž.',
      _10: 'Nebudu odpočívat, dokud nebude úkol dokončen.'
   },
   ...
   a_common: {
      bullybed: [
         [
            '<32>{#p/human}* (...)',
            '<32>{#p/human}* (Probudíš se.)',
            '<32>{#p/human}* (Základna je stejná, jako když jste šli spát.)'
         ],
         [
            '<32>{#p/human}* (Prozkoumáváte každý kout základny, abyste našli známky života, ale nikdo nepřichází.)',
            '<32>{#p/human}* (Hledáš znovu a znovu a znovu...)',
            '<32>{#p/human}* (Ale nikdo nepřijde.)'
         ],
         [
            '<32>{#p/human}* (Hledáte loď, na které jste přijeli.)\n* (Zdá se, že byla zničena.)',
            '<32>{#p/human}* (Pátráš po dalších lodích, které tu zanechal druh příšer.)',
            '<32>{#p/human}* (Zdá se, že ti byli odebráni.)'
         ],
         [
            '<32>{#p/human}* (Navštívíš laboratoř a hledáš plány a součástky raketoplánu.)',
            '<32>{#p/human}* (Plány jsou k dispozici a díly jsou ve skladu...)',
            "<32>{#p/human}* (Zbývající energie CORE však nebude stačit k vypuštění raketoplánu.)"
         ],
         [
            '<32>{#p/human}* (Pokusíte se OBNOVIT tvůj ukládání soubor.)\n* (Nic se neděje.)',
            '<32>{#p/human}* (Zkusíte znovu OBNOVIT tvůj ukládání soubor.)',
            '<32>{#p/human}* (Nic se neděje.)'
         ],
         [
            "<32>{#p/human}* (V zoufalství se snažíš zavolat Torielin telefon.)\n* (Žádná odpověď.)",
            '<32>{#p/human}* (Pokusíte se zavolat Papyrus a Undyne.)',
            '<32>{#p/human}* (Žádná odpověď.)'
         ],
         [
            '<32>{#p/human}* (...)',
            "<32>{#p/human}* (Ztratili jste přehled o tom, jak dlouho jste tady.)",
            "<32>{#p/human}* (Nemůžete říct, jestli to byly týdny, měsíce nebo roky.)",
            "<32>{#p/human}* (Nastavili jste CORE tak, aby spotřebovával co nejméně energie...)",
            "<32>{#p/human}* (Ale nemůže to trvat věčně.)"
         ],
         [
            '<32>{#p/human}* (Gravitace se uvolní.)',
            '<32>{#p/human}* (Teplota začíná klesat.)',
            '<32>{#p/human}* (Atmosféra se hroutí.)',
            '<32>{#p/člověk}* (Bez napájení bude základna neobyvatelná.)'
         ],
         [
            '<32>{#p/human}* (Nějak se cítíš v klidu.)',
            "<32>{#p/human}* (Se svou smrtí jste se smířil.)",
            "<32>{#p/human}* (Uvědomujete si, že to jinak nemohlo dopadnout.)",
            '<32>{#p/human}* (Když se zbývající vzduch rozplyne, vzpomeneš si naposledy na svou cestu.)',
            '<32>{#p/human}* (Ode dne tvého vyhnanství až do dne, kdy utekla nestvůra.)'
         ],
         [
            '<32>{#p/human}* (Vzduch už došel.)',
            '<32>{#p/human}* (Začínáš se dusit.)',
            '<32>{#p/human}* (Cítíš, jak život opouští tvé tělo.)',
            '<32>{#p/human}* (Zdá se, že konec je...)'
         ]
      ],
      dogcheck1: [
         '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
         '<25>{#p/basic}(A tak jste dospěli na konec!)',
         '<25>{#p/basic}(Nadešel čas zhodnotit své úspěchy!)'
      ],
      dogcheck2: () => [
         ...(!SAVE.flag.b._saved
            ? !SAVE.flag.b._item
               ? [
                  '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                  '<25>{#p/basic}(Páni!)\n(Žádné UKLÁDÁNÍ body a žádné VĚCI!)',
                  '<25>{#p/basic}(Asi jste spěchali!)'
               ]
               : [
                  '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                  "<25>{#p/basic}(Páni!)\n(Nevíte, co je to UKLÁDÁNÍ bod?)",
                  '<25>{#p/basic}(Nikdy jste ho nepoužili!)'
               ]
            : !SAVE.flag.b._item
               ? [
                  '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                  "<25>{#p/basic}(Páni!)\n(Nevíte, co je to VĚC?)",
                  '<25>{#p/basic}(Nikdy jste ho nedostali!)'
               ]
               : []),
         ...(SAVE.flag.n._hits === 0
            ? !SAVE.flag.b._flee
               ? [
                  '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                  '<25>{#p/basic}(Úžasné!)\n(Uhýbal jsi každému útoku a nikdy jsi neutekl!)',
                  !SAVE.flag.b._equip
                     ? "<25>{#p/basic}(Museli jste vědět, že nebudete potřebovat žádné brnění ani zbraně!)"
                     : '<25>{#p/basic}(Musíš být opravdu velmi statečný!)'
               ]
               : [
                  '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                  '<25>{#p/basic}(Úžasné!)\n(Uhýbal jsi každému útoku, kterému jsi čelil!)',
                  !SAVE.flag.b._equip
                     ? '<25>{#p/basic}(Jaké štěstí pro někoho, kdo nikdy nenosil žádné brnění ani zbraně!)'
                     : '<25>{#p/basic}(Jak zkušený v boji musíš být!)'
               ]
            : SAVE.flag.n._deaths + SAVE.flag.n._deaths_twinkly === 0
               ? !SAVE.flag.b._heal
                  ? !SAVE.flag.b._flee
                     ? [
                        '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                        '<25>{#p/basic}(Úžasné!)\n(Nejenže jsi nikdy nezemřel...)',
                        !SAVE.flag.b._equip
                           ? '<25>{#p/basic}(Nikdy jsi neléčil, ani jsi nevybavil žádnou zbrojí nebo zbraněmi!)'
                           : '<25>{#p/basic}(Ani ty jsi se nikdy neuzdravil!)'
                     ]
                     : [
                        '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                        '<25>{#p/basic}(Úžasné!)\n(Nikdy jsi nezemřel a nikdy jsi neutekl!)',
                        !SAVE.flag.b._equip
                           ? "<25>{#p/basic}(Ani jsi neléčil ani se nevybavil žádnou zbrojí nebo zbraněmi!)"
                           : "<25>{#p/basic}(Ani jsi se neuzdravil!)"
                     ]
                  : !SAVE.flag.b._flee
                     ? [
                        '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                        '<25>{#p/basic}(Úžasné!)\n(Nikdy jsi nezemřel a nikdy jsi neutekl!)',
                        !SAVE.flag.b._equip
                           ? '<25>{#p/basic}(Je to důvod, proč jste nikdy nevybavil žádnou zbroj nebo zbraně?)'
                           : '<25>{#p/basic}(Tohle znamená být statečný?)'
                     ]
                     : !SAVE.flag.b._equip
                        ? [
                           '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                           '<25>{#p/basic}(Úžasné!)\n(Nikdy jsi nezemřel a nikdy jsi neměl žádné brnění nebo zbraně!)'
                        ]
                        : ['<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!', '<25>{#p/basic}(Úžasné!)\n(Nikdy jsi nezemřel ani jednou!)']
               : !SAVE.flag.b._heal
                  ? !SAVE.flag.b._flee
                     ? [
                        '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                        '<25>{#p/basic}(Úžasné!)\n(Nikdy jste se neuzdravili a nikdy jste neutekli!)',
                        !SAVE.flag.b._equip
                           ? "<25>{#p/basic}(Jsi si jistý, že jsi také nepotřeboval žádné brnění nebo zbraně?)"
                           : '<25>{#p/basic}(Určitě se vám líbí žít na hraně.)'
                     ]
                     : !SAVE.flag.b._equip
                        ? [
                           '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                           '<25>{#p/basic}(Úžasné!)\n(Nikdy jsi neléčil ani nevybavil žádnou zbrojí nebo zbraněmi!)'
                        ]
                        : [
                           '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                           '<25>{#p/basic}(Úžasné!)\n(Nikdy jste se nevyléčili ani jednou!)'
                        ]
                  : !SAVE.flag.b._flee
                     ? [
                        '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                     ...
                     : !SAVE.flag.b._equip
                        ? [
                           '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                           '<25>{#p/basic}(Úžasné!)\n(Nikdy jste se nevybavil žádnou zbrojí ani zbraněmi!)'
                        ]
                        : []),
         ...(!SAVE.flag.b._skip
            ? [
               '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
               "<25>{#p/basic}(Jak laskavý...)\n(Nikdy jste nepřeskočil ničí dialog!)",
               !SAVE.flag.b._call
                  ? SAVE.data.n.plot_pmcheck === 0 && phone.of('pms').display() && pms().length > 0 // NO-TRANSLATE

                     ? '<25>{#p/basic}(Škoda, že váš telefon zřejmě nikdy nebyl použit.)'
                     : '<25>{#p/basic}(Škoda, že váš telefon nikdy nikoho nevytočil.)'
                  : SAVE.data.n.plot_pmcheck === 0 && phone.of('pms').display() && pms().length > 0 // NO-TRANSLATE

                     ? '<25>{#p/basic}(Škoda, že váš telefon nikdy nečetl zprávy.)'
                     : '<25>{#p/basic}(Na každém ti musí opravdu hodně záležet!)'
            ]
            : !SAVE.flag.b._call
               ? SAVE.data.n.plot_pmcheck === 0 && phone.of('pms').display() && pms().length > 0 // NO-TRANSLATE
                  ...
                  ? [
                     '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                     '<25>{#p/basic}(To je divné...)\n(Zdá se, že váš telefon nebyl nikdy použit!)'
                  ]
                  : [
                     '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                     '<25>{#p/basic}(To je divné...)\n(Zdá se, že váš telefon nikdy nikoho nevytočil!)'
                  ]
               : SAVE.data.n.plot_pmcheck === 0 && phone.of('pms').display() && pms().length > 0 // NO-TRANSLATE

                  ? [
                     '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                     '<25>{#p/basic}(To je divné...)\n(Zdá se, že váš telefon nikdy neměl přečtené zprávy!)'
                  ]
                  : []),
         ...(!SAVE.flag.b._getg
            ? [
               '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
               '<25>{#p/basic}(Šokující!)\n(Nikdy jste nezískali žádné Z!)'
            ]
            : !SAVE.flag.b._useg
               ? [
                  '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
                  '<25>{#p/basic}(Šokující!)\n(Nikdy jste neutratili nic ze svého Z!)'
               ]
               : []),
         ...(SAVE.data.b.water
            ? [
               '<25>{#x1}{#p/event}Štěk!',
               "<25>{#p/basic}(Opravdu se vám líbí držet ten hrnek s elektro-tlumicí kapalinou, že?)"
            ]
            : [])
      ],
      dogcheck3: (none: boolean) =>
         none
            ? [
               '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
               "<25>{#p/basic}(Zdá se, že jste neudělal nic neobvyklého.)",
               '<25>{#p/basic}(Možná je to samo o sobě mimořádné!)'
            ]
            : [
               '<25>{#x1}{#p/event}Štěk!\n{#x1}{#p/event}Štěk!',
               "<25>{#p/basic}(Zdá se, že to je vše, co se dnes dá říct!)",
               '<25>{#p/basic}(Gratulujeme a nashledanou!)'
            ],
      neutral0() {
         let d = false;
         let k = '';
            ...
            if (!dundyne) {
               if (royals < 2) {
                  ...
                  addB([
                     ...
                     '<26>{#p/undyne}{#f/7}* DOBŘE, PUNKE, POSLOUCHEJ!',
                     "<25>{#p/undyne}{#f/4}* Udělal jsi VELKOU chybu, když jsi ušetřil můj život po tom, co jsi udělal.",
                     "<25>{#p/undyne}{#f/5}* Díky vám mám sílu dělat to, co jsem VŽDY chtěla, a...",
                     '<25>{#p/undyne}{#f/17}* ... a...',
                     "<25>{#p/undyne}{#f/16}* ... no, ještě předtím bych vám ráda řekla, jak jsem se sem dostala.",
                     '<25>{#p/undyne}{#f/20}* Takže... všechno začalo, když jsi opustil základnu.',
                     "<25>{#p/undyne}{#f/22}* Zjistila jsem, co jsi udělal, a ... sama jsem zaútočil na Citadelu.",
                     '<25>{#p/undyne}{#f/22}* Alphys byl v šoku.\nKrál byl mrtev a stráž byla pryč.',
                     '<25>{#p/undyne}{#f/20}* Navíc, po tom, co se ona a Mettaton pokusili udělat, aby tě zastavili...',
                     "<25>{#p/undyne}{#f/22}* Energetické systémy základny se začaly chovat jako šílené.",
                     '<25>{#p/undyne}{#f/19}* Atmosféra, gravitace... na těchto věcech jsme závislí...',
                     '<25>{#p/undyne}{#f/19}* Všichni se začali zbláznit, což mělo za následek nespočet mrtvých.',
                     "<25>{#p/undyne}{#f/18}* Bez královské gardy bychom je nemohli evakuovat do bezpečí.",
                     '<25>{#p/undyne}{#f/16}* Pak, aby toho nebylo málo, archiv TVRDĚ zasáhl masivní nárůst energie.',
                     '<25>{#p/undyne}{#f/19}* Lidé uvnitř byli okamžitě mrtví.',
                     '<25>{#p/undyne}{#f/10}* ...\n* Pochopila jsem, o co ASGORE usiloval.',
                     "<25>{#p/undyne}{#f/10}* Způsob, jak nás osvobodit, který by nezahrnoval to, že bychom někoho zabili?",
                     '<25>{#p/undyne}{#f/16}* ... Heh.\n* Bylo to velmi... ho.',
                     "<25>{#p/undyne}{#f/19}* Po tomto nárůstu energie však ASGORŮV plán selhal.",
                     '<25>{#p/undyne}{#f/20}* Takže s lidskými DUŠEMI přede mnou a s padajícím královstvím...',
                     '<25>{#p/undyne}{#f/20}* ...',
                     '<25>{#p/alphys}{#f/10}* Nechci přerušovat, ale myslím, že jsme našli to, co jste h-hledali.',
                     '<25>{#p/undyne}{#f/12}* Je to tak?',
                     '<25>{#p/undyne}{#f/1}* Dovolte mi vidět, že...',
                     '<25>{#p/undyne}{#f/17}* ...',
                     '<25>{#p/alphys}{#f/18}* ...\n* Je to tak!?',
                     '<25>{#p/undyne}{#f/9}* Tch.\n* \"Je to tak?\"',
                     '<25>{#p/undyne}{#f/11}* Děláš si ze mě srandu?',
                     '<25>{#p/alphys}{#f/20}* ...',
                     "<25>{#p/undyne}{#f/8}* SAMOZŘEJMĚ, ŽE JE TO PRAVDA!",
                     '<25>{#p/undyne}{#f/7}* Takže, když jsem shromáždila lidské DUŠE...',
                     '<25>{#p/undyne}{#f/11}* Alphys a já jsme přišly s plánem, jak zachránit VŠECHNY.',
                     "<25>{#p/undyne}{#f/16}* Letěli bychom raketoplánem kolem silového pole a ulovili vás...",
                     '<25>{#p/undyne}{#f/7}* A my vám vytrhneme duši z těla!',
                     "<25>{#p/undyne}{#f/1}* Pak bychom se vrátili a rozstříleli silové pole na kusy!",
                     '<25>{#p/undyne}{#f/12}* Jediný problém je, jak bychom vás našli?',
                     '<25>{#p/alphys}{#f/15}* N-no, na TUTO otázku mohu odpovědět.',
                     '<25>{#p/alphys}{#f/16}* Koneckonců, byla jsem to já, kdo přišla s řešením!',
                     "<25>{#p/alphys}{#f/26}* Je to opravdu jednoduché.\n* Tím, že jsem odpověděla na tento VELMI telefonát..."
                  ]);
                  if (!dpapyrus) {
                     addB([
                        "<25>{|} {#p/alphys} {#f/18}* Podařilo se nám triangulovat vaše- {%}",
                        '<18>{#p/papyrus}{#f/6}UNDYNE!?\nJSI V POŘÁDKU!?',
                        '<25>{#p/alphys}{#f/2}* ...!?',
                        '<25>{#p/undyne}{#f/13}* Cože??\n* Co zde děláte vy?',
                        '<18>{#p/papyrus}{#f/5}NO... SLYŠEL JSEM SPOUSTU KŘIKU.\nA KŘIČEL.',
                        '<18>{#p/papyrus}{#f/6}MĚL JSEM O TEBE STRACH.',
                        '<25>{#p/undyne}{#f/14}* Ach, díky Papyrusi.\n* Jak ohleduplné od vás.',
                        "<18>{#p/papyrus}{#f/0}AHA, NEMÁTE ZAČ!",
                        "<25>{#p/undyne}{#f/7}* Možná se PŘÍŠTĚ neplížte do RAKETOPLÁNU NĚKOHO JINÉHO!!",
                        "<18>{#p/papyrus}{#f/6}O-OMLOUVÁM SE, BYL JSEM ZVĚDAVÝ, ANO??",
                        '<18>{#p/papyrus}{#f/5}ŠEL JSEM SE PODÍVAT A DALŠÍ VĚC, KTEROU JSEM VĚDĚL...',
                        '<18>{#p/papyrus}{#f/6}RAKETOPLÁN ZAČAL LÉTAT ZE ZÁKLADNY!',
                        "<18>{#p/papyrus}{#f/4}VĚŘTE MI, ŽE BYCH RADĚJI ZŮSTAL DOMA.",
                        "<25>{#p/alphys}{#f/15}* Dobře, ehm, nevím, jestli to můžete říct, ale...",
                        "<25>{#p/alphys}{#f/23}* Jsme uprostřed situace.",
                        '<25>{#p/undyne}{#f/12}* Ano, měl bys... Pravděpodobně se znovu vrátíte do úkrytu.',
                        '<25>{#p/undyne}{#f/1}* Ber to jako hru na schovávanou!',
                        '<18>{#p/papyrus}{#f/6}A JAK DLOUHO SE MUSÍM SKRÝVAT!?',
                        "<25>{#p/undyne}{#f/12}* Nevím???",
                        "<25>{#p/alphys}{#f/17}* Dvě hodiny.\n* Dáme vám dvě hodiny.",
                        '<18>{#p/papyrus}{#f/0}DOBŘE!!\nTAK HODNĚ ŠTĚSTÍ!!',
                        '<25>{#p/alphys}{#f/20}* ... budou stačit dvě hodiny na to, aby člověka chytili, nebo...',
                        '<25>{#p/undyne}{#f/14}* Pfft, dvě HODINY?',
                        "<25>{#p/undyne}{#f/1}* Jo, to si nemyslím.",
                        '<25>{#p/undyne}{#f/4}* ...\n* Fuhuhuhuhu...',
                        '<25>{*}{#x0}{#p/undyne}{#f/7}* Zkuste dvě SEKUNDY.{^40}{%}'
                     ]);
                  } else {
                     addB([
                        "<25>{#p/alphys}{#f/18}* Podařilo se nám zjistit vaši polohu!",
                        "<25>{#p/undyne}{#f/1}* Fuhuhu... To je pravda.",
                        "<25>{#p/undyne}{#f/7}* Už jsi na to NALETĚL, punke!",
                        "<25>{#p/alphys}{#f/16}* A-ano, budete si přát, abyste n-neudělali všechno, co jste udělali!!",
                        "<25>{#p/alphys}{#f/16}* Ať jdeš kamkoli, není úniku!!",
                        "<25>{#p/undyne}{#f/8}* ANO!!\n* ŘEKNI JIM TO, ALPHYSI!!",
                        '<25>{#p/undyne}{#f/4}* ...\n* Fuhuhuhuhu...',
                        "<25>{*}{#x0}{#p/undyne}{#f/7}* Teď vás mám.{^40}{%}"
                     ]);
                  }
               } else {
                  ...
                  addA([
                     '<32>{#s/phone}{#p/událost}* Zvoní, zvoní...',
                     '<25>{#p/alphys}{#f/33}* ... pššt, pššt, myslím, že to jsou oni.',
                     "<25>{#p/alphys}{#f/1}* Ahoj!\n* Jsem Dr. Alphys.",
                     '<25>{#p/alphys}{#f/17}* Hlava královské společnosti bolesti v zadku.',
                     '<25>{#p/alphys}{#f/28}* ... Mohu vás dnes zajímat o tragický příběh?'
                  ]);
                  addB([
                     '<25>{#p/alphys}{#f/5}* Tak jsem se věnovala své práci, starala se o archiv...',
                     '<25>{#p/alphys}{#f/23}* Když najednou slyším startovat kosmickou loď.',
                     '<32>{#p/basic}{@fill=#ffbbdc}* Obrooooovská kosmická loď.',
                     '<25>{#p/alphys}{#f/17}* Eh, ne tak docela.\n* Byl to jen raketoplán.',
                     '<32>{#p/basic}{@fill=#ffbbdc}* Aha.\n* Malá kosmická loď.',
                     '<25>{#p/alphys}{#f/15}* Jo, a Asgore nebyl NIKDE k nalezení.',
      ...
      neutral1: [
         ...
         "<32>{#p/human}* (You try to apologize, but you can't find the words.)",
         "<25>{#p/sans}{#f/3}* hey, don't sweat it.\n* we all make mistakes, don't we?",
         '<25>{#p/sans}{#f/0}* like, on the day you left...',
         '<25>{#p/sans}{#f/0}* it was a mistake to think my words could make any difference.',
         "<32>{#p/human}* (You ask Sans why he's only mentioning this now.)",
         '<25>{#p/sans}{#f/0}* hmm... good point.',
         "<25>{#p/sans}{#f/3}* we've never really discussed it before.",
         "<25>{#p/sans}{#f/3}* i mean, i could ask why you're still in range of the outpost...",
         '<25>{#p/sans}{#f/2}* but that might be getting a little too off-topic.',
         '<25>{#p/sans}{#f/0}* so... why am i only bringing that day up now?',
         '<25>{#p/sans}{#f/3}* well, to tell you the truth...',
         "<25>{#p/sans}{#f/0}* i'm having trouble taking what happened at face value.",
         "<32>{#p/human}* (You focus on Sans's voice.)",
         '<25>{#p/sans}{#f/0}* first off, none of the other humans were like you.',
         '<25>{#p/sans}{#f/3}* and, sure, not all of them were perfect angels.',
         '<26>{#p/sans}{#f/0}* but, generally speaking, they acted like normal children.',
         '<25>{#p/sans}{#f/0}* ... which brings me to my main point.',
         ...
         '<25>{#p/sans}{#f/0}* the answer to that question was \"no.\"',
         '<25>{#p/sans}{#f/0}* the more i think about it, buddo...',
         '<25>{#p/sans}{#f/3}* the harder it is to believe you were in control back then.',
         '<32>{#p/human}* (Your eyes widen.)',
         '<25>{#p/sans}{#f/0}* looking back, you always seemed so cold...',
         ...
         "<25>{#p/sans}{#f/2}* if not, then you're one darn good actor.",
         "<32>{#p/human}* (...)\n* (You smile a little at Sans's joke.)",
         '<25>{#p/sans}{#f/3}* sorry if the subject got a little heavy, by the way.',
         "<25>{#p/sans}{#f/3}* i just thought i should tell you about what i've been thinking.",
         '<32>{#p/human}* (You ask if it would be a bad time to hang up.)',
         "<25>{#p/sans}{#f/0}* huh?\n* no, that's alright.",
         '<25>{#p/sans}{#f/3}* besides, you must have a lot to think about right now.',
         '<32>{#p/human}* (You let out a sigh.)',
         "<25>{#p/sans}{#f/3}* ... yeah.\n* i'll let you go.",
         '<25>{#p/sans}{#f/0}* good luck out there, okay?',
         "<25>{#p/sans}{#f/2}* i promise we'll do the best we can here.",
         '<32>{#s/equip}{#p/event}* Click...'
      ],
      neutral2: [
         '<32>{#s/phone}{#p/událost}* Zvoní, zvoní...',
   ...
   c_call_common: {
      ...
      nobody1: ['<32>{#p/human}* (Žádná odpověď.)'],
