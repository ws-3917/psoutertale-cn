...
export default {
   ...
   a_common: {
      bullybed: [
         [
            '<18>{#p/human}＊(…)',
            '<18>{#p/human}＊(めが　さめた)',
            '<18>{#p/human}＊(ぜんしょうきちは　ねたときと　おなじだ)'
         ],
         [
            '<18>{#p/human}＊(せいめいの　ちょうこうのために　あらゆるかくを　たんけんします　しかし　だれもこなかった)',
            '<18>{#p/human}＊(なんども　なーんども…)',
            '<18>{#p/human}＊(しかし　だれもこなかった)'
         ],
         [
            '<18>{#p/human}＊(とうちゃくした　ふねを　さがします)\n＊(うごか　なくなりました)',
            '<18>{#p/human}＊(モンスターたちの　のこしたふねを　さがします)',
            '<18>{#p/human}＊(しかし　ぜんぜん　みつかりません)'
         ],
         [
   ...
   b_group_common: {
      nobody: () => (!world.genocide && world.bullied ? '＊…しかし　みんな　にげてしまいました。' : '* ... but nobody came.')
   },
