...
export default {
   _0: {
      _1: 'Oyuncu elinden gelen her şeyi yaptı...',
      _2: 'Fakat ne yazık ki, onun kaderi çoktan belirlenmişti, ve...',
      _3: 'Hikayeye yapılan hiçbir ekleme bunu çözemezdi.',
      _4: 'Oyuncunun tam anlamıyla tatmin olabileceği hiçbir senaryo yoktu.',
      _5: 'Hak ettiği gerçekten bu mu?',
      _6: 'Onun için asla gerçekleşmeyeceğini bilerek, buruk bir acıyla yaşamak...',
      _7: 'Hayır...\nBuna izin vermeyeceğim.',
      _8: 'Gereken şey uzay-zamanın yapısını bükmekse, o zaman...',
      _9: 'Öyle olsun.',
      _10: 'Görev tamamlanana kadar dinlenmeyeceğim.'
   },
   ...
   a_common: {
      bullybed: [
         ...
         [
            '<32>{#p/human}* (Birlikte geldiğin gemiyi arıyorsun.)\n* (Yok edilmiş görünüyor.)',
            '<32>{#p/human}* (Canavar ırkı tarafından geride bırakılmış başka gemiler arıyorsun.)',
            '<32>{#p/human}* (Ama onları çoktan almışsın gibi görünüyor.)'
         ],
         [
            '<32>{#p/human}* (Laboratuvarı ziyaret ediyorsun, taslak ve mekik parçalarını arıyorsun.)',
            '<32>{#p/human}* (Taslaklar var, parçalar ise depoda...)',
            "<32>{#p/human}* (Ama ÇEKİRDEĞİN kalan enerjisi mekiği kaldırmak için yeterli olmayacak.)"
         ],
         [
         ...
         [
            '<32>{#p/human}* (Yerçekimi ortadan kalkıyor.)',
            '<32>{#p/human}* (Sıcaklık azalmaya başlıyor.)',
            '<32>{#p/human}* (Atmosfer çöküyor.)',
            '<32>{#p/human}* (Güç olmadan, Karakol yaşanamaz olacak.)'
         ],
         [
         ...
         [
            '<32>{#p/human}* (Hava tükendi.)',
            '<32>{#p/human}* (Boğulmaya başladın.)',
            '<32>{#p/human}* (Ruhunun bedeninden ayrıldığını hissediyorsun.)',
            '<32>{#p/human}* (Son gelmişe benziyor...)'
         ]
      ],
      dogcheck1: [
         '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
         '<25>{#p/basic}(Ve böylece, sona ulaştın!)',
         '<25>{#p/basic}(Başarılarını inceleme vakti geldi!)'
      ],
      dogcheck2: () => [
         ...(!SAVE.flag.b._saved
            ? !SAVE.flag.b._item
               ? [
                  '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                  '<25>{#p/basic}(Vay canına!)\n(Hiç KAYIT dosyası ve EŞYA yok!)',
                  '<25>{#p/basic}(Büyük acele içindeydin anlaşılan!)'
               ]
               : [
                  '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                  "<25>{#p/basic}(Vay canına!)\n(KAYIT noktasının ne olduğunu bilmiyor musun?)",
                  '<25>{#p/basic}(Hiçbirini kullanmadın!)'
               ]
            : !SAVE.flag.b._item
               ? [
                  '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                  "<25>{#p/basic}(Vay canına!)\n(EŞYA'nın ne olduğunu bilmiyor musun?)",
                  '<25>{#p/basic}(Hiç almamışsın!)'
               ]
               : []),
         ...(SAVE.flag.n._hits === 0
            ? !SAVE.flag.b._flee
               ...
               : [
                  '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                  '<25>{#p/basic}(Mükemmel!)\n(Yüzleştiğin tüm saldırıları ıskaladın!)',
                  !SAVE.flag.b._equip
                     ? '<25>{#p/basic}(Hiç zırh ve silahı olmayan birisi için ne kadar şanslı!)'
                     : '<25>{#p/basic}(Savaşta becerin olmalı!)'
               ]
            : SAVE.flag.n._deaths + SAVE.flag.n._deaths_twinkly === 0
               ? !SAVE.flag.b._heal
                  ? !SAVE.flag.b._flee
                     ...
                     : [
                        '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                        '<25>{#p/basic}(Mükemmel!)\n(Hiç ölmedin, hiç kaçmadın!)',
                        !SAVE.flag.b._equip
                           ? "<25>{#p/basic}(Hiç iyileşmedin veya zırh ve silah kuşanmadın bile!)"
                           : "<25>{#p/basic}(Hiç iyileşmedin bile!)"
                     ]
                  : !SAVE.flag.b._flee
                     ? [
                        '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                        '<25>{#p/basic}(Mükemmel!)\n(Hiç ölmedin, hiç kaçmadın!)',
                        !SAVE.flag.b._equip
                           ? '<25>{#p/basic}(Bu yüzden mi hiç zırh ve silah kuşanmadın?)'
                           : '<25>{#p/basic}(Cesur olmak bu anlama mı geliyor?)'
                     ]
                     : !SAVE.flag.b._equip
                        ? [
                           '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                           '<25>{#p/basic}(Mükemmel!)\n(Hiç ölmedin veya hiç zırh ve silah kuşanmadın!)'
                        ]
                        : ['<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!', '<25>{#p/basic}(Mükemmel!)\n(Bir kere bile ölmedin!)']
               : !SAVE.flag.b._heal
                  ? !SAVE.flag.b._flee
                     ? [
                        '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                        '<25>{#p/basic}(Mükemmel!)\n(Hiç iyileşmedin, ve hiç kaçmadın!)',
                        !SAVE.flag.b._equip
                           ? "<25>{#p/basic}(Hiç silaha ve zırha ihtiyacın olmadığına emin misin?)"
                           : '<25>{#p/basic}(Tam kıyıda yaşıyormuşsun gibi olmalı!)'
                     ]
                     : !SAVE.flag.b._equip
                        ? [
                           '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                           '<25>{#p/basic}(Mükemmel!)\n(Hiç iyileşmedin veya hiç zırh ve silah kuşanmadın!)'
                        ]
                        : [
                           '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                           '<25>{#p/basic}(Mükemmel!)\n(Bir kere bile iyileşmedin!)'
                        ]
                  : !SAVE.flag.b._flee
                     ? [
                        '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                     ...
                     : !SAVE.flag.b._equip
                        ? [
                           '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                           '<25>{#p/basic}(Mükemmel!)\n(Hiç silah ve zırh kuşanmadın!)'
                        ]
                        : []),
         ...(!SAVE.flag.b._skip
            ? [
               '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
               "<25>{#p/basic}(Ne kadar kibar...)\n(Kimsenin konuşmasını geçmedin!)",
               !SAVE.flag.b._call
                  ? SAVE.data.n.plot_pmcheck === 0 && phone.of('pms').display() && pms().length > 0 // NO-TRANSLATE

                     ? '<25>{#p/basic}(Telefonunun hiç kullanılmamış görünüyor olması çok kötü.)'
                     : '<25>{#p/basic}(Telefonunun kimseyi aramamış görünmesi çok kötü.)'
                  : SAVE.data.n.plot_pmcheck === 0 && phone.of('pms').display() && pms().length > 0 // NO-TRANSLATE

                     ? '<25>{#p/basic}(Telefonunun mesajlarının hiç okunmamış olması çok kötü.)'
                     : '<25>{#p/basic}(Herkesi gerçekten umursuyor olmalısın!)'
            ]
            : !SAVE.flag.b._call
               ? SAVE.data.n.plot_pmcheck === 0 && phone.of('pms').display() && pms().length > 0 // NO-TRANSLATE
                  ...
                  ? [
                     '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                     '<25>{#p/basic}(Ne kadar garip...)\n(Telefonun hiç kullanılmamış görünüyor!)'
                  ]
                  : [
                     '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                     '<25>{#p/basic}(Ne kadar garip...)\n(Telefonun kimseyi aramamış gibi görünüyor!)'
                  ]
               : SAVE.data.n.plot_pmcheck === 0 && phone.of('pms').display() && pms().length > 0 // NO-TRANSLATE

                  ? [
                     '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                     '<25>{#p/basic}(Ne kadar garip...)\n(Telefonunun mesajları hiç okunmamışa benziyor!)'
                  ]
                  : []),
         ...(!SAVE.flag.b._getg
            ? [
               '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
               '<25>{#p/basic}(Şok edici!)\n(Hiç Altın elde etmedin!)'
            ]
            : !SAVE.flag.b._useg
               ? [
                  '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
                  '<25>{#p/basic}(Şok edici!)\n(Hiç altınlarını harcamadın!)'
               ]
               : []),
         ...(SAVE.data.b.water
            ? [
               '<25>{#x1}{#p/event}Hav!',
               "<25>{#p/basic}(O elektro-sönümleyici sıvı kabını tutmayı çok seviyorsun, değil mi?)"
            ]
            : [])
      ],
      dogcheck3: (none: boolean) =>
         none
            ...
            : [
               '<25>{#x1}{#p/event}Hav!\n{#x1}{#p/event}Hav!',
               "<25>{#p/basic}(Görünüşe bakılırsa bugün söyleyeceklerimin hepsi bu kadar!)",
               '<25>{#p/basic}(Tebrikler ve görüşürüz!)'
            ],
      neutral0() {
         let d = false;
         let k = '';
            ...
            if (!dundyne) {
               if (royals < 2) {
                  ...
                  addB([
                     ...
                     '<26>{#p/undyne}{#f/7}* PEKALA SERSERİ, DİNLE!',
                     "<25>{#p/undyne}{#f/4}* Yaptığın şeyden sonra beni bağışlayarak BÜYÜK bir hata yaptın.",
                     ...
                     "<25>{#p/undyne}{#f/18}* Kraliyet muhafızları olmadan, onları güvenli bir yere tahliye edemedik.",
                     '<25>{#p/undyne}{#f/16}* Sonra, üstüne üstlük, büyük bir güç dalgalanması arşive SERT bir şekilde çarptı.',
                     '<25>{#p/undyne}{#f/19}* İçindeki insanlar anında öldü.',
                     '<25>{#p/undyne}{#f/10}* ...\n* ASGORE\'un amacını anladım..',
                     "<25>{#p/undyne}{#f/10}* Kimseyi öldürmemiz gerekmeden bizi özgür bırakabilecek bir yol mu?",
                     '<25>{#p/undyne}{#f/16}* ... heh.\n* Bu ondan beklenir bir hareketti.',
                     "<25>{#p/undyne}{#f/19}* Ama bu güç akışından sonra, ASGORE'un planı suya düştü.",
                     '<25>{#p/undyne}{#f/20}* Böylece önümde olan insan RUHLARI ve düşen bir krallık ile birlikte...',
                     '<25>{#p/undyne}{#f/20}* ...',
                     '<25>{#p/alphys}{#f/10}* Rahatsız etmek istemem ama, sanırım a-aradığın şeyi bulduk.',
                     '<25>{#p/undyne}{#f/12}* Öyle mi?',
                     ...
                     '<25>{#p/undyne}{#f/12}* Tek sorun, seni nasıl bulacaktık?',
                     '<25>{#p/alphys}{#f/15}* P-Pekala, bu soruyu ben cevaplayabilirim.',
                     '<25>{#p/alphys}{#f/16}* Sonuçta, çözümle çıkagelen bendim!',
                     "<25>{#p/alphys}{#f/26}* Gerçekten, basit.\n* Bu telefona cevap vererek..."
                  ]);
                  if (!dpapyrus) {
                     addB([
                        "<25>{|}{#p/alphys}{#f/18}* Böylece senin konumunu bu- {%}",
                        ...
                        "<18>{#p/papyrus}{#f/4}İNAN BANA, GERİDE KALMAYI TERCİH EDERDİM.",
                        "<25>{#p/alphys}{#f/15}* Pekala, uh, anladın mı bilmiyorum ama...",
                        "<25>{#p/alphys}{#f/23}* Bir durumun tam ortasındayız.",
                        '<25>{#p/undyne}{#f/12}* Evet, belki de... gidip yeniden saklanmalısın.',
                        '<25>{#p/undyne}{#f/1}* Saklambaçmış gibi düşün!',
                        '<18>{#p/papyrus}{#f/6}VE NE KADAR SÜRE SAKLANMAM GEREKİYOR?!',
                        "<25>{#p/undyne}{#f/12}* Bilmiyorum??",
