...
'<25>{#f/6}* ...',
         ...
         afterfight5a: ['<25>{#p/asriel2}{#f/5}* 我最亲爱的Asgore！', '<25>{#f/5}* 最近活得滋润不？'],
         afterfight5b: [
         ...
         coretext4a: ['<32>{#p/basic}{#s/spiderLaugh}* Papyrus！', "<32>{#p/basic}* 你还活着~"],
         ...
         coretext20: [
            ...
            '<18>{#p/papyrus}{#f/0}ASGORE！我们成功了！',
            '<18>{#p/papyrus}{#f/0}核心不会爆炸了！',
            '<32>{#p/basic}* ...我的表亲，Blooky，它...',
         ...
         coretext26: ['<18>{*}{#p/papyrus}{#f/7}ASGORE，你做了什么？！{^40}{%}'],
      ...
      story: {
         ...
         bad2: [
            ...
            '<25>{*}{#g/twinklySassy}* 闪亮明星：Twinkly。{^30}{%}'
         ],
         ...
         bad13: () => [
            ...
            '<99>{#p/twinkly}{#v/1}Asgore把那“档案”当宝一样宠着...{^100}{%}',
      ...
      overworld: {
         ...
         brocall4: [
            '<32>{#s/phone}{#p/event}* 铃铃，铃铃...',
            '<32>{#p/mettaton}* 嘿。\n* ALPHYS刚给我打电话，跟我说\n  你不配合她的工作。',
            "<32>{#p/mettaton}* 随后，我就跟PAPYRUS聊了聊...",
...
'<32>* “但一无所获。”',
                           ...
                           : [
                              [
                                 ...
                                 '<32>{#p/asgore}* “Asgore的日记，克历516年1月。”',
                                 '<32>* “在这艰难的时刻，\n   身边却一个伙伴都没有，\n   只能聊以自慰。”',
                                 '<32>* “或许写几页日记\n   能缓解一下我的伤痛。”',
                                 '<32>* “此刻，我心中五味杂陈。”',
                                 '<32>* “我很愤怒，\n   人类的所作所为，孩子们遭的罪...\n   想到这些，我气不打一处来。”',
                              ...
                              [
                                 '<32>{#p/human}* （你翻到下一篇日记。）',
                                 '<32>{#p/asgore}* “Asgore的日记，克历516年2月。”',
                                 '<32>* “今天，Gerson来看望我。”',
                                 '<32>* “他和我倾诉了自己的经历。”',
                                 '<32>* “他讲了在行星理事会的辉煌事业，\n   讲了和家人的分别，\n   还讲了自己身上的责任。”',
                                 '<32>* “他的故事触动了我。”',
   ...
   b_opponent_archive1: {
      ...
      status0: ['<32>{#p/human}* （此刻，546f7269656c\n  正站在你的面前。）'],
      ...
      dinnerStatus: ['<32>{#p/human}* （看起来，546f7269656c\n  想给你读点什么。）'],

      act_storytimeX: ['<32>{#p/human}* （可是，你们已经读完故事了。）'],
      act_storytimeE: ['<32>{#p/human}* （可是，546f7269656c\n  现在还不想给你读故事。）'],
      storyTalk: [
         '<11>{#p/toriel}从前，\n有一只{@fill=#42fcff}{@mystify=怪物圣忽恠㹅径勿}怪物{@mystify=}{@fill=#ffffff}...'
      ],
      storyStatus: ['<32>{#p/human}* （546f7269656c\n  还想为你做一件事。）'],

      act_bedtimeX: ['<32>{#p/human}* （可是，她已经哄过你了。）'],
      act_bedtimeE: ['<32>{#p/human}* （可是，546f7269656c\n  现在和不想哄你睡觉。）'],
      bedTalk: ['<11>{#p/toriel}孩子，晚安。'],
      bedStatus: ['<32>{#p/human}* （Toriel完成了自己的使命。）'],

      act_talkE: ["<32>{#p/human}* （可是，546f7269656c\n  还没有完成她的使命。）"],
      act_talkN: ['<32>{#p/human}* （在消散前，Toriel送给你\n  一则人生心得。）'],
   ...
   b_opponent_archive2: {
      ...
      status1: ['<32>{#p/human}* （476572736f6e让你先出招。）'],
      ...
      failStatus: ["<32>{#p/human}* （476572736f6e觉得\n  你应该休息一下。）"],
      successStatus: ['<32>{#p/human}* （Gerson完成了自己的使命。）'],

      act_restA: ['<32>{#p/human}* （可是，你现在还不累。）'],
      restTalk: [
         '<11>{#p/basic}一名\n够格的{@fill=#ff993d}{@mystify=英雄偀䧺央隹䇦难}英雄{@mystify=}{@fill=#ffffff}\n绝不会逞强。'
      ],
      restStatus: ['<32>{#p/human}* （476572736f6e很期待\n  你下回出什么招。）'],

      act_handshakeE: ["<32>{#p/human}* （可是，476572736f6e对你的\n  一对一训练还未结束。）"],
      act_handshakeN: ['<32>{#p/human}* （在消散前，Gerson把最喜欢的\n  握手方式教给了你。）'],
   ...
   b_opponent_archive4: {
      ...
      successStatus: ['<32>{#p/human}* （Napstablook完成了它的使命。）'],
   ...
   b_opponent_asriel: {
      ...
      act_flirt1: ['<32>{#p/human}* （你向Asriel调情。）\n* （什么都没发生。）'],
      act_flirt2: [
      ...
      status3: () =>
         SAVE.data.b.oops ? ['<32>{#p/story}* Asriel正在蓄力“混沌冲击”。'] : ['<32>{#p/basic}* ...'],
      ...
      turnTalk10: (fluff: boolean) =>
         30 <= SAVE.data.n.bully
            ...
            : fluff
               ...
               : ['<20>{*}{#p/asriel3}{#e/asriel/1}...因为，\n你“爱着你的朋友”。'],
      status10: () =>
         SAVE.data.b.oops ? ['<32>{#p/story}* Asriel准备施放“末日风暴”。'] : ['<32>{#p/basic}* 呃啊...'],
      ...
      act_check2: () =>
         SAVE.flag.b.pacifist_marker_save1 && SAVE.flag.b.pacifist_marker_save2 && SAVE.flag.b.pacifist_marker_save3
            ...
            : SAVE.data.b.oops
               ? [
                  '<33>{#p/story}* ASRIEL DREEMURR 攻击{^2}\u221e{^1} DEF{^2}\u221e{^1}\n* 乃是主宰死亡的绝对神祇。'
               ]
               : ["<32>{#p/story}* ASRIEL DREEMURR 攻击{^2}\u221e{^1} 防御{^2}\u221e{^1}\n* 不要放弃。"],
      mercy_save1: () => [
   ...
   b_opponent_lostsoul_a: {
      status1: () =>
         SAVE.data.b.oops ? ['<32>{#p/story}* 迷失的灵魂出现了。'] : ['<32>{#p/basic}* 是Alphys和Undyne。'],
      status2: () =>
         SAVE.data.b.oops
   ...
   b_opponent_final: {
      ...
      friend14: ['<20>{|}{#p/alphys}{#e/alphys/6}Undyne，你怎么-{%}'],
...
'<20>{#p/mettaton}{#e/mettaton/1}{#e/asgore/6}{#e/papyrus/20}刚才，我俩还寻思\n第一天在一起，\n咋享受呢。'
      ...
      friend45: ['<20>{#p/sans}{#e/alphys/7}嘿。asgore，\n你好呀。'],
      friend46: ['<20>{#p/asgore}{#e/asgore/6}{#e/papyrus/20}哈喽，Sans。\n你也来了，真好。'],
      friend47: [
      ...
      friend64: ['<20>{#p/toriel}{#e/toriel/9}{#e/asgore/12}是Twinkly。'],
      friend65: [
         '<20>{#p/undyne}{#e/alphys/15}Twinkly？',
         "<20>{#p/undyne}{#e/alphys/28}{#e/undyne/37}{#e/toriel/3}Twinkly是谁？"
      ],
      friend66: () =>
         SAVE.flag.n.genocide_milestone < 7
            ? [
