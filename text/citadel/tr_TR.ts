...
export default {
   a_citadel: {
      youvedoneitnow: [
         [
            '<32>{#p/human}* (İçinde büyüyen bir karanlığı hissediyorsun.)',
            '<32>{#p/human}* (Hepsinin sadece kötü bir rüyadan \nibaret olmasını diliyorsun.)'
         ],
         [
            '<32>{#p/human}* (Bununla savaşmak için elinden geleni \nyapıyorsun, ama hiçbir şey olmuyor.)',
            '<32>{#p/human}* (You wish desperately that you could break free.)'
         ],
         [
            '<32>{#p/human}* (Yardım çağırıyorsun, ama kimse gelmiyor.)',
            '<32>{#p/human}* (You wish you could make this all just go away.)'
         ],
         ['<32>{#p/human}* (...)', '<32>{#p/human}* (Derin bir nefes alıyorsun, ve kendini son için hazırlıyorsun.)'],
