   ...
   a_citadel: {
      ...
      hypertext: {
         ...
         cyan1: [
            ...
            '<99>{*}{@fill=#faff29}Con {@mystify=PACIENCIA}PACIENCIA{@mystify=}, podrá escapar.',
            '<99>{*}{#p/human}{#v/1}{@fill=#42fcff}Deberás conseguir mi Pequeño Cazo...',
            '<99>{*}{#p/human}(Pulsa [Z] para teletransportarte.)'
         ],
         cyan2: [
            '<99>{*}{#p/human}{#v/1}{@fill=#42fcff}La entidad está al acecho.',
            '<99>{*}{@fill=#42fcff}Con PACIENCIA, podrás sobrevivirla...'
         ],
         orange1: [
            '<99>{*}{#p/human}{#v/6}{@fill=#faff29}Una ALMA perdida te está llamando.',
            '<99>{*}{@fill=#faff29}Con {@mystify=VALENTÍA}VALENTÍA{@mystify=}, podrá escapar.',
            "<99>{*}{#p/human}{#v/2}{@fill=#ff993d}¡No salgas sin mi Guante De Poder!",
            '<99>{*}{#p/human}(Pulsa [Z] para explotar.)'
         ],
         orange2: [
            '<99>{*}{#p/human}{#v/2}{@fill=#ff993d}La entidad se eleva sobre nosotros...',
            '<99>{*}{@fill=#ff993d}¡Con VALENTÍA, podrás superarla!'
         ],
         blue1: [
            '<99>{*}{#p/human}{#v/6}{@fill=#faff29}Una ALMA perdida te está llamando.',
            '<99>{*}{@fill=#faff29}Con {@mystify=INTEGRIDAD}INTEGRIDAD{@mystify=}, podrán escapar.',
            "<99>{*}{#p/human}{#v/3}{@fill=#003cff}Necesitaré mis confiables Aerobotas."
         ],
         blue2: [
            '<99>{*}{#p/human}{#v/3}{@fill=#003cff}La entidad mantiene su posición.',
            '<99>{*}{@fill=#003cff}Con INTEGRIDAD, puedes sobrepasarla.'
         ],
         purple1: [
            '<99>{*}{#p/human}{#v/6}{@fill=#faff29}Una ALMA perdida te está llamando.',
         ...
         purple2: [
            ...
            '<99>{*}{@fill=#d535d9}¡Con PERSEVERANCIA, puedes sobrevivirla!'
         ],
         green1: [
            '<99>{*}{#p/human}{#v/6}{@fill=#faff29}Una ALMA perdida te está llamando.',
            '<99>{*}{@fill=#faff29}Con {@mystify=AMABILIDAD}AMABILIDAD{@mystify=}, puede escapar.',
            '<99>{*}{#p/human}{#v/5}{@fill=#00c000}¡El Tabláfono me hará libre!'
         ],
         green2: [
            '<99>{*}{#p/human}{#v/5}{@fill=#00c000}La entidad se está desestabilizando...',
            '<99>{*}{@fill=#00c000}Con AMABILIDAD, puedes eclipsarla...'
         ],
         yellow: [
            '<99>{*}{#p/human}{#v/6}{@fill=#faff29}Las ALMAS perdidas te han llamado.',
            '<99>{*}{@fill=#faff29}Con JUSTICIA, has respondido.',
            '<99>{*}{@fill=#faff29}Las has liberado de sus prisiones.',
            '<99>{*}{#p/human}{#v/1}{@fill=#42fcff}Al fin.',
            "<99>{*}{#p/human}{#v/2}{@fill=#ff993d}¡Eres un héroe!",
            "<99>{*}{#p/human}{#v/3}{@fill=#003cff}Has hecho lo correcto.",
            '<99>{*}{#p/human}{#v/4}{@fill=#d535d9}Gracias...',
            "<99>{*}{#p/human}{#v/5}{@fill=#00c000}¡Eres el mejor...!",
            '<99>{*}{#p/human}{#v/6}{@fill=#faff29}Nuestro poder es tuyo ahora.',
            '<99>{*}{@fill=#faff29}Con él, la entidad colapsará.',
            '<99>{*}{@fill=#faff29}Luego...',
            '<99>{*}{@fill=#faff29}... harás lo que debes.',
            '<99>{*}{@fill=#faff29}¡Ahora, acaba con esto!',
            '<99>{*}{#p/human}(Pulsa [Z] para disparar.)'
         ],
         boot: 'REINICIANDO...',
         init: 'LISTO',
         warn: 'ADVERTENCIA...',
         file1saved: 'ARCHIVO 1 GUARDADO',
         file1loaded: 'ARCHIVO 1 CARGADO',
         file2saved: 'ARCHIVO 2 GUARDADO',
         file2loaded: 'ARCHIVO 2 CARGADO',
         file3saved: 'ARCHIVO 3 GUARDADO',
         file3loaded: 'ARCHIVO 3 CARGADO',
         file4saved: 'ARCHIVO 4 GUARDADO',
         file4loaded: 'ARCHIVO 4 CARGADO',
         file5saved: 'ARCHIVO 5 GUARDADO',
         file5loaded: 'ARCHIVO 5 CARGADO',
         file6saved: 'ARCHIVO 6 GUARDADO',
         file6loaded: 'ARCHIVO 6 CARGADO'
      },
