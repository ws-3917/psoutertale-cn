...
export default {
   a_citadel: {
      youvedoneitnow: [
         ...
         [
            '<18>{#p/human}＊(たすけをよんだ　しかし　だれもこなかった)',
      ...
      hypertext: {
         ...
         init: 'かんりょう',
         warn: 'けいこく…',
         file1saved: 'FILE1をセーブしました',
         file1loaded: 'FILE1をロードしました',
         file2saved: 'FILE2をセーブしました',
         file2loaded: 'FILE2をロードしました',
         file3saved: 'FILE3をセーブしました',
         file3loaded: 'FILE3をロードしました',
         file4saved: 'FILE4をセーブしました',
         file4loaded: 'FILE4をロードしました',
         file5saved: 'FILE5をセーブしました',
         file5loaded: 'FILE5をロードしました',
         file6saved: 'FILE6をセーブしました',
         file6loaded: 'FILE6をロードしました'
      },
   ...
   b_opponent_alphys: {
      ...
      status1a: ['<17>{#p/asriel2}＊アルフィーか…'],
      status1r: () =>
         [
            ['<32>{#p/asriel2}* If you need my help, just ask.'],
            ["<32>{#p/asriel2}* I'll be here if you need my help."],
            ['<17>{#p/asriel2}＊やるべきことを　しましょう。']
         ][Math.min(SAVE.flag.n.ga_asrielAlphysHint++, 2)],
      status1b: ["<17>{#p/asriel2}＊にげなかったんですか。\n＊きょうみ　ぶかいな。"],
      status1c: ['<17>{#p/asriel2}＊やるべきことを　ね。'],
      status1d: ["<17>{#p/asriel2}＊へえー　つかれてるんじゃないですか。"],
      status2a: ["<17>{#p/asriel2}＊どうした　アルフィー。\n＊もっと　がんばって　くれませんか。"],
      status2r1: ['<32>{#p/asriel2}* Ugh, here we go...'],
      status2b: ['<32>{#p/asriel2}* Go on, tell us your sob story.'],
      status2c: ["<17>{#p/asriel2}＊マンネリを　やめたというのは　ちょっと　おどろきですね。"],
      status2d: ['<17>{#p/asriel2}＊ぱちぱち　ドクター・ある日。'],
      ...
      turnTalk14: [
         '<13>{#p/alphys}{#e/alphys/21}たえられませんよ　それに…',
         '<13>{#e/alphys/39}ある日　これいじょう　うしろめたさに　おぼれていたら…',
         '<13>{#e/alphys/45}いつか　げんじつを　みなければ　なりませんと　きづきました'
      ],
      turnTalk15: [
   ...
   b_opponent_archive1: {
      name: () => (battler.volatile[0].sparable ? '* Toriel' : '＊546f7269657275'),
   ...
   b_opponent_archive2: {
      name: () => (battler.volatile[0].sparable ? '* Gerson' : '＊476161736f6e'),
   ...
   b_opponent_archive3: {
      name: () => (battler.volatile[0].sparable ? '* Prof. Roman' : '＊526f6f6d616e204b796f756a75'),
   ...
   b_opponent_archive4: {
      name: () => (battler.volatile[0].sparable ? '* Napstablook' : '＊4e6170757375746162757275756b75'),
   ...
   b_opponent_archive5: {
      name: () => (battler.volatile[0].sparable ? '* Asgore' : '＊417a75676f61'),
   ...
   s_save_citadel: {
      c_elevator1: { name: 'シタデル', text: [] },
      c_courtroom: { name: 'さいごのかいろう', text: [] },
      c_road2: { name: 'あんぐう', text: [] },
      c_archive_start: { name: '4b6574737569', text: [] },
      c_archive_path1: { name: '4e696e746169', text: [] },
      c_archive_path2: { name: '5975756b69', text: [] },
      c_archive_path3: { name: '5365696a697473757361', text: [] },
      c_archive_path4: { name: '4b6f6e6b69', text: [] },
      c_archive_path5: { name: '596173617368697361', text: [] },
      c_archive_path6: { name: '5365696769', text: [] },
      c_exit: { name: 'おわり', text: [] }
   }
};
