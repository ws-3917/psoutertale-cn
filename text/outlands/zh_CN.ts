...
export default {
   ...
   b_opponent_whimsun: {
      ...
      act_flirt: [
         ...
         '<32>{#p/basic}* Flutterlyte无法接受你的赞美，\n  泪流满面地飞走了...'
      ],
      act_terrorize: [
         '<32>{#p/human}* （你呲牙咧嘴，\n  发出一阵鬼哭狼嚎。）',
   ...
   b_opponent_loox: {
      ...
      spareStatus: ["<32>{#p/story}* Oculoux完全不想战斗了。"],
   ...
   b_opponent_napstablook: {
      ...
      status6: ['<32>{#p/story}* Napstablook正在伺机而动。'],
   ...
   b_opponent_toriel: {
      ...
      status2: ['<32>{#p/story}* Toriel准备着魔法攻击。'],
      status3: ['<32>{#p/story}* Toriel板着脸，\n  冷冷地看着你。'],
