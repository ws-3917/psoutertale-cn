      ...
      : SAVE.data.n.plot < 51
         ? world.bad_lizard > 1 || SAVE.data.n.state_foundry_undyne === 2
            ...
            : [
               ...
               '<13>{#f/1}＊だけど　そのはなしを　きいたとき　しょうじきおどろいたわ。',
         ...
         : SAVE.data.n.plot < 56
            ? [
               '<13>{#p/toriel}{#f/1}＊…\n＊エアリアルの　ロイヤル・ガード　たちね…',
               '<13>{#f/0}＊みたところ　かれらの　すきそうな　たべものは…　サーモンのようね。',
            ...
            : SAVE.data.n.plot < 59
               ...
               : SAVE.data.n.plot < 60
                  ? [
                     ...
                     '<13>{#f/0}＊…\n＊そんなに　おおくの　しつもんをして　ごめんなさい。',
                     '<13>{#f/1}＊わたしのような　パズルオタクから　すれば　そういうことに　くちだしせざるを　えないわ。'
                  ]
                  : SAVE.data.n.plot < 61
                     ? [
                        '<13>{#p/toriel}{#f/1}＊メタトンとの　わるふざけの　はなしを　きいて…',
                        '<12>{#f/0}＊おもったの。',
                        '<13>{#f/1}＊もし　AIきんしれいが　でたとしたら　メタトンみたいな　ロボットは　そんざいできるのかしら？',
                        '<13>{#f/5}＊たしかに　ドクター・　アルフィーは　そんなほうりつを　やぶることは　ないでしょうね。',
                        '<13>{#f/0}＊いえ…\n＊なにか　べつの　ほうほうが　あるはずよ。'
                     ]
                     : SAVE.data.n.plot < 63
                        ? [
                           ...
                           '<13>{#f/0}＊べつに　かれらに　いいぶきを　ゲットしてほしい　わけじゃないわ。',
                        ...
                        : SAVE.data.n.plot < 65
                           ? SAVE.data.b.a_state_hapstablook
                              ? [
                                 ...
                                 '<13>{#f/5}＊しばらく　まえから　けいかくして　いたみたいね。',
                                 '<13>{#f/0}＊すぐに　もんだいも　かたづくそうで　なによりだわ。',
                              ...
                              : [
                                 '<25>{#p/toriel}{#f/1}* A ghost, Lurksalot, recently spoke of some family business.',
                                 '<13>{#f/5}＊しばらく　まえから　けいかくして　いたみたいね。',
                                 '<13>{#f/1}＊いとこのコが　あなたに　たすけをもとめた　みたいだけど…',
                                 '<13>{#f/5}＊そのとき　あなたは　ムリだって。',
                                 '<13>{#f/1}＊…ちゃんと　したりゆうが　あったのよね？'
                              ]
                           : SAVE.data.n.plot < 66
                              ? [
                                 '<13>{#p/toriel}{#f/1}＊ロボットの　うたごえが　あんなに　きれいだなんて　しらなかったわ。',
                                 "<13>{#f/0}＊メタトンの　レコーディングに　おじゃまさせて　もらったとき　みみを　うたがったもの。",
                                 '<13>{#f/1}＊まあ　うたのかしは　いちぶ　きけん…というか　ぼうりょくてきというか…',
                                 '<13>{#f/5}＊…',
                                 '<13>{#f/0}＊あんしん　してね。\n＊だれも　あなたを　うちゅうくうかんに　ほうりだしたり　しないわ。'
                              ]
                              : SAVE.data.n.plot < 68
                                 ? [
                                    '<25>{#p/toriel}{#f/0}* Sans tells me the \"rec center\" is a favored location of his.',
                                    '<13>{#p/toriel}{#f/1}＊びじゅつきょうしつや　おんがくクラブ　としょかんまで…',
                                    '<13>{#p/toriel}{#f/5}＊でも　ちいさな　こどもには　あぶない　ちいきなのが　ざんねんな　ところね。',
                                 ...
                                 : SAVE.data.n.plot < 70
                                    ? world.bad_robot
                                       ? [
                                          '<13>{#p/toriel}{#f/0}＊「グランドフィナーレ」が　ちゅうしに　なったから　みんな　おこってるみたいよ。',
                                          '<13>{#p/toriel}{#f/0}＊ものすごい　たたかいに　なっていただろうに　って。',
                                          '<13>{#p/toriel}{#f/1}＊でもあなたが　そんなバトルを　せずにすんで　ほんとうによかった。',
                                          '<13>{#p/toriel}{#f/5}＊そんなたたかい…　なにがでてくるのか　しんぱいで　たまらないから。'
                                       ]
                                       : SAVE.data.b.killed_mettaton
                                          ...
                                          : [
                                             '<13>{#p/toriel}{#f/0}＊みんな　「グランドフィナーレ」の　ことについて　はなしていたわ。',
                                             '<13>{#p/toriel}{#f/0}＊あなたと　メタトンの　ことをみてて　とてもねっちゅう　できたって。',
...
export default {
   a_outlands: {
      darktorielcall: [
         ...
         '<13>{#p/toriel}{#f/9}＊とりあえず　わたしを　ここにおいて　いってください。',
         '<13>{#p/toriel}{#f/10}＊すぐに　あなたたちの　ところへ　もどりますから。'
      ],
      secret1: () => [
      ...
      finaltext: {
         ...
         d8: [
            '<18>{#p/basic}＊ハハ…　どの口が言ってるんだ？\n＊「愛してくれる人のもとへ　行きなさい。」　としか言わないじゃないか。',
         ...
         d11: [
            '<17>{#p/basic}＊…それは重要か？',
            '<17>＊つい先程のように　私のことを　忘れていたのは　正しかった。',
            "<17>＊私は悪人であったから。",
            "<17>＊私は　お前の望んだ　友達でも　兄弟でもなかったから。"
         ],
         d12: ['<13>{#p/asriel1}{#f/13}＊$(name)　ボクは…'],
         d13: ["<17>{#p/basic}＊すまない。　アズリエル。", "<32>* You don't have to make it out to be better than it is."],
         ...
         d19: [
            ...
            '<17>＊私はニンゲンを殺すために　力を使おうとした。　しかし　お前は私を止めただろう？'
         ],
         ...
         d26: [
            ...
            '<13>{#f/22}＊キミが　あのとき　どんなに　こころをいためたか…',
         ...
         d29: [
            ...
            "<17>＊私は百年間　恨み続けた。",
            '<17>＊その間　私はなぜ存在していたのか…　ずっと疑問だった。',
            '<17>＊今ついに　答えが分かった。'
         ],
         d30: ['<13>{#p/asriel1}{#f/15}＊…？'],
         d31: ["<17>{#p/basic}＊お前だよ…　アズリエル。", "<17>＊お前こそが　私が存在していた　理由だった。"],
         d32: [
            '<17>{#p/basic}＊果たせなかった約束…　のようなものだ。',
            '<17>＊恨みを抱きながらも…　お前のことを考えていた。',
            "<17>＊もっと良くして　やれたのではないかと。",
            "<17>＊これが　いつも私を阻んでいたもの。"
         ],
         ...
         d40: ["<17>{#p/basic}＊私がついているよ。"],
         d41: [
            '<17>{#p/basic}＊…ようやく感じられた。',
            '<17>＊100年間経った今でも…',
            "<17>＊アズリエルは　そこに居続けてくれた。　そうだろう？",
            '<17>＊天使のように。',
            '<17>＊私を見守り　間違った決断を　止めてくれた。',
            '<17>＊いつか　恩返しできるように…'
         ],
         d42: ["<17>{#p/basic}＊今こそ　全てが意味を成し始める。", '<17>＊やるべきことは　分かっている。'],
         d43: ['<13>{*}{#p/asriel1}{#f/25}＊…？\n＊キミはなにを…{^60}{%}'],
         d44: ['<13>{*}{#f/25}＊まって…！{^60}{%}', '<13>{*}{#f/26}＊…ボクもいかせて！{^60}{%}'],
         d45: ['<13>{*}{#p/basic}＊ああ…{^60}{%}', '<17>{*}＊…私の代わりに　パパとママを　大事にするんだぞ？{^60}{%}'],
         d46: ['<13>{#p/asriel1}{#f/25}＊フリスク　そこにいるの？', '<13>{#f/22}＊おねがい…　めをさまして…'],
         d47: ["<13>{#p/asriel1}{#f/23}＊キミまで…\n＊キミまで　うしないたくない…"],
         d48: ['<13>{#p/asriel1}{#f/17}＊…よかった。'],
         d49: [
            "<13>{#p/asriel1}{#f/23}＊ハハ…　キミを１ぷんかん　みていなかった　だけだったね。",
            "<13>{#f/22}＊もう　びっくりさせないでよ？",
            '<13>{#f/13}＊…'
         ],
         d50: [
            ...
            '<13>{#f/15}＊$(name)が　のぞんでいたように　いきる。'
         ],
         d51: [
            '<13>{#p/asriel1}{#f/23}＊…フリスク。',
            "<13>{#f/23}＊いまから　キミについていく　ことにするよ。",
            "<13>{#f/17}＊どこへ行こうとも…　あとにつづくね。",
            '<13>{#f/13}＊キミのことはしんらいできる　きがするんだ。',
            "<13>{#f/13}＊おたがいのことを　あまりしらないとしてもね。",
            "<13>{#f/15}＊すくなくとも　ボクは分からないかな…",
            '<13>{#f/15}＊…',
            '<13>{#f/13}＊フリスク…知ってた？',
            "<13>{#f/13}＊キミとキミの　ともだちのことを　きずつけたとき…",
            "<13>{#f/22}＊いまきづいたところ　なんだけど…",
            '<13>{#f/21}＊こころのなかで　いくどとなく　しんでいくのを　そうぞうしていると…',
            "<13>{#f/22}＊ボクが　やったって　じぶんでも　わかるんだ。",
            '<13>{#f/15}＊…',
         ...
         e2: [
            "<13>{#p/asriel1}{#f/13}＊いまだに　あんなに　ながいじかん　まっていたなんて　しんじられないよ…",
            '<13>{#f/23}＊あたまのかたい　バカだ。',
            '<13>{#f/17}＊ほしの　ままだったら　そういってただろうね。',
            "<13>{#f/13}＊でも…　ほんとうに　バカだったとは　おもえない。"
         ],
         e3: [
            "<13>{#p/asriel1}{#f/13}＊$(name)は　バカじゃない。",
            '<13>{#f/13}＊$(name)の　いっていたこと　ほとんどは　ほんとうだと　おもってる。',
            '<13>{#f/15}＊ボクの　のぞむともだちでは　なかったってことも。',
            "<13>{#f/7}＊でも　ボクをおいていって　ほしいなんて　いってない！"
         ],
         e4: [
            "<13>{#p/asriel1}{#f/13}＊$(name)が　いなくなる　ひつようがある　みたいじゃないか。",
            "<13>{#f/17}＊ボクらと　いっしょにいる　こともできたはず。\n＊そうして　ほしかった。",
            "<13>{#f/15}＊だけど　いなくなって　しまいたい　っていうきもち　もわかるんだ。",
            '<13>{#f/16}＊ゲームに　「しょうり」した。\n＊それなら　ボクと　「プレイ」なんて　したくないはず。'
         ],
         e5: [
            "<13>{#p/asriel1}{#f/13}＊…$(name)…\n＊もしまだいるなら　きいて。",
            '<13>{#f/15}＊キミのこと　だいすきだよ。',
            '<13>{#f/23}＊おせじにも　いいやつとは　いえないかも　しれないけど…',
            '<13>{#f/22}＊だけど　よくかんがえたら　キミはボクのことを　きづかってくれてた。'
         ],
         e6: [
            '<13>{#p/asriel1}{#f/23}＊ハハ…',
            '<13>{#f/22}＊いまボク　ヘンなこと　いってるよね。',
            '<13>{#f/15}＊もう　わすれるべきなのに　しゅうちゃくしてる　みたいだね…',
            '<13>{#f/17}＊$(name)とボクは　りょうほうとも　ただの　「あたまのかたいバカ」　だったよ。'
         ],
         e7: [
            '<13>{#p/asriel1}{#f/13}＊あるとき　$(name)とボクは　ベッドで　けんかしてたんだ。',
            "<13>{#f/10}＊じぶんの　となりにしようと　スタンドライトを　とりあってたんだ。",
            '<13>{#f/15}＊そこで　あいだをあけようと　おたがいに　からだをおしあったんだ。',
            '<13>{#f/4}＊けんかで　とっても　つかれたから　ねてしまったんだ。',
            '<13>{#f/13}＊でも　おきたら…',
         ...
         e9: [
            ...
            '<13>{#f/20}＊いっしょにいたい　ってこと　いがいはね。',
            '<13>{#f/17}＊ちがうところがあっても　$(name)とボクは　きりはなせなかった。',
            "<13>{#f/13}＊しぬことでさえも　えいえんに　わかつことが　できなかったし…"
         ],
         e10: [
            "<13>{#p/asriel1}{#f/17}＊…まだ　$(name)は　ちかくにいる　のかな？　フリスク。",
         ...
         e11: [
            ...
            "<13>{#f/17}＊かつてしっていただれかの　ことをおもいださずには　いられないんだ。"
         ],
         e12: () => [
            '<13>{#p/asriel1}{#f/17}＊フリスク。\n＊これだけ　いわせて。',
            '<13>{#f/13}＊ほんとうにありがとう…',
            '<13>{#f/23}＊また　みらいがみえた　ような　きが　するんだ。',
            '<13>{#f/22}＊…',
