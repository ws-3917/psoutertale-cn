...
export default {
   a_foundry: {
      ...
      napcomputer3: {
         a: () => [
            ...
            '喵喵航天行 - 主题曲.kwac',
            !world.genocide && SAVE.data.n.state_starton_papyrus === 1 ? 'papyrus求包养.kwac' : '滑腔动调.kwac',
            '群星之歌.kwac'
         ],
         b: () => [
            '酷炫骷髅95',
                           ...
                           : SAVE.data.n.state_foundry_undyne === 2
                              ...
                              : 2 <= SAVE.data.n.plot_date
                                 ...
                                 : SAVE.data.n.plot > 47.2 && SAVE.data.n.plot_date > 1
                                    ? world.trueKills > 0
                                       ? ['<32>{#p/basic}{#npc/a}* Papyrus在附近等着呢。', "<32>* Isn't he brave?"]
                                       : ['<32>{#p/basic}{#npc/a}* Papyrus在附近等着呢。', "<32>* 想见见我的新邻居去吗？"]
                                    : [
            ...
            SAVE.data.n.plot === 72
               ...
               : world.genocide
                  ? [
                     ...
                     '<33>{#p/undyne}* 该死...',
                     '<33>{#p/undyne}* Papyrus，我真不该让你遭这种罪。',
      ...
      secretcallB: [
         '<32>{#s/phone}{#p/event}* 铃铃，铃铃...',
         "<18>{#p/papyrus}{#f/0}嘘，还是我，PAPYRUS。",
         '<18>{#f/5}哇哦... 这会肯定不早了。',
         '<18>{#f/6}你还好吗？\n有没有人... 死了？',
         '<18>{#f/5}每天我都得琢磨琢磨\n这俩问题。',
         "<18>{#f/4}虽说我也没躲在这多久。",
      ...
      spookydate8: ["<32>{#p/basic}* 我听说你用烈焰grillby\n  把酒吧给点燃了，\n  是这样吗？"],
      spookydate9: [
         '<25>{#p/sans}{#f/3}* 嗯？\n* 不，那东西完全无害。',
         '<25>{#f/2}* 能让这酒吧燃起来的\n  只有我的招牌幽默笑话。'
      ],
      ...
      spookydate12a: ["<25>{#p/sans}* grillby，给我们来两份\n  烈焰你自己。"],
      spookydate12b: ["<25>{#p/sans}* grillby，给我们来两份\n  小汉堡。"],
      spookydate13: () => [
      ...
      temmiepat2a: ['<32>{#p/human}* （你摸了摸temmie。）', '<32>{#p/tem}{#npc/a}* 呜哇哦哇哦哇哦.....'],
      temmiepat2b: ['<32>{#p/tem}{#npc/a}* ...', '<32>{#p/tem}{#npc/a}* 滚开。'],
      temmiepat3a: ['<32>{#p/human}* （你继续摸temmie。）', '<32>{#p/tem}{#npc/a}* 呜哇哦哇哦哇哦.....'],
            ...
            : [
               ...
               ...(SAVE.data.n.state_foundry_undyne > 0
                  ...
                  : [
                     '<18>{#f/4}你准备好接受这个...',
                     '<18>{#f/1}和皇家卫队队长\n做朋友的艰巨的\n任务了吗！？！？',
                     choicer.create('* （和Undyne做朋友吗？）', '是', '否')
                  ])
            ],
      unddate0x: () =>
         world.trueKills > 0 || SAVE.data.n.state_foundry_undyne > 0
            ? [
               "<18>{#p/papyrus}{#f/0}UNDYNE现在不在这。",
      ...
      unddate5: ['<18>{#p/papyrus}给，UNDYNE。', '<18>我的朋友想\n送给你这个！'],
      unddate5x: [
      ...
      unddate60: ["<25>{#p/undyne}{#f/14}* 啊，难怪Papyrus\n  厨艺再也没有进步了。"],
   ...
   b_group_foundry: {
      ...
      woshuaMoldbygg2b: () =>
         world.goatbro
            ...
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? ['<32>{#p/kidding}* 只剩我们了！']
               : ['<32>{#p/story}* Skrubbington不知道该怎么办。']
   },
   b_opponent_woshua: {
      tweet: '啾啾',
      epiphany: [
         ...
         () =>
            world.meanie
               ...
               : SAVE.data.b.oops && world.flirt > 9
                  ? ['<08>{#p/basic}{~}清洗你的身体..', '<08>{#p/basic}{~}Special service just for you!']
                  : SAVE.data.b.oops
                     ? [
      ...
      act_check: () =>
         world.goatbro
            ...
            : [
               '<32>{#p/story}* SKRUBBINGTON - 攻击 18 防御 5\n* 这个卑微的细菌恐惧症患者\n  想要清理整个星系。'
            ],
      act_check2: [
         '<33>{#p/story}* SKRUBBINGTON - 攻击 18 防御 5\n* 这个卑微的细菌恐惧症患者\n  想要回家清洗伤口。'
      ],
      act_check3: [
      ...
      randStatus1: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ? ['<32>{#p/kidding}* 看那只小鸟！']
            : ['<32>{#p/story}* Skrubbington和一只小鸟交了朋友。'],
      randStatus2: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
      ...
      randStatus3: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ...
            : ['<32>{#p/story}* Skrubbington想洗点好玩的东西。'],
      randStatus4: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
      ...
      randStatus5: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ...
            : ['<32>{#p/story}* Skrubbington好奇星尘干不干净。'],
      hurtStatus: () =>
         world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
            ? ['<32>{#p/kidding}* 一切... 还好吗？']
      ...
      touchText1: [
         '<32>{#p/human}* （你友好地摸了摸Skrubbington。）',
         '<32>{#p/basic}* Skrubbington后退，躲开了你的手。'
      ],
      touchText2: [
         '<32>{#p/human}* （你友好地摸了摸Skrubbington。）',
         '<32>{#p/basic}* Skrubbington受宠若惊。'
      ],
      cleanText1: [
         '<32>{#p/human}* （你问Skrubbington能不能把你清洗一下。）',
         '<32>{#p/basic}* Skrubbington高兴地跳来跳去。'
      ],
      flirtTalk1: ['<08>{#p/basic}{~}No!\nUnclean romance!'],
      flirtTalk2: ['<08>{#p/basic}{~}Sparkle and shine!'],
      cleanText2: [
         '<32>{#p/human}* （你问Skrubbington能不能把你清洗一下。）',
         '<32>{#p/basic}* Skrubbington继续清洗。'
      ]
   },
   b_opponent_moldbygg: {
      sexyChat: ['<08>{#p/basic}{~}\x00*性感扭动*'],
      epiphany: [
         ['<08>{#p/basic}{~}\x00*黏液的声音*'],
         () =>
            world.meanie
               ? ['<08>{#p/basic}{~}Guoooh..']
               : SAVE.data.b.oops && world.flirt > 9
      ...
      status1: () =>
         world.goatbro
            ...
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? ['<32>{#p/kidding}* 哇！']
               : ['<32>{#p/story}* Gelata出现了！'],
      act_check: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Gelata，恶心粘球。\n* 为啥我要多费口舌给你解释这些？']
            : ['<32>{#p/story}* GELATA - 攻击 18 防御 18\n* 它已经从“小团子”进化成功。'],
      ...
      randStatus1: () =>
         world.goatbro
            ...
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ...
               : ['<32>{#p/story}* Gelata想背着你。'],
      randStatus2: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Gelata。']
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? ['<32>{#p/kidding}* 我好奇我要是抱抱它\n  会发生什么。']
               : ['<32>{#p/story}* Gelata焦虑地摇晃着。'],
      randStatus3: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Gelata。']
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
               ? ['<32>{#p/kidding}* 黏糊糊的... 但我喜欢！']
               : ['<32>{#p/story}* Gelata磨动着地面。'],
      randStatus4: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* Gelata。']
            : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
   ...
   b_opponent_moldfake: {
      ...
      act_slap: ['<32>{#p/human}* （你使劲扇了Gelatini一巴掌。）', '<32>{#p/basic}* ...突然！']
   },
   b_opponent_shyren: {
   ...
   b_opponent_doge: {
      ...
      act_flirt: () => [
         ...(dogecon() || world.goatbro
            ...
            : battler.volatile[0].vars.pet
               ? ['<32>{#p/human}* （你向Doge调情。）', '<32>{#p/basic}* Doge回以微笑。']
               : battler.volatile[0].sparable
                  ? [
                     '<32>{#p/human}* （你向Doge调情。）',
                     '<32>{#p/basic}* Doge非常沮丧，不想听你说三道四。'
                  ]
                  : world.flirt < 10
                     ? ['<32>{#p/human}* （你向Doge调情。）', "<32>{#p/basic}* Doge并没有什么\n  强烈的反应。"]
                     : ['<32>{#p/human}* （你向Doge调情。）', '<32>{#p/basic}* Doge is giving it her all to resist you.'])
      ],
      act_flirt2: [
         '<32>{#p/human}* （你再次对Doge调情。）',
      ...
      batheTextEarly: ["<32>{#p/human}* （你建议Doge去洗个澡，\n  但她现在并不怎么想去。）"],
      batheTextGeno: [
         '<32>{#p/human}* （你建议Doge去洗个澡。）',
         '<32>{#p/basic}* 但她根本不在乎自己脏不脏。'
      ],
      batheTextLate: ['<32>{#p/human}* （你建议Doge去洗个澡，\n  但为时已晚。）'],
      batheTextPost: ['<32>{#p/human}* （但是Doge已经清洗干净了。）'],
      ...
      flirtStatus: ['<32>{#p/story}* Doge正猜疑你进攻背后\n  所隐藏的真正意图。'],
      flirtStatusAccept: ['<32>{#p/story}* Doge的脸微微泛红。'],
      flirtStatusReject: ['<32>{#p/story}* Doge无奈地叹了口气。'],
      hurtStatus: () =>
         world.goatbro
            ? ['<32>{#p/asriel2}* 离死不远了。']
            : ["<32>{#p/story}* Doge拼命装出一副没事的样子。"],
      name: '* Doge',
      ...
      petTextEarly: ["<32>{#p/human}* （你试着抚摸Doge，\n  但你现在还够不到她。）"],
      petTextGeno: [
         '<32>{#p/human}* （你想摸摸Doge。）',
         '<32>{#p/basic}* 她对这份亲昵漠然置之。'
      ],
      petTextLate: ['<32>{#p/human}* （你试着抚摸Doge，\n  但为时已晚。）'],
      petTextPost1: [
         '<32>{#p/human}* （你再一次试着抚摸Doge。）',
         "<32>{#p/basic}* Doge沉浸在你的爱抚之中，\n  仿佛她多年来第一次受到关爱..."
      ],
      petTextPost2: ['<32>{#p/human}* （你还想再试着抚摸Doge。）', '<32>{#p/basic}* Doge已经要爽上天了。'],
      petTextPost3: ['<32>{#p/human}* （你继续抚摸着Doge。）', '<32>{#p/basic}* 这么摸下去不会违法吗？'],
      petTextPost4: ['<32>{#p/human}* （你又抚摸了Doge好一会。）', '<32>{#p/basic}* Doge直接躺在了地上。'],
      petTextPost5: ['<32>{#p/human}* （你揉了揉Doge的肚皮。）', '<32>{#p/basic}* Doge开始流口水了...'],
      petTextPost6: ['<32>{#p/human}* （你抚摸着Doge。）', '<32>{#p/basic}* 她还在继续流着口水。'],
      petTextPost7: ['<32>{#p/human}* （你抚摸着Doge。）', '<32>{#p/basic}* ...'],
      petTextSus: ['<32>{#p/human}* （但是Doge过于烦躁，\n  不想被摸。）'],
      status1: () => (world.goatbro ? ['<32>{#p/asriel2}* Doge。'] : ['<32>{#p/story}* Doge昂首阔步向你走来。']),
      turnStatus1: ['<32>{#p/story}* Doge审视着你的站姿，\n  认为你不够端正。'],
      turnStatus2: () =>
         dogecon() ? ['<32>{#p/story}* Doge摆弄着她的长矛。'] : ['<32>{#p/story}* Doge需要好好冲洗一番。'],
      turnStatus3: () =>
         dogecon()
            ? ['<32>{#p/story}* Doge一再检查她的站姿。']
            : battler.volatile[0].vars.bathe
               ? ['<32>{#p/story}* Doge浑身湿漉漉的。']
               : ["<32>{#p/story}* Doge的卫生习惯毫无改变，\n  这让她感到非常沮丧。"],
      turnStatus4: () =>
         dogex()
            ? ['<32>{#p/story}* Doge想起了她的职责。']
            : world.dead_canine
               ? ['<32>{#p/story}* Doge想起了她的同事们。']
               : battler.volatile[0].vars.bathe
                  ? ['<32>{#p/story}* Doge想要活动一下筋骨。']
                  : ['<32>{#p/story}* Doge思考着她的职责所在。'],
      turnStatus5: () =>
         dogex()
            ? ['<32>{#p/story}* Doge想起了她的荣誉。']
            : world.dead_canine
      ...
      turnStatus6: () =>
         dogecon()
            ...
            : battler.volatile[0].vars.walk
               ? ['<32>{#p/story}* Doge深吸一口气。']
               : ['<32>{#p/story}* Doge冒出了一身冷汗。'],
      turnStatus7: () =>
         battler.volatile[0].vars.walk
            ? ['<32>{#p/story}* Doge渴望着关爱。']
            : ['<32>{#p/story}* Doge深吸一口气。'],
      turnStatus8: () =>
         dogecon()
            ...
            : battler.volatile[0].vars.walk
               ? ['<32>{#p/story}* Doge需要帮助。']
               : ["<32>{#p/story}* Doge的呼吸变得急促。"],
      turnStatus9: () =>
         dogecon()
            ? ['<32>{#p/story}* Doge依旧保持着专注。']
            : battler.volatile[0].vars.walk
               ? ['<32>{#p/story}* Doge只想被抚摸。']
               : ['<32>{#p/story}* Doge气喘吁吁。'],
      turnStatus10: () =>
         dogecon()
            ? ['<32>{#p/story}* Doge依旧保持着专注。']
      ...
      walkTextPost: ['<32>{#p/human}* （但是Doge早已因为之前的散步\n  而累到虚脱了。）'],
      walkTextSus: ['<32>{#p/human}* （但是Doge太脏了，\n  没法出去散步。）']
   },
   b_opponent_muffet: {
      act_check: ['<32>{#p/story}* MUFFET - 攻击39 防御19\n* 全蜘蛛部落的女王。\n* 特战队志愿兵。'],
      act_flirt: () => [
         ...(badSpider()
      ...
      appeaseTextPost: ["<32>{#p/human}* （但Muffet不需要被呼吁第二遍。）"],
   ...
   b_opponent_undyne: {
      ...
      randStatus4: () =>
         respecc() ? ['<32>{#p/story}* Undyne满怀激情地跳来跳去。'] : ['<32>{#p/story}* Undyne焦躁地跳来跳去。'],
      randStatus5: () =>
         respecc()
      ...
      randStatus6: () =>
         respecc()
            ? ['<33>{#p/story}* Undyne满怀敬慕地看着。']
            : ['<32>{#p/story}* Undyne用手指划过她的脖子。'],
      randStatus7: () =>
         respecc()
            ? ['<32>{#p/story}* Undyne发出了一声战吼。']
            : ['<32>{#p/story}* Undyne握紧拳头举在胸前，\n  然后摇了摇头。'],
      randStatus8: () =>
         respecc()
            ? ['<32>{#p/story}* Undyne凝视着你的灵魂。']
            : ['<32>{#p/story}* Undyne巍然耸立。'],
      randStatus9: () =>
         respecc()
      ...
      endStatus1: ["<32>{#p/story}* Undyne的眼皮不由自主地跳了起来。"],
      endStatus2: ['<32>{#p/story}* Undyne将长矛刺向地面。'],
      endStatus3: ["<32>{#p/story}* Undyne的目光左右飘动，\n  想确认这是不是个恶作剧。"],
      endStatus4: ['<32>{#p/story}* Undyne开始呼吸困难了。'],
      ...
      deterStatus2: ["<32>{#p/story}* Undyne的身体正一点一点融化。"],
      deterStatus3: ["<32>{#p/story}* Undyne的身体已经化得\n  看不出形状了。"],
      deterStatus4: ['<32>{#p/story}* Undyne深吸了一口气。'],
      deterStatus5: ['<32>{#p/story}* Undyne挑衅地屹立着。'],
      challengeText1: ["<32>{#p/human}* （你告诉Undyne她的攻击\n  太弱了。）\n* （她没理你。）"],
      challengeText2: [
      ...
      challengeText7: ["<32>{#p/human}* （你告诉Undyne她的攻击\n  太弱了。）\n* （她没在意。）"],
      pleadText1: ["<32>{#p/human}* （你告诉Undyne你不想再\n  战斗了。）\n* （无事发生。）"],
      pleadText2: [
         '<32>{#p/human}* （你告诉Undyne你只是想\n  交朋友。）',
         '<32>{#p/basic}* 这让她想起了某个人。\n* 她的攻击变得弱了一点。'
      ],
      pleadText3: ["<32>{#p/human}* （你告诉Undyne你只是想\n  交朋友。）\n* （但她并不信任你。）"],
      pleadText4: ["<32>{#p/human}* （你告诉Undyne你不想再\n  战斗了。）\n* （她不禁笑了笑。）"],
      pleadText5: ["<32>{#p/human}* （你告诉Undyne你不想再\n  战斗了。）\n* （看起来她很是困惑。）"],
      pleadText6: ["<32>{#p/human}* （你告诉Undyne你不想再\n  战斗了。）\n* （她没在意。）"],
      pleadText7a: [
         '<32>{#p/human}* （你告诉Undyne你只是想\n  交朋友。）',
      ...
      pleadText8: ["<32>{#p/human}* （你告诉Undyne你不想再\n  战斗了。）\n* 她冷冰冰地瞪了你一眼。"],
...
'<20>...才怪。',
      ...
      neutralFinalStatus: ['<32>{#p/story}* Undyne充满了决心。']
   },
   b_opponent_dateundyne: {
      ...
      status1: ['<32>{#p/story}* Undyne让你先出招。'],
      act_check: ['<32>{#p/story}* UNDYNE - 攻击41 防御21\n* 千真万确的最终决战\n  终于开始了！'],
      ...
      flirtText0: ['<32>{#p/human}* （你向Undyne调情。）'],
