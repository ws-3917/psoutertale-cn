...
export default {
   a_foundry: {
      ...
      spookydate9x: ["<25>{#p/sans}{#f/3}* 哎呀，烤爾比，\n  大傢伙人呢？"],
      spookydate9y: [
         '<32>{#p/basic}{#npc/a}* ...\n* ...\n* ...',
         "<32>* ...烤爾比沒說那些老主顧去哪了，\n  不過你來了他也鬆口氣了。"
      ],
   ...
   b_opponent_woshua: {
      ...
      jokeText2: ['<32>{#p/human}* （你拿大氣汙染打趣刷潔頓。）'],
   ...
   b_opponent_shyren: {
      ...
      act_boo1: ['<32>{#p/human}* （你朝著害羞塞壬喝倒彩。）', '<32>{#p/basic}* 她耷拉著頭，默默走了...'],
      act_boo2: [
         '<32>{#p/human}* （你朝著害羞塞壬喝倒彩。）',
   ...
   b_opponent_radtile: {
      ...
      act_insult: ['<32>{#p/human}* （你大罵老頑鱷廢物，\n  讓他閉上臭嘴。）'],
...
'<20>...才怪。',
   ...
   n_shop_tem: {
      ...
      talk: () => [
         ...
         SAVE.data.n.plot === 72 ? '未來發展' : SAVE.data.b.colleg ? '提米盔甲' : '介紹下自己',
               ...
               : world.genocide || world.killed0 || startonATE()
                  ...
                  : SAVE.data.s.state_foundry_deathroom === 'f_hub' // NO-TRANSLATE
                     ...
                     : [
                        ...
                        [
                           '<32>{#p/basic}{#k/0}* 艾羅戈，是故園最後一段全盛時期的\n  當政國王。',
                           "<32>* 我相信，你一定讀過他的故事。",
