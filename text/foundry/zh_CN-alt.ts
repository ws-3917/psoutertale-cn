   ...
   b_opponent_moldbygg: {
      ...
      act_check: () =>
         world.goatbro
            ...
            : ['<32>{#p/story}* 大黏簇 - 攻击 18 防御 18\n* 它已经从“小团子”进化成功。'],
      act_check2: ['<32>{#p/story}* 大黏簇 - 攻击 18 防御 18\n* 状态并不是很好。'],
      act_check3: ['<32>{#p/story}* 大黏簇 - 攻击 18 防御 18\n* 允许成为全职果冻垫。'],
      act_check4: ['<32>{#p/story}* 大黏簇 - 攻击 18 防御 18\n* 和你的关系并没有想象的那么好...'],
