...
export default {
   a_foundry: {
      locketseller: ['<32>{#p/basic}* ...', "<32>{#p/basic}* Budu předstírat, že jsi ten medailonek jen tak neprodal."],
      noequip: ['<32>{#p/human}* (Rozhodnete se nevybavit.)'],
      darktoriel1: [
         "<32>{#p/human}* (Chytíš Toriel za ruku.)",
         '<25>{#p/toriel}{#f/2}* Ach můj...!\n* F-frisk, jsi to ty?',
         "<25>{#f/1}* Tady je to trochu špatně vidět..."
      ],
      darktoriel2: [
         '<25>{#p/toriel}{#f/9}* Omlouvám se. Musel jsi mě všude hledat.',
         '<25>{#f/9}* Pokud jste se mi pokusili dovolat, měla jsem vypnutý telefon.',
         '<25>{#f/13}* ...',
         '<25>{#f/13}* Omlouvám se za všechno, co jsem udělala, maličká.',
         '<25>{#f/13}* I když mi odpustíš, bylo by těžké to přijmout.',
         '<25>{#f/9}* Teprve se začínám smiřovat se svým chováním v minulosti.',
         '<25>{#f/10}* ...',
         '<25>{#f/10}* Myslím, že jsem ráda, že vás tu vidím.'
      ],
      darktoriel3: [
         '<25>{#p/toriel}{#f/5}* ...co?\n* Chtěl jsi, abych zavolala... Sans?',
         '<25>{#f/1}* Nech mě to zapnout...'
      ],
      darktoriel4a: [
         '<32>{#s/phone}{#p/událost}* Vytáčení...',
         '<25>{#p/toriel}{#f/3}* ... ach jo.\n* Můj telefon zde nefunguje příliš dobře.'
      ],
      darktoriel4b: [
         '<25>{#f/4}* Budu tam muset jít nahoru a promluvit si s ním sama.',
         '<25>{#f/5}* Eh... Udělám to.\n* Ale ne teď.',
         '<25>{#f/5}* ...'
      ],
      darktoriel5a: [
         '<25>{#p/toriel}{#f/5}* ... huh?\n* Chcete mi ještě něco říct?',
         '<32>{#p/human}* (Opakujete radu, kterou vám dal Toriel v Archivu šest.)',
         '<25>{#p/toriel}{#f/2}* ...',
         '<25>{#f/1}* Ta slova...',
      ...
      artifact3: () =>
         SAVE.data.b.svr
            ...
            : [
               '<32>{#p/basic}* There is an inscription inscribed on the pedastal.',
               '<32>* \"Two halves, split by the ivories.\"',
               '<32>* \"If the prince\'s is your left, then whose is your right?',
               '<32>* \"And what is their melody?\"'
            ],
      tome0: () => ['<32>{#p/basic}* The tome is attached firmly to the pedastal.'],
