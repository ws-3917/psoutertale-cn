...
export default {
   a_foundry: {
         ...
         f_clamgirl: pager.create(
            ...
            () =>
               SAVE.data.n.plot === 72
                  ...
                  ? world.trueKills > 0
                     ? [ '<32>{#p/basic}{#npc/a}* Papyrus在附近等著呢。', "<32>* Isn't he brave?" ]
      ...
      spookydate11: [
         ...
         '<25>{#f/2}* 有些怪咖會把放屁墊\n  放在座位上。',
         "<25>{#f/0}* ... 那麼，來點餐吧。\n* 你呲點啥？",
         "<99>{#p/human}* （你要怎麼回答？）{!}\n§shift=64§烈焰\n§shift=64§Grillbys§shift=56§小漢堡{#c/0/8/7}",
   ...
   b_opponent_woshua: {
      ...
      act_check: () =>
         world.goatbro
            ...
            : [
                 '<32>{#p/story}* SKRUBBINGTON - 攻擊 18 防禦 5\n* 這個卑微的細菌恐懼症患者\n  想要清理整個星系。'
              ],
      act_check2: [
         '<33>{#p/story}* SKRUBBINGTON - 攻擊 18 防禦 5\n* 這個卑微的細菌恐懼症患者\n  想要回家清洗傷口。'
      ],
      act_check3: [
      ...
      cleanText1: [
         '<32>{#p/human}* （你問Skrubbington能不能把你清洗一下。）',
   ...
   b_opponent_moldbygg: {
      ...
      act_check: () =>
         world.goatbro
            ...
            : [ '<32>{#p/story}* GELATA - 攻擊 18 防禦 18\n* 它已經從「小糰子」進化成功。' ],
      act_check2: [ '<32>{#p/story}* GELATA - 攻擊 18 防禦 18\n* 狀態並不是很好。' ],
      act_check3: [ '<32>{#p/story}* GELATA - 攻擊 18 防禦 18\n* 允許成為全職果凍墊。' ],
      act_check4: [ '<32>{#p/story}* GELATA - 攻擊 18 防禦 18\n* 和你的關係並沒有想像的那麼好...' ],
   ...
   b_opponent_doge: {
      ...
      batheTextEarly: [ "<32>{#p/human}* （你建議Doge去洗個澡，\n  但她現在並不怎麼想去。）" ],
      batheTextGeno: [
         '<32>{#p/human}* （你建議Doge去洗個澡。）',
         '<32>{#p/basic}* 但她根本不在乎自己髒不髒。'
      ],
      batheTextLate: [ '<32>{#p/human}* （你建議Doge去洗個澡，\n  但為時已晚。）' ],
...
'<20>...才怪。',
   ...
   n_shop_tem: {
      ...
      talk: () => [
         ...
         SAVE.data.n.plot === 72 ? '未來發展' : SAVE.data.b.colleg ? 'Temmie盔甲' : '介紹下自己',
