...
'謎自開。」'
   ...
   n_shop_tem: {
      ...
      talk: () => [
         ...
         SAVE.data.n.plot === 72 ? '未來發展' : SAVE.data.b.colleg ? '關於Temmie盔甲' : '介紹下自己',
