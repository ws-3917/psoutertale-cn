...
public class DoubleVineAttack : AttackBase
{
	...
	protected override void Update()
	{
		...
		if (frames >= 25 && frames <= 210)
		{
			for (int i = 0; i < 2; i++)
			{
				...
				FloweyVineBullet component = Object.Instantiate(Resources.Load<GameObject>("battle/attacks/bullets/flowey/FloweyVineBullet"), position, Quaternion.identity, base.transform).GetComponent<FloweyVineBullet>();
				component.Activate(zero);
				if (i == 0)
				{
